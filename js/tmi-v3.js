    ...
    return function e(t, n, r) {
        ...
        5: [function(require, module, exports) {
            ...
            Connection.prototype._onSocketConnected = function(data) {
                ...
                if (this.isActive) {
                    ...
                    this._pingInterval = setInterval(_utilJs2["default"].callback(this._doPing, this), PING_INTERVAL + _utilJs2["default"].randomInt(PING_JITTER))
                } else {
            ...
            Connection.prototype._doPing = function() {
                ...
                this._send("PING");
                this._pingTimeout = setTimeout(_utilJs2["default"].callback(this._doPingTimeout, this), PING_TIMEOUT)
            };
        ...
        7: [function(require, module, exports) {
            ...
            var parseTwitchTags = function parseTwitchTags(tagsString) {
                ...
                if (tags.badges) {
                    ...
                    tags.badges = _utilJs2["default"].convertBadgesTagToOldFormat(tags._badges)
                }
                return tags
            };
        ...
        9: [function(require, module, exports) {
            ...
            Room.prototype.getBadges = function(username) {
                return _utilJs2["default"].convertBadgesTagToOldFormat(this._roomUserBadges[username])
            };
            ...
            Room.prototype._updateUserStateBadges = function(user) {
                var newBadges = arguments.length <= 1 || arguments[1] === undefined ? [] : arguments[1];
            ...
            Room.prototype._addHistoricalMessages = function(messages) {
                ...
                messages.reverse().forEach(function(msg) {
                    var ircMsg = _ircJs2["default"].parseMessage(msg);
