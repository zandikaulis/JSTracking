        ...
        RQ6e: function(e, t, n) {
                ...
                m = function(e) {
                    ...
                    return r.__extends(t, e), t.prototype.componentDidUpdate = function() {
                        ...
                        this.props.data.loading ? e = [a.createElement("option", {
                            key: "Loading"
                        }, Object(i.d)("Loading...", "ReportReasonsSelect"))] : e = (this.props.data.reportReasons || Object(u.b)()).map(function(e) {
            ...
            var v = function(e) {
                ...
                return r.__extends(t, e), t.prototype.render = function() {
                    ...
                    return this.props.submitStatus === g.Success ? a.createElement("div", null, a.createElement(d.z, {
                        onClick: this.props.onClose
                    }, a.createElement(d.Va, {
                        padding: {
                            x: 2
                        }
                    }, Object(i.d)("Close", "ReportUser")))) : a.createElement("div", null, a.createElement(d.Va, {
                ...
                ae = function(e) {
                    function t() {
                        ...
                        return t.state = {
                            ...
                            return a.createElement(f.Va, null, i, a.createElement(f.z, {
                                onClick: n,
                                disabled: o,
                            ...
                            if (t.state.currentSelection && t.state.currentSelection.value) {
                                ...
                                t.setState({
                                    ...
                                    return t.trackNavigation(E.Next, e.value)
                                })
                            }
                                ...
                                return o.__generator(this, function(o) {
                                    switch (o.label) {
                                        ...
                                        case 1:
                                            switch (o.sent(), this.props.submitStatus) {
                                                ...
                                                case M.b.Success:
                                                    r = X, J[t] && (r = J[t]), this.state.currentCard.nextCard && (r = this.state.currentCard.nextCard), this.setState({
                                                        ...
                                                        return a.trackNavigation(E.Submit)
                                                    });
                                                    break;
                                                case M.b.UserError:
                                                    this.setState({
                                            ...
                                            return [3, 3];
                                        case 2:
                                            this.props.onError(M.b.FormError), this.setState({
                                                error: e
                                            }), o.label = 3;
                                        case 3:
                                            return [2]
                            ...
                            return o.__awaiter(t, void 0, void 0, function() {
                                ...
                                return o.__generator(this, function(o) {
                                    return e = this.state.currentCard, t = this.state.prevCards[this.state.prevCards.length - 1], n = this.state.prevSelections[this.state.prevSelections.length - 1], r = !n.differentTarget && this.state.targetUnknown, a = this.state.displacedSelections, this.state.currentSelection && (a = a.concat(this.state.currentSelection)), t && n && this.setState({
                                        ...
                                        return i.trackNavigation(E.Back, e.value)
                                    }), [2]
                                })
                            })
                    ...
                    return o.__extends(t, e), t.prototype.componentWillUnmount = function() {
                        ...
                        var e = this.state.currentCard.type === C.Info && this.state.currentCard.blockPrompt ? a.createElement(R, {
                        ...
                        return a.createElement(f.xb, {
                            ...
                            error: this.props.submitStatus === M.b.FormError && !!this.state.error
            ...
            var ue = function(e) {
                function t(t) {
                    ...
                    n.handleSubmit = function(e, t, r, a, i) {
                                ...
                                switch (o.label) {
                                    ...
                                    case 2:
                                        return o.sent(), l.o.tracking.track(g.SpadeEventType.CommunityModeration, {
                                            ...
                                            submitStatus: M.b.Success
                                        }, function() {
                                            d.state.showWizard || d.trackAction(U.Submit)
                                        }), [3, 4];
                                    case 3:
                                        return n = o.sent(), l.j.error(n, "ReportUserInCommunity Mutation failed."), this.setState({
                                            submitStatus: M.b.MutationError
                                        }), [3, 4];
                                    case 4:
                                        return [3, 9];
                                    case 5:
                                        if (s = i === T.a.Whisper ? i : this.props.reportContext.contentType, c = {
                                                description: t,
                                                reason: e,
                                                content: s,
                                            ...
                                            }, this.props.reportContext.contentType === T.a.Community && this.props.reportContext.extra && (c.description = Object(ie.a)(this.props.reportContext.extra, t)), null === c.targetID) return this.setState({
                                            submitStatus: M.b.UserError
                                        }), [2];
                                        o.label = 6;
                                    case 6:
                                        return o.trys.push([6, 8, , 9]), [4, this.props.reportUser(Object(p.a)(c))];
                                    case 7:
                                        return o.sent(), this.props.reportContext.contentType === T.a.Community && l.o.tracking.track(g.SpadeEventType.CommunityReport, {
                        ...
                        n.state.openEventSent || (n.state.showWizard ? n.trackWizardAction(E.Open, void 0, e) : n.trackAction(U.Open), n.setState({
                            openEventSent: !0
                        }))
                    }, n.trackClose = function(e, t) {
                        n.state.closeEventSent || (n.state.showWizard ? n.trackWizardAction(E.Close, t, void 0, e) : n.trackAction(U.Close), n.setState({
                            closeEventSent: !0
                        }))
                        ...
                        l.o.tracking.track(g.SpadeEventType.ReportWizardFlowAction, {
                            ...
                            report_sent: n.state.submitStatus === M.b.Success,
                ...
                return o.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    if (this.props.data.targetUser) {
                        ...
                        return this.state.showWizard ? this.props.data.loading ? a.createElement(f.Xa, null) : a.createElement(ae, o.__assign({}, e, {
                        ...
                        })) : a.createElement(M.c, o.__assign({}, e, {
                            targetUser: this.props.data.targetUser
                        }))
                    }
                    return a.createElement(f.Va, {
            ...
            var r = n("/MKj"),
                ...
                y = function(e) {
                    ...
                    return l.__extends(t, e), t.prototype.componentDidMount = function() {
                        ...
                        return this.props.isLoggedIn ? this.props.data.error ? u.createElement(f.Va, {
                            margin: {
                                bottom: 1
                            }
                        }, u.createElement(f.V, {
                            fontSize: f.Aa.Size5
                        }, Object(d.d)("There was an unexpected error. Please refresh the page and try again", "ReportUserPage"))) : !this.props.data || this.props.data.loading ? u.createElement(f.cb, {
                            lineCount: 3
                        ...
                        }) : u.createElement(f.Va, {
                            margin: {
                                bottom: 1
                            }
                        }, u.createElement(f.V, {
                            fontSize: f.Aa.Size5
                        }, Object(d.d)("The user you are trying to report does not exist", "ReportUserPage"))) : u.createElement(f.Va, {
