                        ...
                        switch (s.label) {
                            ...
                            case 1:
                                return (n = s.sent()).requestError ? (r.j.error(n.requestError, zt.name), e.dispatch(p(Vt(""))), [2]) : n.error ? (r.j.error(new Error(n.error.error), zt.name), e.dispatch(p(Vt(n.error.message))), [2]) : void 0 === n.body ? (e.dispatch(p(Vt(""))), [2]) : (l = n.body, o = {
                                    ...
                                    type: u
                                }, c))), e.dispatch(bt(Qt, o)), setTimeout(function() {
                                    e.dispatch({
                                        type: _
                                    })
                                }, 5e3), [3, 3]);
                ...
                return a.__awaiter(Bt, void 0, void 0, function() {
                    ...
                    return a.__generator(this, function(i) {
                        switch (i.label) {
                            ...
                            case 2:
                                return o = i.sent(), r.j.error(o, Gt.name), [3, 3];
                            case 3:
                                return [2]
                        }
                        var s
                ...
                return a.__awaiter(Bt, void 0, void 0, function() {
                    ...
                    return a.__generator(this, function(a) {
                        switch (a.label) {
                            ...
                            case 2:
                                return i = a.sent(), r.j.error(i, Qt.name), [3, 3];
                            case 3:
                                return [2]
                        }
                    })
        ...
        var po = function(e) {
                ...
                return a.__extends(t, e), t.prototype.componentWillMount = function() {
                    ...
                    if (this.props.data.loading) e = kt.createElement(Ct._10, {
                        ...
                        var s = void 0;
                        s = this.props.hasFetchedComments && this.props.offsetRange === Qe ? kt.createElement(Ct._2, {
                            display: Ct.R.Flex,
                            margin: {
                                x: 1,
                                top: 2,
