            ...
            D = function(e) {
                return l.__awaiter(E, void 0, void 0, function() {
                    ...
                    return l.__generator(this, function(a) {
                        switch (a.label) {
                            case 0:
                                return a.trys.push([0, 2, , 3]), [4, C(e)];
                            case 1:
            ...
            ee = (n(1018), function(e) {
                function t() {
                    ...
                    return t.state = {
                        ...
                        if (!t.props.data || !t.props.data.directory || !t.props.data.directory.id) return null;
                        var e = {
                            uploadURL: V(t.props.data.directory.id),
                        ...
                        return l.__awaiter(t, void 0, void 0, function() {
                            ...
                            return l.__generator(this, function(t) {
                                switch (t.label) {
                                    case 0:
                                        return [4, v.a.delete(V(this.props.data.directory.id))];
                                    case 1:
                ...
                return l.__extends(t, e), t.prototype.render = function() {
                    ...
                    return s.createElement(G.U, {
                        ...
                        to: {
                            pathname: R(this.props.directoryType)
                        },
                        className: "directory-header__link"
                    }, s.createElement(G._8, {
            ...
            g = (n.n(p), function(e) {
                ...
                return a.__extends(t, e), t.prototype.componentWillUnmount = function() {
                    ...
                    var e = this.state.hovered && !this.state.didAnimatedPreviewFailToLoad,
                        ...
                        a = i("video-preview-card__preview-image", {
            ...
            p = (n(1094), function(e) {
                ...
                return a.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    return this.state.isPremiereExperimentActive && (h = r.createElement(m.S, {
                        ...
                        className: i(this.props.broadcastType === d.a.PastPremiere ? v : f),
                        padding: {
                            y: .5,
                            x: 1
                        },
                        ...
                        className: i(this.props.broadcastType ? f : v),
                        padding: {
                            y: .5,
                            x: 1
                        },
                        ...
                        className: i(this.props.broadcastType === d.a.Archive ? v : f),
                        padding: {
                            y: .5,
                            x: 1
                        },
                        "data-test-selector": "filter-item-archive"
                    }, a)), r.createElement(m.S, {
                        onClick: this.typeChangeHandler,
                        "data-filter-type": d.a.Highlight,
                        "data-a-target": "video-type-filter-highlights"
                    }, r.createElement(m.U, {
                        className: i(this.props.broadcastType === d.a.Highlight ? v : f),
                        padding: {
                            y: .5,
                            x: 1
                        },
                        ...
                        className: i(this.props.broadcastType === d.a.Upload ? v : f),
                        padding: {
                            y: .5,
                            x: 1
                        },
            ...
            F = function(e) {
                function t(t) {
                    ...
                    return n.onVideoSortChange = function(e) {
                        Object(g.d)("/directory/game/" + n.props.match.params.encodedCommunityName + "/videos", n.props, void 0, e)
                    }, n.onVideoFilterChange = function(e) {
                        Object(g.d)("/directory/game/" + n.props.match.params.encodedCommunityName + "/videos", n.props, e)
                    }, n.state = {
                        directoryType: Object(N.c)(t.match.path)
                    }, n
                }
                return o.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    var e = null,
                        ...
                        n = Object(g.c)(this.props) || D,
                        a = Object(g.b)(this.props);
                    if (this.props.data.error) {
                        var i = Object(s.d)("{gameName} videos are temporarily unavailable.", {
                            gameName: t
                        }, "DirectoryVideosPage");
                    ...
                    if (!this.props.data.loading && null === this.props.data.game) {
                        var i = Object(s.d)("{gameName} does not exist.", {
                            gameName: t
                        }, "DirectoryVideosPage");
                        return l.createElement(d.a, {
                            message: i
                                ...
                                return e.data.fetchMore({
                                    ...
                                    updateQuery: function(e, t) {
                                        var n = t.fetchMoreResult,
                                            a = n;
                                        return {
                                            game: o.__assign({}, a.game, {
                                                videos: o.__assign({}, a.game.videos, {
                                                    edges: Object(p.b)(e.game.videos.edges, a.game.videos.edges)
                                                })
                                            })
                                        }
                                    }
        ...
        var s, d = n(0),
            ...
            D = function(e) {
                ...
                return d.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    }, u.createElement(S.u, d.__assign({
                        ariaLabel: e,
            ...
            H = function(e) {
                ...
                return d.__extends(t, e), t.prototype.render = function() {
                    ...
                    }, Object(p.d)("Cancel", "CommunityBanModal"))), u.createElement(S.U, {
                        display: S.H.Inline,
                        margin: {
                            x: 1
                        }
                    ...
                    }, Object(p.d)("Ban", "CommunityBanModal")))))), u.createElement(M.a, {
                        closeOnBackdropClick: !0
                    })))
                }, t
            }(u.Component),
            G = Object(R.compose)(Object(k.a)(B, {
            ...
            $ = function(e) {
                ...
                return d.__extends(t, e), t.prototype.render = function() {
                    return this.props.data && this.props.data.error ? null : u.createElement(S.U, {
                        position: S._2.Relative
                    }, u.createElement(j.a, null, u.createElement(S.v, {
            ...
            h = (n(917), function(e) {
                ...
                return d.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    return c.createElement(f.U, {
                        ...
                        padding: .5
                    }, Object(g.b)().map(this.renderLanguageOption))), c.createElement(f._17, {
                        background: f.m.Alt,
                        borderTop: !0,
    ...
    920: function(e, t, n) {
        ...
        var a = n(1),
            ...
            r = function() {
                ...
                }, a.createElement(i._1, null)), a.createElement(i.B, null, a.createElement(i.U, {
                    display: i.H.Flex,
                    margin: {
                        bottom: 1
                    }
                ...
                }, a.createElement(i._21, null, a.createElement(i._1, {
                    width: 150
                    ...
                    return t.follow = function() {
                        return c.__awaiter(t, void 0, void 0, function() {
                            ...
                            return c.__generator(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        return this.props.followGame && this.props.data && this.props.data.game ? (e = c.__assign({}, Object(v.a)({
                        ...
                        return c.__awaiter(t, void 0, void 0, function() {
                            ...
                            return c.__generator(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        return this.props.unfollowGame && this.props.data && this.props.data.game ? (e = c.__assign({}, Object(v.a)({
                                            gameID: this.props.data.game.id
                                        }), {
                                            optimisticResponse: {
                                                unfollowGame: {
...
//# sourceMappingURL=pages.directory-game-videos-3766abab2043ff43cd81ee38021cc55e.js.map