            ...
            var a = n("mrSG"),
                ...
                s = function(t) {
                    ...
                    return a.__extends(e, t), e.prototype.render = function() {
                        return o.createElement(l.Va, null, o.createElement(l.Va, {
                            ...
                            display: l.W.Flex,
                            justifyContent: l.Ua.Start
                        }, o.createElement(l.V, null, Object(r.d)("Live campaign analytics can be tracked here. Historical data is available in individual campaign detail pages. Please visit the <x:link>Campaign Manager</x:link> for details.", {
                            "x:link": function(t) {
                ...
                u = Object(i.compose)(Object(c.c)("DevBountyBoardAnalyticsPagePresentation", {
