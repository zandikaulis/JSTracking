                                        ...
                                        case 1:
                                            switch (a.sent(), this.props.submitStatus) {
                                                case I.a.FormError:
                                                    ...
                                                    break;
                                                case I.a.Success:
                                                    r = Z, te[t] && (r = te[t]), this.state.currentCard.nextCard && (r = this.state.currentCard.nextCard), i = this.getChoiceIndex(), this.setState({
                                                        currentCard: r,
                                                        prevCards: [],
                                                        prevSelections: [],
                                                        currentSelection: null,
            ...
            var de = function(e) {
                function t(t) {
                    ...
                    n.handleSubmit = function(e, t, r) {
                        ...
                        n.state.openEventSent || (n.state.showWizard ? n.trackWizardAction(M.Open, void 0, e) : n.trackAction(O.Open), n.setState({
                            openEventSent: !0
                        }))
                    }, n.trackClose = function(e, t, r) {
                        n.state.closeEventSent || (n.state.showWizard ? n.trackWizardAction(M.Close, t, void 0, r, e) : n.trackAction(O.Close), n.setState({
                            closeEventSent: !0
                        }))
