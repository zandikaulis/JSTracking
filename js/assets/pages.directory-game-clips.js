(window.webpackJsonp = window.webpackJsonp || []).push([
    [144], {
        ...
        "3f6U": function(e, t, n) {
            ...
            var T = Object(u.connect)(function(e) {
                    return {
        ...
        FUtE: function(e, t, n) {
            ...
            var w, O = Object(u.connect)(null, function(e, t) {
            ...
            var M = function(e) {
                    ...
                    return i.__extends(t, e), t.prototype.render = function() {
                        ...
                        if (this.props.isLoading) {
                            for (var n = [], r = 0; r < 20; r++) n.push(a.createElement(_.a, {
                                key: r
                            }));
                ...
                N = function(e) {
                    function t(t) {
                        ...
                        return n.clipsMaintenance = Object(E.a)(), n.renderMenuItem = function(e) {
                            ...
                            return e && t ? c.createElement(R.Va, {
                                ...
                                disabled: n.clipsMaintenance && j.includes(e)
                            ...
                            [r.Report, {
                                display: Object(_.d)("Report", "ModerationMenu"),
                                destinationHandler: function() {
                                    return n.props.updateModalViewState(r.Report)
                                }
                            }],
                            [r.Delete, {
                                display: Object(_.d)("Delete", "ModerationMenu"),
                                destinationHandler: function() {
                                    return n.props.updateModalViewState(r.Delete)
                                }
                            }],
                            [r.DeleteAll, {
                                display: Object(_.d)("Delete All Clips from Video", "ModerationMenu"),
                                destinationHandler: function() {
                                    return n.props.updateModalViewState(r.DeleteAll)
                                }
                            }],
                            [r.Ban, {
                                display: Object(_.d)("Ban User", "ModerationMenu"),
                                destinationHandler: function() {
                                    return n.props.updateModalViewState(r.Ban)
                                }
                            }],
                            [r.Timeout, {
                                display: Object(_.d)("Timeout User (24 hr)", "ModerationMenu"),
                                destinationHandler: function() {
                    ...
                    return s.__extends(t, e), t.prototype.componentDidMount = function() {
                        ...
                        return o && l.push(r.Delete), s && (l.push(r.DeleteAll), t.curator && t.broadcaster && (l.push(r.Ban), l.push(r.Timeout))), c.createElement(R.Ya, {
                            ...
                            type: R.F.Hollow,
                            icon: R.ub.More,
                            ariaLabel: Object(_.d)("More Options", "ModerationMenu"),
                    ...
                    }, t = s.__decorate([Object(T.a)(M), Object(h.b)("ModerationMenu")], t)
                }(c.Component),
                x = n("MLDe"),
                D = (n("n/Dx"), 2e3),
                U = function(e) {
            ...
            var j, N, x, D = {
                ...
                se = function(e) {
                        ...
                        return t.state = {
                            ...
                            if (t.state.currentSelection && t.state.currentSelection.value) {
                                ...
                                t.setState({
                                    ...
                                    return t.trackNavigation(N.Next, e.value, s)
                                })
                            }
                                            ...
                                            switch (a.sent(), this.props.submitStatus) {
                                                ...
                                                case M.a.Success:
                                                    r = Z, te[t] && (r = te[t]), this.state.currentCard.nextCard && (r = this.state.currentCard.nextCard), i = this.getChoiceIndex(), this.setState({
                                                        ...
                                                        return o.trackNavigation(N.Submit, void 0, i)
                                                    });
                                                    break;
                                                case M.a.UserError:
                                                    this.setState({
                            ...
                            return a.__awaiter(t, void 0, void 0, function() {
                                ...
                                return a.__generator(this, function(a) {
                                    return e = this.state.currentCard, t = this.state.prevCards[this.state.prevCards.length - 1], n = this.state.prevSelections[this.state.prevSelections.length - 1], r = !n.differentTarget && this.state.targetUnknown, i = this.getChoiceIndex(), o = this.state.displacedSelections, this.state.currentSelection && (o = o.concat(this.state.currentSelection)), t && n && this.setState({
                                        ...
                                        return s.trackNavigation(N.Back, e.value, i)
                                    }), [2]
                                })
                            })
                    ...
                    return a.__extends(t, e), t.prototype.componentWillUnmount = function() {
                        ...
                        var e = this.state.currentCard.type === T.Info && this.state.currentCard.blockPrompt ? o.createElement(O, {
            ...
            var de = function(e) {
                function t(t) {
                    ...
                    n.handleSubmit = function(e, t, r) {
                                ...
                                switch (a.label) {
                                    ...
                                    case 2:
                                        return a.sent(), this.setState({
                                            ...
                                            l.state.showWizard || l.trackAction(j.Submit)
                                        }), [3, 4];
                                    case 3:
                        ...
                        n.state.openEventSent || (n.state.showWizard ? n.trackWizardAction(N.Open, void 0, e) : n.trackAction(j.Open), n.setState({
                            openEventSent: !0
                        }))
                    }, n.trackClose = function(e, t, r) {
                        n.state.closeEventSent || (n.state.showWizard ? n.trackWizardAction(N.Close, t, void 0, r, e) : n.trackAction(j.Close), n.setState({
                            closeEventSent: !0
                        }))
