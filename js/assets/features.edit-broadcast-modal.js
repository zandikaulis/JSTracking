    ...
    [114], {
        ...
        C29h: function(e, t, a) {
            ...
            var S, y, C = function(e) {
                ...
                O = Object(o.compose)(Object(p.a)(N, {
                    options: function(e) {
                        return {
                            variables: {
            ...
            var I = function(e) {
                    function t(t) {
                        ...
                        return a.state = {
                            ...
                            var e = null;
                            return e = a.props.type === S.StreamTag ? a.renderStreamTagResults() : a.renderTagResults(), r.createElement(d.b, {
                            ...
                            var t = Object(w.b)(e, a.props.type === S.TagAllMinusAutomation),
                            ...
                            return a.props.type === S.StreamTag && a.state.isOpen ? "" === a.state.searchTerm ? r.createElement(O, {
                            ...
                            return a.state.isOpen ? a.props.type === S.TagAll && "" === a.state.searchTerm ? r.createElement(O, {
                                onAddTag: a.onTagResultSelected,
                                tagsLimit: 100
                            ...
                            if (a.toggleTagSearch(!1), a.clearSearchTerm(), a.props.type === S.TagCategory && "SCOPE_ALL" === t ? l.p.history.push(A.a.Popular) : a.props.type === S.TagAll && "SCOPE_CATEGORY" === t && l.p.history.push(A.a.Games), a.props.onTagClick && (a.props.onTagClick(e), a.props.section && a.props.numSelectedTags)) {
                                var n = {
            ...
            var m = function(e) {
                ...
                return i.__extends(t, e), t.prototype.render = function() {
                    return r.createElement(g.Cb, {
                        ...
                        type: g.Sb.H4
                    }, Object(l.d)("Broadcast Options", "EditBroadcastModal"))), r.createElement(g.Cb, {
                        borderTop: !0,
                        margin: {
                            top: 2
                        },
            ...
            var n, i, r, s, o = a("mrSG"),
                ...
                C = function(e) {
                    ...
                    return o.__extends(t, e), t.prototype.render = function() {
                        return c.createElement(y.Ua, o.__assign({
                            onClick: this.onClick,
                            tabIndex: -1
                        }, Object(S.a)(this.props)), c.createElement(y.Xa, {
                            padding: {
                                y: .5,
                                x: 1
                            }
            ...
            var G = 2500,
                B = function(e) {
                    function t() {
                        ...
                        return t.state = {
                                        ...
                                        case 2:
                                            return this.setState(function(a) {
                                                ...
                                                return r && (n.fields.language.value = r.language), n.fields.title.value = l && l.title || s && s.title || "", n.selectedGame = l && l.id && l.game && l.game.name || s && s.game && s.game.name || "", n.fields.goLiveNotification = {
                                                    isEnabled: e,
                                                    value: t
                                                }, n.selectedTags = c.map(function(e) {
                                                    return {
                                                        id: e.id,
                                                        tagName: e.tagName,
                            ...
                            t.setState(function(r) {
                                var s = o.__assign({}, r);
                                return s.fields[e].value = t.normalizeString(a).slice(0, F.c).join(""), s.fields[e].errorType = function(e, t) {
                                    switch (t) {
                                        case n.Title:
                            ...
                            return (F.c - (e && t.normalizeString(e).length || 0)).toString()
                    ...
                    return o.__extends(t, e), t.prototype.componentWillReceiveProps = function(e) {
                        ...
                        return this.props.data.error ? null : c.createElement(y.Xa, {
                            fullHeight: !0,
                            display: y.X.Flex,
                            ...
                            fullWidth: !0
                        }, this.getContent(), c.createElement(y.Xa, {
                            margin: {
                                bottom: 2
                            }
                        }, c.createElement(y.U, {
                            targetBlank: !0,
                            to: F.b
                        }, Object(u.d)("Your content must follow our guidelines", "EditBroadcastComponent"))), c.createElement(y.Xa, {
                            ...
                            fullWidth: !e,
                            icon: t === s.Complete ? y.rb.Check : void 0,
                        ...
                        if (this.props.data && this.props.data.currentUser && this.props.data.user && this.props.data.user.stream && !this.props.data.loading && this.state.loaded) {
                            var t = this.state.fields,
                                ...
                                l = x(i.errorType),
                                d = x(s.errorType);
                            e = c.createElement(c.Fragment, null, c.createElement(y.Xa, {
                            ...
                            }))), this.state.fields.goLiveNotification.isEnabled && c.createElement(y.Xa, {
                                margin: {
                                    bottom: 2
                                }
                            }, c.createElement(y.Ea, {
                            ...
                            })), this.renderTagSelect(), c.createElement(y.Xa, {
                                margin: {
                                    bottom: 1
                                }
                            }, c.createElement(g.a, {
                        ...
                        } else e = c.createElement(y.Xa, {
                            fullWidth: !0,
                            padding: {
                                y: 2
                            }
                        }, c.createElement(y.Za, {
                            fillContent: !0
                        }));
                        return e
                        ...
                        return o.__awaiter(this, void 0, void 0, function() {
                            ...
                            return o.__generator(this, function(o) {
                                switch (o.label) {
                                    ...
                                    case 1:
                                        return c = o.sent(), d = function(e) {
                                            return n.chatSettings && c.data.updateChatSettings && c.data.updateChatSettings.chatSettings && (n.chatSettings.isBroadcasterLanguageModeEnabled = c.data.updateChatSettings.chatSettings.isBroadcasterLanguageModeEnabled), e
                                        }, Object(p.e)(R, {
                                            login: a
                                        }, d), [2]
                                }
                ...
                j = Object(d.compose)(Object(A.b)("EditBroadcast"), Object(m.a)(R, {
                    options: function(e) {
                        return {
            ...
            var d = function(e) {
                    function t() {
                        ...
                        return t.renderErrorMessage = function() {
                            if (t.props.error && t.props.errorMessage) return r.createElement(c.Xa, {
                                margin: {
                                    top: .5
                                }
                    ...
                    return i.__extends(t, e), t.prototype.render = function() {
                        ...
                        }, r.createElement(c.Ha, {
                            id: Object(o.b)(e),
                            label: e
                        }), this.renderHelpButton()), r.createElement(c.Xa, {
                        ...
                        var e = this;
                        return 0 !== this.props.selectedTags.length || this.props.readOnly ? 0 === this.props.selectedTags.length ? r.createElement(c.Xa, {
                            ...
                            return r.createElement(c.Xa, {
                                ...
                                action: t.isAutomated ? void 0 : c.Mb.Remove,
                        ...
                        return this.props.showHelpButton ? r.createElement(c.Xa, null, Object(s.d)("<x:link>Learn More</x:link>", {
                            "x:link": function(e) {
