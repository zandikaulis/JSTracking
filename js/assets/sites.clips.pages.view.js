webpackJsonp([48], {
    ...
    "0vB1": function(e, t, n) {
        ...
        function _(e, t, n) {
            return r.__awaiter(this, void 0, void 0, function() {
                var i, a, o, l, c, d, u, p, m, h, g, b, f, v, k, y, _, T;
                return r.__generator(this, function(C) {
                    switch (C.label) {
                        ...
                        case 1:
                            return C.trys.push([1, 3, , 4]), [4, s.o.apollo.client.query({
                                query: S,
                                variables: {
                                    slug: t
                                }
                        ...
                        case 2:
                            return u = C.sent(), i = !!(u.data.clip.broadcaster && u.data.clip.broadcaster.stream && u.data.clip.broadcaster.stream.id), a = u.data.clip.broadcaster ? u.data.clip.broadcaster.login : null, o = u.data.clip.broadcaster ? u.data.clip.broadcaster.login : null, l = u.data.clip.game ? u.data.clip.game.name : null, c = u.data.clip.broadcaster ? u.data.clip.broadcaster.isPartner : null, d = u.data.clip.id, [3, 4];
                        case 3:
                            return p = C.sent(), s.j.error(p, "Failed to make query for Clip info for tracking event.", {
                                slug: t
                            }), [3, 4];
                        case 4:
                            return m = null, h = null, g = !1, (b = s.o.store.getState().session.user) && (h = b.id, m = b.login, g = !0), f = null, v = null, k = null, y = null, (_ = s.n.getLastPageview()) && (f = _.medium || null, v = _.content || null, k = _.tab_session_id || null, y = _.location || null), T = r.__assign({
                                game: l,
                                live: i,
                                channel: a,
                                channel_id: o,
        ...
        function C(e, t, n, i) {
            _(p.SpadeEventType.ItemSectionLoad, e.slug, r.__assign({}, T(e, i), {
        ...
        var N = function(e) {
                            ...
                            return o.createElement("div", {
                                ...
                                return o.createElement(y, {
                                    ...
                                    trackSelectionClickHandler: function() {
                                        ! function(e, t, n, i, a) {
                                            _(p.SpadeEventType.ItemSectionClick, e.slug, r.__assign({}, T(e, a), {
                                                item_id: t.slug,
            ...
            P = Object(m.d)("ClipsRecommendations")(Object(l.a)(E)(N)),
            R = n("ynxC"),
            I = n("RH2O"),
            D = n("Aj/L"),
            F = n("zCIC"),
            ...
            G = function(e) {
                ...
                return r.__extends(t, e), t.prototype.componentWillReceiveProps = function(e) {
                    ...
                    this.scrollableAreaEl && this.state.shouldRenderChat && (n || e.slug !== this.props.slug) ? (this.scrollPosition = 0, this.scrollableAreaEl.scrollTop = 0, this.setState(r.__assign({}, W, {
                        shouldRenderChat: !1
                    }))) : !this.state.shouldRenderChat && t && t > 1 && this.setState(r.__assign({}, W))
        ...
        var ee = function(e) {
                ...
                return r.__extends(t, e), t.prototype.componentDidUpdate = function() {
                    ...
                    var e = X(Z(this.props.data)).node.id;
            ...
            oe = function(e) {
                ...
                return r.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    return this.props.data.clip ? (e = this.props.data.clip.video ? o.createElement(k.v, {
                        ...
                        linkTo: Object(b.g)(this.props.data.clip.video.id, {
                            t: Object(ie.a)(this.props.data.clip.videoOffsetSeconds),
                            tt_medium: "clips_web",
                            tt_content: "full_vod_button"
                        })
                    }, Object(re.d)("Watch Full Video", "ClipsFullVideoButton")) : o.createElement(k.v, {
                        disabled: !0
                    }, Object(re.d)("Full Video Unavailable", "ClipsFullVideoButton")), o.createElement(k._8, {
                        display: k.R.InlineBlock
                ...
                }, t = r.__decorate([Object(m.d)("ClipsFullVideoButton"), Object(l.a)(ae)], t)
            }(o.Component),
            ...
            le = Object(m.d)("ClipsSidebar", {
                autoReportInteractive: !0
            })(se),
            ce = n("ZxOd"),
            de = n("mVDO"),
            ue = n("bW4X"),
            pe = (n("IcDq"), function(e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                    return t.state = {
                        ...
                        void 0 === e && (e = t.props), t.redirected || e.data.loading || !(e.data.error || e.data.clip && e.data.clip.creationState !== f.a.created) || (t.redirected = !0, e.history.push(Object(b.f)(g.a.ClipMissing)))
        ...
        var y = function(e) {
            ...
            return i.__extends(t, e), t.prototype.componentDidMount = function() {
                ...
                return r.createElement(g.v, i.__assign({
                    ...
                    icon: this.props.followUIType === k.TextOnly ? void 0 : g._25.Heart,
                    onClick: e,
                    size: this.props.size,
                    tabIndex: this.props.tabIndex
                }, Object(g._63)(this.props)), this.props.followUIType === k.IconOnly ? null : t)
                ...
                return r.createElement(g.v, i.__assign({
                    ...
                    icon: this.props.unfollowUIType === k.TextOnly ? void 0 : g._25.Heart,
                    statusAlertIcon: this.props.unfollowUIType === k.TextOnly ? void 0 : g._25.Unheart,
                    statusAlertText: this.props.unfollowUIType === k.IconOnly ? "" : e,
                    tabIndex: this.props.tabIndex,
                    size: this.props.size,
                    onClick: this.toggleFollowing
                }, Object(g._63)(this.props)), this.props.unfollowUIType === k.IconOnly ? null : Object(a.d)("Followed", "FollowButton"))
        ...
        var i = n("TToO"),
            ...
            C = (n("twHn"), function(e) {
                ...
                return i.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    if (!t && !Object(b.c)(window.navigator.userAgent)) return r.createElement(y._8, null, this.renderPlaceholders());
                    if (!t && Object(b.c)(window.navigator.userAgent)) return r.createElement(y._8, null, this.renderMobilePlaceholders());
                    if (Object(b.c)(window.navigator.userAgent)) return r.createElement(_, {
                        clip: t
                    });
                    ...
                    }, r.createElement(c.a, null, r.createElement(y.v, {
                        type: y.B.Hollow,
                        ariaLabel: n,
    ...
    fc0G: function(e, t, n) {
        ...
        var K = Object(b.d)(Object(g.b)(function(e) {
            return {
                ...
                activeVideoPlayerRefID: Object(P.a)(e)
            }
        }, function(e) {
            return Object(b.b)({
    ...
    sikP: function(e, t, n) {
        ...
        var v = n("LnKh"),
            ...
            N = Object(T.compose)(Object(u.d)("ClipsModalDeleteAll"), f({
                props: function(e) {
                    return {
...
//# sourceMappingURL=sites.clips.pages.view-e0deead8ad86dd36e90cff36189a067e.js.map