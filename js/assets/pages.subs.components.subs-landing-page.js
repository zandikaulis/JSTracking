        ...
        t.a = function(e) {
            return r.__awaiter(this, void 0, void 0, function() {
                ...
                return r.__generator(this, function(n) {
                    ...
                    }, s.n.track(a.SpadeEventType.SubsLandingStreamerClick, t), [2]
                })
            })
        }, t.b = function(e) {
            return r.__awaiter(this, void 0, void 0, function() {
                ...
                return r.__generator(this, function(r) {
                    ...
                    }, s.n.track(a.SpadeEventType.Subscription, n), [2]
                })
            })
        };
        var r = n("TToO"),
            ...
            return function(t) {
                var n = function(n) {
                    function i(t) {
                        ...
                        }, o.j.debug("pageViewTracking", e), t.rootLatencyTracker ? t.rootLatencyTracker.setLocation(e.location) : o.j.warn("No latency tracker exists! This means no data will be sent to Spade.", e), s
                    }
            ...
            O = (n("VNre"), function(e) {
                function t() {
                    ...
                    return t.state = {
                        ...
                        if (t.props.data.loading || t.props.data.error) return [a.createElement(w._14, {
                        ...
                        return e.length < 1 ? [a.createElement(w.Q, {
                        ...
                        return !t.props.data.loading && !t.props.data.error && t.props.data.currentUser.follows && t.props.data.currentUser.follows.pageInfo && t.props.data.currentUser.follows.pageInfo.hasNextPage ? a.createElement(w._8, {
                ...
                return s.__extends(t, e), t.prototype.componentWillReceiveProps = function(e) {
                    ...
                    return this.props.isLoggedIn ? a.createElement(w._8, {
                    ...
                    }, this.messages.title)), a.createElement(w._55, {
                        center: !0,
                        gutterSize: w._57.Small
                    }, this.getFollowedChannels()), this.getShowMore()) : a.createElement(w._8, {
                        textAlign: w._45.Center,
                        margin: {
                            top: 3
                        }
                    ...
                    }, this.messages.login), a.createElement(w.Q, null, this.messages.loginTitle))
                                ...
                                return e.data.fetchMore({
                                    ...
                                    updateQuery: function(e, t) {
                                        var n = t.fetchMoreResult,
                                            r = [];
                                        return e.currentUser.follows && n.currentUser.follows ? r = Object(y.c)(e.currentUser.follows.edges, n.currentUser.follows.edges) : !e.currentUser.follows && n.currentUser.follows ? r = n.currentUser.follows.edges : e.currentUser.follows && !n.currentUser.follows && (r = e.currentUser.follows.edges), {
        ...
        var x = Object(r.b)(function(e) {
            ...
            P = (n("np4D"), function(e) {
                ...
                return s.__extends(t, e), t.prototype.render = function() {
                    var e;
                    return e = this.props.isWaiting ? a.createElement(w._10, {
                        fillContent: !0
                    }) : this.props.isErrored ? this.getErrorMessage() : this.props.streamerResults && this.props.streamerResults.totalHits > 0 ? this.getStreamerResultContent() : this.getNoResultsMessage(), a.createElement(w._35, {
                        elevation: 4
                    }, a.createElement("div", {
                        ...
                        suppressScrollX: !0
                    }, a.createElement(w._8, null, e, a.createElement(d.a, {
                        enabled: !this.props.isWaiting && this.props.isOpen,
                        loadMore: this.props.loadMore
                    })))))))
                }, t.prototype.getStreamerResultContent = function() {
                    var e = this;
                    if (!this.props.streamerResults) return a.createElement(w._8, null);
                    ...
                    return a.createElement(w._8, null, t)
                }, t.prototype.getErrorMessage = function() {
                    return a.createElement(w.Q, null, "Error")
                }, t.prototype.getNoResultsMessage = function() {
                    return a.createElement(w.Q, null, "No Results")
                }, t
            }(a.Component)),
            D = (n("yoqf"), {
                        ...
                        return s.__awaiter(n, void 0, void 0, function() {
                            ...
                            return s.__generator(this, function(a) {
                                switch (a.label) {
                                    ...
                                    case 1:
                                        return a.trys.push([1, 3, , 4]), [4, this.searchClient.queryForType(L.a.Users, this.state.term, "", {
                                            page: e,
                                    ...
                                    case 2:
                                        return t = a.sent(), [3, 4];
                                    case 3:
                                        return n = a.sent(), i.j.error(n, "Algolia page search failed"), this.setState(s.__assign({}, this.getEmptyState(), {
                                            isErrored: !0,
                                            isOpen: !0
                                        })), [2];
                                    case 4:
                                        return t ? (r = Object(I.b)({
                                            searchResults: t,
                                            append: e > 0,
                ...
                return s.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    return s.__awaiter(this, void 0, void 0, function() {
                        ...
                        return s.__generator(this, function(c) {
                            switch (c.label) {
                                case 0:
                                    this.inputTimer = 0, t = -1, n = F.a(), r = "INPUT" === document.activeElement.tagName, this.setState({
                                        queryID: n,
                                        focusSelectable: !r && !!this.state.currentFocus
                                    }), c.label = 1;
                                case 1:
                                    return c.trys.push([1, 3, , 4]), t = 0, [4, this.searchClient.queryForType(L.a.Users, e, n, {
                                        facetFilters: "has_subscription_products:true"
                                    })];
                                case 2:
                                    return a = c.sent(), [3, 4];
                                case 3:
                                    return o = c.sent(), i.j.error(o, "Algolia top results search failed"), this.setState(s.__assign({}, this.getEmptyState(), {
                                        isErrored: !0,
                                        isOpen: !0,
                                        term: e
                                    })), [2];
                                case 4:
                                    return a ? this.state.queryID !== a.id ? [2] : (l = Object(I.b)({
                                        searchResults: a,
                                        append: !1
            ...
            H = (n("rbRz"), function(e) {
                ...
                return s.__extends(t, e), t.prototype.componentDidMount = function() {
                    ...
                    return a.createElement(w._8, {
                        ...
                        color: w.K.Link,
                        bold: !0
                    }, this.messages.title)), a.createElement(w._2, {
                        margin: {
                            top: 2
                        },
                        ...
                        type: w._49.P,
                        fontSize: w.V.Size5
                    }, this.messages.info)), a.createElement(w._2, {
                        margin: {
                            top: 3
                        },
                        ...
                        bold: !0,
                        fontSize: w.V.Size4
                    }, this.messages.searchTitle)), a.createElement(w._2, {
                        margin: {
                            top: 2
                        },
                        className: "subs-landing-page-contents__paragraph"
                        ...
                        type: w._49.P,
                        fontSize: w.V.Size5
                    }, this.messages.searchInfo)), a.createElement(W, null), a.createElement(x, null), a.createElement(w._8, {
                        ...
                        bold: !0,
                        fontSize: w.V.Size4
                    }, this.messages.perksTitle)), a.createElement(w._2, {
                        margin: {
                            top: 2
                        },
                        className: "subs-landing-page-contents__paragraph"
                        ...
                        type: w._49.P,
                        fontSize: w.V.Size5
                    }, this.messages.perksInfo))), a.createElement(w._8, {
                        margin: {
                            top: 2
                        },
                        ...
                        bold: !0,
                        fontSize: w.V.Size4
                    }, this.messages.emotesTitle)), a.createElement(w._2, {
                        margin: {
                            top: 2
                        },
                        className: "subs-landing-page-contents__paragraph"
...
//# sourceMappingURL=pages.subs.components.subs-landing-page-6fba9d02d9479e5c5664b7c9113eb4e8.js.map