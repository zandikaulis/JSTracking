...
function toggle_live_player_popout(e) {
    ...
    function v(e, t, n, i, r) {
        for (var o, s, a, l, u, c, h, d = e.length, v = f(t), y = [], _ = 0; _ < d; _++)
            ...
            if (!he.leadingWhitespace && Fe.test(s) && y.push(t.createTextNode(Fe.exec(s)[0])), !he.tbody)
                for (s = "table" !== u || $e.test(s) ? "<table>" !== h[1] || $e.test(s) ? 0 : l : l.firstChild, o = s && s.childNodes.length; o--;) de.nodeName(c = s.childNodes[o], "tbody") && !c.childNodes.length && s.removeChild(c);
    ...
    function U(e, t, n) {
        ...
        for ($(c, u.opts.specialEasing); o < s; o++)
            if (i = U.prefilters[o].call(u, e, c, u.opts)) return de.isFunction(i.stop) && (de._queueHooks(u.elem, u.opts.queue).stop = de.proxy(i.stop, i)), i;
    ...
    function J(e, t, n, i) {
        ...
        if (de.isArray(t)) de.each(t, function(t, r) {
            n || Ut.test(e) ? i(e, r) : J(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    var pe = function(e) {
        ...
        _ = t.support = {}, x = t.isXML = function(e) {
            ...
            if ((e.ownerDocument || e) !== A && E(e), n = n.replace(le, "='$1']"), _.matchesSelector && O && !U[n + " "] && (!N || !N.test(n)) && (!I || !I.test(n))) try {
                var i = j.call(e, n);
    ...
    de.extend({
        ...
        ajax: function(t, n) {
            ...
            if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((t || d.url || Wt) + "").replace(/#.*$/, "").replace(/^\/\//, $t[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = de.trim(d.dataType || "*").toLowerCase().match(Te) || [""], null == d.crossDomain && (r = Lt.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === $t[1] && r[2] === $t[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === ($t[3] || ("http:" === $t[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = de.param(d.data, d.traditional)), B(Ft, d, n, x), 2 === b) return x;
...
function(e, t) {
    ...
    function(e, t) {
        ...
        var Be = (We = {
            ...
            reject: oe,
            map: ie
        }, fe(We, "async", Ue), fe(We, "filter", le), We);
        e.default = Be, e.cast = $e, e.Promise = R, e.EventTarget = ge, e.all = V, e.allSettled = G, e.race = X, e.hash = J, e.hashSettled = ee, e.rethrow = te, e.defer = ne, e.denodeify = U, e.configure = i, e.on = pe, e.off = me, e.resolve = re, e.reject = oe, e.map = ie, e.async = Ue, e.filter = le, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    }),
    function(e) {
                    ...
                    for (k = "", this.maxRows = 4, T = 0; T < B[1]; T++) {
                        if (S = this._daylightSavingAdjust(new Date(ee, Z, e.selectedDay)), D = " ui-corner-all", C = "", G) {
                            if (C += "<div class='ui-datepicker-group", B[1] > 1) switch (T) {
                                case 0:
                                    C += " ui-datepicker-group-first", D = " ui-corner-" + ($ ? "right" : "left");
                                    break;
                                case B[1] - 1:
                                    C += " ui-datepicker-group-last", D = " ui-corner-" + ($ ? "left" : "right");
                                    break;
                                default:
                        ...
                        for (C += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === x ? $ ? o : i : "") + (/all|right/.test(D) && 0 === x ? $ ? i : o : "") + this._generateMonthYearHeader(e, Z, ee, K, J, x > 0 || T > 0, p, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", M = h ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", w = 0; w < 7; w++) E = (w + c) % 7, M += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[E] + "'>" + f[E] + "</span></th>";
...
function(e, t) {
    ...
    function h(e, t, n) {
        ...
        if (r) {
            ...
            Q.ie ? $[$.length] = e.id : (l.setAttribute("type", I), l.setAttribute("data", e.data)), r.parentNode.replaceChild(l, r), i = l
        }
        return i
    }
    ...
    return function() {
        ...
        function() {
            Q.ie && window.attachEvent("onunload", function() {
                ...
                for (var n = $.length, i = 0; n > i; i++) f($[i]);
    ...
    function(e, t) {
        ...
        function ie(e, n) {
            return t(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || Ui).test(n) ? "format" : "standalone"][e.month()]
        }

        function re(e, n) {
            return t(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[Ui.test(n) ? "format" : "standalone"][e.month()]
        }
        ...
        function tt(e) {
            var t, n = e._a;
            return n && c(e).overflow === -2 && (t = n[ji] < 0 || n[ji] > 11 ? ji : n[Ri] < 1 || n[Ri] > ne(n[Ni], n[ji]) ? Ri : n[Li] < 0 || n[Li] > 24 || 24 === n[Li] && (0 !== n[Fi] || 0 !== n[Hi] || 0 !== n[zi]) ? Li : n[Fi] < 0 || n[Fi] > 59 ? Fi : n[Hi] < 0 || n[Hi] > 59 ? Hi : n[zi] < 0 || n[zi] > 999 ? zi : -1, c(e)._overflowDayOfYear && (t < Ni || t > Ri) && (t = Ri), c(e)._overflowWeeks && t === -1 && (t = Wi), c(e)._overflowWeekday && t === -1 && (t = $i), c(e).overflow = t), e
        }
        ...
        function Dt(t, n) {
            ...
            return this.isValid() ? null != t ? ("string" == typeof t ? t = kt(Ai, t) : Math.abs(t) < 16 && (t *= 60), !this._isUTC && n && (i = St(this)), this._offset = t, this._isUTC = !0, null != i && this.add(i, "m"), r !== t && (!n || this._changeInProgress ? Ut(this, Lt(t - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, e.updateOffset(this, !0), this._changeInProgress = null)), this) : this._isUTC ? r : St(this) : null != t ? this : NaN
        }
        ...
        function $t(e, t) {
            return function(n, i) {
                var r, o;
                return null === i || isNaN(+i) || (x(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), o = n, n = i, i = o), n = "string" == typeof n ? +n : n, r = Lt(n, i), Ut(this, r, e), this
            }
        }
        ...
        var Xi = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
            ...
            er = Pi,
            tr = Pi;
        Y("H", ["HH", 2], 0, "hour"), Y("h", ["hh", 2], 0, We), Y("k", ["kk", 2], 0, $e), Y("hmm", 0, 0, function() {
            return "" + We.apply(this) + U(this.minutes(), 2)
        }), Y("hmmss", 0, 0, function() {
            return "" + We.apply(this) + U(this.minutes(), 2) + U(this.seconds(), 2)
        }), Y("Hmm", 0, 0, function() {
            return "" + this.hours() + U(this.minutes(), 2)
        }), Y("Hmmss", 0, 0, function() {
            return "" + this.hours() + U(this.minutes(), 2) + U(this.seconds(), 2)
        }), Ue("a", !0), Ue("A", !1), I("hour", "h"), R("hour", 13), G("a", Ye), G("A", Ye), G("H", /\d\d?/), G("h", /\d\d?/), G("HH", /\d\d?/, /\d\d/), G("hh", /\d\d?/, /\d\d/), G("hmm", /\d\d\d\d?/), G("hmmss", /\d\d\d\d\d\d?/), G("Hmm", /\d\d\d\d?/), G("Hmmss", /\d\d\d\d\d\d?/), Z(["H", "HH"], Li), Z(["a", "A"], function(e, t, n) {
        ...
        return Qr.abs = Bn, Qr.add = Qn, Qr.subtract = Gn, Qr.as = ei, Qr.asMilliseconds = Ar, Qr.asSeconds = Pr, Qr.asMinutes = Or, Qr.asHours = Ir, Qr.asDays = Nr, Qr.asWeeks = jr, Qr.asMonths = Rr, Qr.asYears = Lr, Qr.valueOf = ti, Qr._bubble = Kn, Qr.get = ii, Qr.milliseconds = Fr, Qr.seconds = Hr, Qr.minutes = zr, Qr.hours = Wr, Qr.days = $r, Qr.weeks = oi, Qr.months = Ur, Qr.years = Yr, Qr.humanize = ci, Qr.toISOString = hi, Qr.toString = hi, Qr.toJSON = hi, Qr.locale = un, Qr.localeData = cn, Qr.toIsoString = w("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", hi), Qr.lang = br, Y("X", 0, 0, "unix"), Y("x", 0, 0, "valueOf"), G("x", /[+-]?\d+/), G("X", /[+-]?\d+(\.\d{1,3})?/), Z("X", function(e, t, n) {
            ...
            function(e) {
                di = e
            }(gt), e.fn = Cr, e.min = yt, e.max = _t, e.now = pr, e.utc = l, e.unix = jn, e.months = Wn, e.isDate = r, e.locale = Xe, e.invalid = d, e.duration = Lt, e.isMoment = g, e.weekdays = Un, e.parseZone = Rn, e.localeData = Ze, e.isDuration = wt, e.monthsShort = $n, e.weekdaysMin = qn, e.defineLocale = Ke, e.updateLocale = Je, e.locales = et, e.weekdaysShort = Yn, e.normalizeUnits = N, e.relativeTimeRounding = li, e.relativeTimeThreshold = ui, e.calendarFormat = Yt, e.prototype = Cr, e
    }),
    function(e, t) {
