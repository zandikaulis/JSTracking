...
function toggle_live_player_popout(e) {
    ...
    function v(e, t, n, i, r) {
        for (var o, s, a, l, u, c, h, d = e.length, v = f(t), y = [], _ = 0; _ < d; _++)
            ...
            for (l = l || v.appendChild(t.createElement("div")), u = (We.exec(s) || ["", ""])[1].toLowerCase(), h = Be[u] || Be._default, l.innerHTML = h[1] + fe.htmlPrefilter(s) + h[2], o = h[0]; o--;) l = l.lastChild;
            if (!he.leadingWhitespace && Ye.test(s) && y.push(t.createTextNode(Ye.exec(s)[0])), !he.tbody)
    ...
    function D(e, t, n, i) {
        ...
        if (h && (u = v(t, e[0].ownerDocument, !1, e, i), r = u.firstChild, 1 === u.childNodes.length && (u = r), r || i)) {
            ...
            if (s)
                for (l = a[a.length - 1].ownerDocument, fe.map(a, T), c = 0; c < s; c++) o = a[c], $e.test(o.type || "") && !fe._data(o, "globalEval") && fe.contains(l, o) && (o.src ? fe._evalUrl && fe._evalUrl(o.src) : fe.globalEval((o.text || o.textContent || o.innerHTML || "").replace(ot, "")));
            u = r = null
        }
        return e
    }
    ...
    function Y(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = St || F(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(o);
        ...
        for ($(c, u.opts.specialEasing); o < s; o++)
            if (i = Y.prefilters[o].call(u, e, c, u.opts)) return fe.isFunction(i.stop) && (fe._queueHooks(u.elem, u.opts.queue).stop = fe.proxy(i.stop, i)), i;
    ...
    var ye = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : z) !== O && P(t), t = t || O, N)) {
                ...
                if (w.qsa && !B[e + " "] && (!j || !j.test(e))) {
                    if (1 !== m) p = t, f = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(_e, "\\$&") : t.setAttribute("id", a = H), h = S(e), o = h.length, l = de.test(a) ? "#" + a : "[id='" + a + "']"; o--;) h[o] = l + " " + d(h[o]);
        ...
        w = t.support = {}, T = t.isXML = function(e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, I = O.documentElement, N = !T(O), (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), w.attributes = r(function(e) {
            ...
            if ((e.ownerDocument || e) !== O && P(e), n = n.replace(ce, "='$1']"), w.matchesSelector && N && !B[n + " "] && (!R || !R.test(n)) && (!j || !j.test(n))) try {
                var i = L.call(e, n);
    ...
    fe.extend({
        ...
        html: function(e) {
            return He(this, function(e) {
                ...
                if ("string" == typeof e && !nt.test(e) && (he.htmlSerialize || !et.test(e)) && (he.leadingWhitespace || !Ye.test(e)) && !Be[(We.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        addClass: function(e) {
            ...
            if ("string" == typeof e && e)
                for (t = e.match(Ee) || []; n = this[l++];)
                    if (r = U(n), i = 1 === n.nodeType && (" " + r + " ").replace(Ht, " ")) {
    ...
    fe.parseJSON = function(t) {
        ...
        var n, i = null,
            r = fe.trim(t + "");
        return r && !fe.trim(r.replace(Yt, function(e, t, r, o) {
    ...
    fe.extend({
        ...
        ajax: function(t, n) {
            ...
            if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((t || d.url || en) + "").replace(Ut, "").replace(Gt, tn[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = fe.trim(d.dataType || "*").toLowerCase().match(Ee) || [""], null == d.crossDomain && (r = Xt.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === tn[1] && r[2] === tn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (tn[3] || ("http:" === tn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = fe.param(d.data, d.traditional)), q(Kt, d, n, x), 2 === b) return x;
            u = fe.event && d.global, u && 0 === fe.active++ && fe.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Qt.test(d.type), s = d.url, d.hasContent || (d.data && (s = d.url += ($t.test(s) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Bt.test(s) ? s.replace(Bt, "$1_=" + Wt++) : s + ($t.test(s) ? "&" : "?") + "_=" + Wt++)), d.ifModified && (fe.lastModified[s] && x.setRequestHeader("If-Modified-Since", fe.lastModified[s]), fe.etag[s] && x.setRequestHeader("If-None-Match", fe.etag[s])), (d.data && d.hasContent && d.contentType !== !1 || n.contentType) && x.setRequestHeader("Content-Type", d.contentType), x.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Zt + "; q=0.01" : "") : d.accepts["*"]);
...
function(e, t, n) {
    ...
    e.fn.data = function(t) {
        var r, o, s = this[0];
        return !s || "events" !== t || 1 !== arguments.length || (r = e.data(s, t), o = e._data(s, t), r !== n && r !== o || o === n) ? S.apply(this, arguments) : (i("Use of jQuery.fn.data('events') is deprecated"), o)
    };
...
function(e, t) {
    ...
    function(e, t) {
        ...
        e.default = Ke, e.cast = Ve, e.Promise = R, e.EventTarget = be, e.all = V, e.allSettled = G, e.race = X, e.hash = J, e.hashSettled = ee, e.rethrow = te, e.defer = ne, e.denodeify = Y, e.configure = i, e.on = ye, e.off = _e, e.resolve = re, e.reject = oe, e.map = ie, e.async = Qe, e.filter = le, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    }),
    function(e) {
...
function(e) {
    ...
    function a(e, t, n, i) {
        ...
        if (n = m(n), q = !0, C = i || null, D = {
            ...
            "OBJECT" === r.nodeName.toUpperCase() ? (T = u(r), S = null) : (T = r, S = n), e.id = j, (typeof e.width === A || !/%$/.test(e.width) && y(e.width) < 310) && (e.width = "310"), (typeof e.height === A || !/%$/.test(e.height) && y(e.height) < 137) && (e.height = "137");
    ...
    function h(e, t, n) {
        ...
        if (r) {
            ...
            G.ie ? Y[Y.length] = e.id : (l.setAttribute("type", N), l.setAttribute("data", e.data)), r.parentNode.replaceChild(l, r), i = l
        }
        return i
    }
    ...
    return ! function() {
        G.w3 && ((typeof F.readyState !== A && ("complete" === F.readyState || "interactive" === F.readyState) || typeof F.readyState === A && (F.getElementsByTagName("body")[0] || F.body)) && e(), B || (typeof F.addEventListener !== A && F.addEventListener("DOMContentLoaded", e, !1), G.ie && (F.attachEvent(R, function t() {
            ...
            return B ? void 0 : /loaded|complete/.test(F.readyState) ? void e() : void setTimeout(t, 0)
        }()))
    }(), W[0] = function() {
        z ? i() : r()
    }, ! function() {
        ...
        expressInstallCallback: function() {
            if (q) {
                var e = g(j);
                e && T && (e.parentNode.replaceChild(T, e), S && (x(S, !0), G.ie && (T.style.display = "block")), C && C(D)), q = !1
            }
        },
        version: "2.3"
    }
    ...
    function(e, t) {
        ...
        function Dt(t, n) {
            ...
            return this.isValid() ? null != t ? ("string" == typeof t ? t = Tt(qi, t) : Math.abs(t) < 16 && (t *= 60), !this._isUTC && n && (i = Ct(this)), this._offset = t, this._isUTC = !0, null != i && this.add(i, "m"), r !== t && (!n || this._changeInProgress ? Ut(this, Ft(t - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, e.updateOffset(this, !0), this._changeInProgress = null)), this) : this._isUTC ? r : Ct(this) : null != t ? this : NaN
        }
        ...
        function Pt() {
            return this._tzm ? this.utcOffset(this._tzm) : "string" == typeof this._i && this.utcOffset(Tt(Bi, this._i)), this
        }
        ...
        function Yt(e, t) {
            return function(n, i) {
                var r, o;
                return null === i || isNaN(+i) || (k(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), o = n, n = i, i = o), n = "string" == typeof n ? +n : n, r = Ft(n, i), Ut(this, r, e), this
            }
        }
        ...
        function en(e, t, n) {
            var i, r, o, s;
            return this.isValid() ? (i = St(e, this), i.isValid() ? (r = 6e4 * (i.utcOffset() - this.utcOffset()), t = j(t), "year" === t || "month" === t || "quarter" === t ? (s = tn(this, i), "quarter" === t ? s /= 3 : "year" === t && (s /= 12)) : (o = this - i, s = "second" === t ? o / 1e3 : "minute" === t ? o / 6e4 : "hour" === t ? o / 36e5 : "day" === t ? (o - r) / 864e5 : "week" === t ? (o - r) / 6048e5 : o), n ? s : y(s)) : NaN) : NaN
        }
        ...
        }), B(0, ["YYYY", 4], 0, "year"), B(0, ["YYYYY", 5], 0, "year"), B(0, ["YYYYYY", 6, !0], 0, "year"), N("year", "y"), L("year", 1), X("Y", Ui), X("YY", Li, Ii), X("YYYY", Wi, ji), X("YYYYY", $i, Ri), X("YYYYYY", $i, Ri), ee(["YYYYY", "YYYYYY"], Ki), ee("YYYY", function(t, n) {
        ...
        var hr = H("FullYear", !0);
        B("w", ["ww", 2], "wo", "week"), B("W", ["WW", 2], "Wo", "isoWeek"), N("week", "w"), N("isoWeek", "W"), L("week", 5), L("isoWeek", 5), X("w", Li), X("ww", Li, Ii), X("W", Li), X("WW", Li, Ii), te(["w", "ww", "W", "WW"], function(e, t, n, i) {
            t[i.substr(0, 1)] = _(e)
        });
        var dr = {
            dow: 0,
        ...
        }), B("e", 0, 0, "weekday"), B("E", 0, 0, "isoWeekday"), N("day", "d"), N("weekday", "e"), N("isoWeekday", "E"), L("day", 11), L("weekday", 11), L("isoWeekday", 11), X("d", Li), X("e", Li), X("E", Li), X("dd", function(e, t) {
        ...
        var fr = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
            ...
            vr = Qi,
            yr = Qi;
        B("H", ["HH", 2], 0, "hour"), B("h", ["hh", 2], 0, $e), B("k", ["kk", 2], 0, Ye), B("hmm", 0, 0, function() {
        ...
        }), Ue("a", !0), Ue("A", !1), N("hour", "h"), L("hour", 13), X("a", Be), X("A", Be), X("H", Li), X("h", Li), X("HH", Li, Ii), X("hh", Li, Ii), X("hmm", Fi), X("hmmss", Hi), X("Hmm", Fi), X("Hmmss", Hi), ee(["H", "HH"], er), ee(["a", "A"], function(e, t, n) {
        ...
        }), B("Q", 0, "Qo", "quarter"), N("quarter", "Q"), L("quarter", 7), X("Q", Oi), ee("Q", function(e, t) {
            t[Ji] = 3 * (_(e) - 1)
        }), B("D", ["DD", 2], "Do", "date"), N("date", "D"), L("date", 9), X("D", Li), X("DD", Li, Ii), X("Do", function(e, t) {
            return e ? t._ordinalParse : t._ordinalParseLenient
        }), ee(["D", "DD"], Zi), ee("Do", function(e, t) {
            t[Zi] = _(e.match(Li)[0], 10)
        });
        var Hr = H("Date", !0);
        B("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), N("dayOfYear", "DDD"), L("dayOfYear", 4), X("DDD", zi), X("DDDD", Ni), ee(["DDD", "DDDD"], function(e, t, n) {
            n._dayOfYear = _(e)
        }), B("m", ["mm", 2], 0, "minute"), N("minute", "m"), L("minute", 14), X("m", Li), X("mm", Li, Ii), ee(["m", "mm"], tr);
        var zr = H("Minutes", !1);
        B("s", ["ss", 2], 0, "second"), N("second", "s"), L("second", 15), X("s", Li), X("ss", Li, Ii), ee(["s", "ss"], nr);
        var Wr = H("Seconds", !1);
        B("S", 0, 0, function() {
        ...
        var $r;
        for ($r = "SSSS"; $r.length <= 9; $r += "S") X($r, Yi);
        for ($r = "S"; $r.length <= 9; $r += "S") ee($r, In);
        var Yr = H("Milliseconds", !1);
        B("z", 0, 0, "zoneAbbr"), B("zz", 0, 0, "zoneName");
        var Ur = g.prototype;
        Ur.add = Rr, Ur.calendar = qt, Ur.clone = Vt, Ur.diff = en, Ur.endOf = fn, Ur.format = on, Ur.from = sn, Ur.fromNow = an, Ur.to = ln, Ur.toNow = un, Ur.get = $, Ur.invalidAt = xn, Ur.isAfter = Qt, Ur.isBefore = Gt, Ur.isBetween = Xt, Ur.isSame = Kt, Ur.isSameOrAfter = Jt, Ur.isSameOrBefore = Zt, Ur.isValid = bn, Ur.lang = Fr, Ur.locale = cn, Ur.localeData = hn, Ur.max = Pr, Ur.min = Ar, Ur.parsingFlags = wn, Ur.set = Y, Ur.startOf = dn, Ur.subtract = Lr, Ur.toArray = vn, Ur.toObject = yn, Ur.toDate = gn, Ur.toISOString = rn, Ur.toJSON = _n, Ur.toString = nn, Ur.unix = mn, Ur.valueOf = pn, Ur.creationData = kn, Ur.year = hr, Ur.isLeapYear = ge, Ur.weekYear = Sn, Ur.isoWeekYear = Cn, Ur.quarter = Ur.quarters = Pn, Ur.month = ue, Ur.daysInMonth = ce, Ur.week = Ur.weeks = Ce, Ur.isoWeek = Ur.isoWeeks = De, Ur.weeksInYear = Mn, Ur.isoWeeksInYear = Dn, Ur.date = Hr, Ur.day = Ur.days = je, Ur.weekday = Re, Ur.isoWeekday = Le, Ur.dayOfYear = On, Ur.hour = Ur.hours = wr, Ur.minute = Ur.minutes = zr, Ur.second = Ur.seconds = Wr, Ur.millisecond = Ur.milliseconds = Yr, Ur.utcOffset = Dt, Ur.utc = Et, Ur.local = At, Ur.parseZone = Pt, Ur.hasAlignedHourOffset = Ot, Ur.isDST = It, Ur.isLocal = jt, Ur.isUtcOffset = Rt, Ur.isUtc = Lt, Ur.isUTC = Lt, Ur.zoneAbbr = Nn, Ur.zoneName = jn, Ur.dates = x("dates accessor is deprecated. Use date instead.", Hr), Ur.months = x("months accessor is deprecated. Use month instead", ue), Ur.years = x("years accessor is deprecated. Use year instead", hr), Ur.zone = x("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Mt), Ur.isDSTShifted = x("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Nt);
        var Br = Ur,
            qr = D.prototype;
        qr.calendar = M, qr.longDateFormat = E, qr.invalidDate = A, qr.ordinal = P, qr.preparse = Fn, qr.postformat = Fn, qr.relativeTime = O, qr.pastFuture = I, qr.set = S, qr.months = re, qr.monthsShort = oe, qr.monthsParse = ae, qr.monthsRegex = de, qr.monthsShortRegex = he, qr.week = ke, qr.firstDayOfYear = Se, qr.firstDayOfWeek = Te, qr.weekdays = Ae, qr.weekdaysMin = Oe, qr.weekdaysShort = Pe, qr.weekdaysParse = Ne, qr.weekdaysRegex = Fe, qr.weekdaysShortRegex = He, qr.weekdaysMinRegex = ze, qr.isPM = qe, qr.meridiem = Ve, Ke("en", {
        ...
        var Vr = Math.abs,
            ...
            ho = Math.abs,
            fo = wt.prototype;
        fo.abs = Vn, fo.add = Gn, fo.subtract = Xn, fo.as = ti, fo.asMilliseconds = Qr, fo.asSeconds = Gr, fo.asMinutes = Xr, fo.asHours = Kr, fo.asDays = Jr, fo.asWeeks = Zr, fo.asMonths = eo, fo.asYears = to, fo.valueOf = ni, fo._bubble = Jn, fo.get = ri, fo.milliseconds = no, fo.seconds = io, fo.minutes = ro, fo.hours = oo, fo.days = so, fo.weeks = si, fo.months = ao, fo.years = lo, fo.humanize = hi, fo.toISOString = di, fo.toString = di, fo.toJSON = di, fo.locale = cn, fo.localeData = hn, fo.toIsoString = x("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", di), fo.lang = Fr, B("X", 0, 0, "unix"), B("x", 0, 0, "valueOf"), X("x", Ui), X("X", Vi), ee("X", function(e, t, n) {
            n._d = new Date(1e3 * parseFloat(e, 10))
        }), ee("x", function(e, t, n) {
            n._d = new Date(_(e))
        }), e.version = "2.14.1", t(vt), e.fn = Br, e.min = _t, e.max = bt, e.now = Or, e.utc = u, e.unix = Rn, e.months = $n, e.isDate = o, e.locale = Ke, e.invalid = f, e.duration = Ft, e.isMoment = v, e.weekdays = Un, e.parseZone = Ln, e.localeData = et, e.isDuration = xt, e.monthsShort = Yn, e.weekdaysMin = qn, e.defineLocale = Je, e.updateLocale = Ze, e.locales = tt, e.weekdaysShort = Bn, e.normalizeUnits = j, e.relativeTimeRounding = ui, e.relativeTimeThreshold = ci, e.calendarFormat = Bt, e.prototype = Br;
        var po = e;
        return po
    }),
    function(e, t) {
...
var Dobbin = function(e) {
        ...
        function i(e) {
            e.Promise && (r = e.Promise), e.serviceUrls && (e.serviceUrls.mixpanel && (a.mixpanel = e.serviceUrls.mixpanel), e.serviceUrls.spade && (a.spade = e.serviceUrls.spade))
        }
        n.d(t, "d", function() {
            return o
        }), n.d(t, "e", function() {
        ...
        var s = function() {
                ...
                return Object.defineProperty(e.prototype, "length", {
                    ...
                    return n.i(o.a)(i.c[this.service].href, "data=" + n.i(r.a)(e)), 1
                }, e
            }(),
            a = function() {
                function e() {
                    this.services = (e = {}, e[i.d] = new s(i.d), e[i.e] = new s(i.e), e);
                    var e
                }
