...
function toggle_live_player_popout(e) {
    ...
    function i(e, t, n) {
        ...
        if ("string" == typeof t) {
            if (_e.test(t)) return de.filter(t, e, n);
            t = de.filter(t, e)
        }
    ...
    function o(e) {
        var t = {};
        return de.each(e.match(Te) || [], function(e, n) {
            t[n] = !0
        }), t
    }
    ...
    function a() {
        (ie.addEventListener || "load" === e.event.type || "complete" === ie.readyState) && (s(), de.ready())
    }
    ...
    function c(e, t, n, i) {
        if (Ce(e)) {
            var r, o, s = de.expando,
                a = e.nodeType,
                l = a ? de.cache : e,
                u = a ? e[s] : e[s] && s;
            if (u && l[u] && (i || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = a ? e[s] = ne.pop() || de.guid++ : s), l[u] || (l[u] = a ? {} : {
                toJSON: de.noop
            }), "object" != typeof t && "function" != typeof t || (i ? l[u] = de.extend(l[u], t) : l[u].data = de.extend(l[u].data, t)), o = l[u], i || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[de.camelCase(t)] = n), "string" == typeof t ? null == (r = o[t]) && (r = o[de.camelCase(t)]) : r = o, r
        }
    }
    ...
    function h(e, t, n) {
        if (Ce(e)) {
            var i, r, o = e.nodeType,
                s = o ? de.cache : e,
                a = o ? e[de.expando] : de.expando;
            if (s[a]) {
                if (t && (i = n ? s[a] : s[a].data)) {
                    de.isArray(t) ? t = t.concat(de.map(t, de.camelCase)) : t in i ? t = [t] : (t = de.camelCase(t), t = t in i ? [t] : t.split(" ")), r = t.length;
                    for (; r--;) delete i[t[r]];
                    if (n ? !u(i) : !de.isEmptyObject(i)) return
                }(n || (delete s[a].data, u(s[a]))) && (o ? de.cleanData([e], !0) : he.deleteExpando || s != s.window ? delete s[a] : s[a] = void 0)
            }
        }
    }
    ...
    function d(e, t, n, i) {
        var r, o = 1,
            ...
            c = (de.cssNumber[t] || "px" !== u && +l) && Pe.exec(de.css(e, t));
        if (c && c[3] !== u) {
            u = u || c[3], n = n || [], c = +l || 1;
            do {
                o = o || ".5", c /= o, de.style(e, t, c + u)
            } while (o !== (o = a() / l) && 1 !== o && --s)
        }
    ...
    function p(e, t) {
        ...
        if (!o)
            for (o = [], n = e.childNodes || e; null != (i = n[r]); r++) !t || de.nodeName(i, t) ? o.push(i) : de.merge(o, p(i, t));
    ...
    function v(e, t, n, i, r) {
        for (var o, s, a, l, u, c, h, d = e.length, v = f(t), y = [], _ = 0; _ < d; _++)
            if ((s = e[_]) || 0 === s)
                if ("object" === de.type(s)) de.merge(y, s.nodeType ? [s] : s);
                else if (We.test(s)) {
            for (l = l || v.appendChild(t.createElement("div")), u = (Re.exec(s) || ["", ""])[1].toLowerCase(), h = ze[u] || ze._default, l.innerHTML = h[1] + de.htmlPrefilter(s) + h[2], o = h[0]; o--;) l = l.lastChild;
            if (!he.leadingWhitespace && Fe.test(s) && y.push(t.createTextNode(Fe.exec(s)[0])), !he.tbody)
                for (s = "table" !== u || Ue.test(s) ? "<table>" !== h[1] || Ue.test(s) ? 0 : l : l.firstChild, o = s && s.childNodes.length; o--;) de.nodeName(c = s.childNodes[o], "tbody") && !c.childNodes.length && s.removeChild(c);
            for (de.merge(y, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
            l = v.lastChild
        } else y.push(t.createTextNode(s));
        for (l && v.removeChild(l), he.appendChecked || de.grep(p(y, "input"), g), _ = 0; s = y[_++];)
            if (i && de.inArray(s, i) > -1) r && r.push(s);
            else if (a = de.contains(s.ownerDocument, s), l = p(v.appendChild(s), "script"), a && m(l), n)
            for (o = 0; s = l[o++];) Le.test(s.type || "") && n.push(s);
        return l = null, v
    }
    ...
    function D(e, t) {
        if (1 === t.nodeType && de.hasData(e)) {
            var n, i, r, o = de._data(e),
                s = de._data(t, o),
                a = o.events;
            if (a) {
                delete s.handle, s.events = {};
                for (n in a)
                    for (i = 0, r = a[n].length; i < r; i++) de.event.add(t, n, a[n][i])
            }
    ...
    function S(e, t) {
        var n, i, r;
        if (1 === t.nodeType) {
            if (n = t.nodeName.toLowerCase(), !he.noCloneEvent && t[de.expando]) {
                r = de._data(t);
                for (i in r.events) de.removeEvent(t, i, r.handle);
                t.removeAttribute(de.expando)
            }
            "script" === n && t.text !== e.text ? (k(t).text = e.text, T(t)) : "object" === n ? (t.parentNode && (t.outerHTML = e.outerHTML), he.html5Clone && e.innerHTML && !de.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && je.test(e.type) ? (t.defaultChecked = t.checked = e.checked, t.value !== e.value && (t.value = e.value)) : "option" === n ? t.defaultSelected = t.selected = e.defaultSelected : "input" !== n && "textarea" !== n || (t.defaultValue = e.defaultValue)
        }
    }
    ...
    function C(e, t, n, i) {
        ...
        var r, o, s, a, l, u, c = 0,
            ...
            f = t[0],
            m = de.isFunction(f);
        if (m || h > 1 && "string" == typeof f && !he.checkClone && Xe.test(f)) return e.each(function(r) {
            var o = e.eq(r);
            m && (t[0] = f.call(this, r, o.html())), C(o, t, n, i)
        });
        if (h && (u = v(t, e[0].ownerDocument, !1, e, i), r = u.firstChild, 1 === u.childNodes.length && (u = r), r || i)) {
            for (a = de.map(p(u, "script"), k), s = a.length; c < h; c++) o = u, c !== d && (o = de.clone(o, !0, !0), s && de.merge(a, p(o, "script"))), n.call(e[c], o, c);
            if (s)
                for (l = a[a.length - 1].ownerDocument, de.map(a, T), c = 0; c < s; c++) o = a[c], Le.test(o.type || "") && !de._data(o, "globalEval") && de.contains(l, o) && (o.src ? de._evalUrl && de._evalUrl(o.src) : de.globalEval((o.text || o.textContent || o.innerHTML || "").replace(Je, "")));
            u = r = null
        }
        return e
    }
    ...
    function M(e, t, n) {
        for (var i, r = t ? de.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || de.cleanData(p(i)), i.parentNode && (n && de.contains(i.ownerDocument, i) && m(p(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    ...
    function N(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; s < a; s++) i = e[s], i.style && (o[s] = de._data(i, "olddisplay"), n = i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ne(i) && (o[s] = de._data(i, "olddisplay", E(i.nodeName)))) : (r = Ne(i), (n && "none" !== n || !r) && de._data(i, "olddisplay", r ? n : de.css(i, "display"))));
    ...
    function j(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; o < 4; o += 2) "margin" === n && (s += de.css(e, n + Oe[o], !0, r)), i ? ("content" === n && (s -= de.css(e, "padding" + Oe[o], !0, r)), "margin" !== n && (s -= de.css(e, "border" + Oe[o] + "Width", !0, r))) : (s += de.css(e, "padding" + Oe[o], !0, r), "padding" !== n && (s += de.css(e, "border" + Oe[o] + "Width", !0, r)));
        return s
    }
    ...
    function R(e, t, n) {
        var i = !0,
            ...
            o = at(e),
            s = he.boxSizing && "border-box" === de.css(e, "boxSizing", !1, o);
        if (r <= 0 || null == r) {
            if (r = lt(e, t, o), (r < 0 || null == r) && (r = e.style[t]), rt.test(r)) return r;
    ...
    function W(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], u = de.css(e, "display"), "inline" === ("none" === u ? de._data(e, "olddisplay") || E(e.nodeName) : u) && "none" === de.css(e, "float") && (he.inlineBlockNeedsLayout && "inline" !== E(e.nodeName) ? d.zoom = 1 : d.display = "inline-block")), n.overflow && (d.overflow = "hidden", he.shrinkWrapBlocks() || c.always(function() {
        ...
        for (i in t)
            if (r = t[i], wt.exec(r)) {
                ...
                h[i] = p && p[i] || de.style(e, i)
            } else u = void 0;
        if (de.isEmptyObject(h)) "inline" === ("none" === u ? E(e.nodeName) : u) && (d.display = u);
        else {
            p ? "hidden" in p && (f = p.hidden) : p = de._data(e, "fxshow", {}), o && (p.hidden = !f), f ? de(e).show() : c.done(function() {
                de(e).hide()
            }), c.done(function() {
                var t;
            ...
            for (i in h) s = z(f ? p[i] : 0, i, c), i in p || (p[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function U(e, t) {
        var n, i, r, o, s;
        for (n in e)
            if (i = de.camelCase(n), r = t[i], o = e[n], de.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = de.cssHooks[i]) && "expand" in s) {
    ...
    function $(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = yt || F(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(o);
        ...
        for (U(c, u.opts.specialEasing); o < s; o++)
            if (i = $.prefilters[o].call(u, e, c, u.opts)) return de.isFunction(i.stop) && (de._queueHooks(u.elem, u.opts.queue).stop = de.proxy(i.stop, i)), i;
    ...
    function K(e) {
        if (!de.contains(e.ownerDocument || ie, e)) return !0;
        for (; e && 1 === e.nodeType;) {
    ...
    function J(e, t, n, i) {
        ...
        if (de.isArray(t)) de.each(t, function(t, r) {
            n || $t.test(e) ? i(e, r) : J(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    de.fn = de.prototype = {
        ...
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || de.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (r = arguments[a]))
                for (i in r) e = s[i], n = r[i], s !== n && (u && n && (de.isPlainObject(n) || (t = de.isArray(n))) ? (t ? (t = !1, o = e && de.isArray(e) ? e : []) : o = e && de.isPlainObject(e) ? e : {}, s[i] = de.extend(u, o, n)) : void 0 !== n && (s[i] = n));
        return s
    }, de.extend({
        ...
        makeArray: function(e, t) {
            var i = t || [];
            return null != e && (n(Object(e)) ? de.merge(i, "string" == typeof e ? [e] : e) : se.call(i, e)), i
        },
        ...
        proxy: function(e, t) {
            var n, i, r;
            if ("string" == typeof t && (r = e[t], t = e, e = r), de.isFunction(e)) return n = re.call(arguments, 2), i = function() {
    ...
    var pe = function(e) {
        function t(e, t, n, i) {
            var r, o, s, a, u, h, d, f, p = t && t.ownerDocument,
                m = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== m && 9 !== m && 11 !== m) return n;
            if (!i && ((t ? t.ownerDocument || t : F) !== E && A(t), t = t || E, O)) {
                if (11 !== m && (h = me.exec(e)))
                    if (r = h[1]) {
                        if (9 === m) {
                        ...
                        if (h[2]) return X.apply(n, t.getElementsByTagName(e)), n;
                        if ((r = h[3]) && _.getElementsByClassName && t.getElementsByClassName) return X.apply(n, t.getElementsByClassName(r)), n
                    }
                if (_.qsa && !$[e + " "] && (!N || !N.test(e))) {
                    if (1 !== m) p = t, f = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(ve, "\\$&") : t.setAttribute("id", a = L), d = k(e), o = d.length, u = ce.test(a) ? "#" + a : "[id='" + a + "']"; o--;) d[o] = u + " " + c(d[o]);
                        f = d.join(","), p = ge.test(e) && l(t.parentNode) || t
                    }
                    if (f) try {
        ...
        function h(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (s) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || r) {
                            if (u = t[L] || (t[L] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (a = l[i]) && a[0] === H && a[1] === o) return c[2] = a[2];
        ...
        function m(e, t, n, r, o, s) {
            return r && !r[L] && (r = m(r)), o && !o[L] && (o = m(o, s)), i(function(i, s, a, l) {
                var u, c, h, d = [],
                    ...
                    _ = n ? o || (i ? e : g || r) ? [] : s : y;
                if (n && n(y, _, a, l), r)
                    for (u = p(_, m), r(u, [], a, l), c = u.length; c--;)(h = u[c]) && (_[m[c]] = !(y[m[c]] = h));
                if (i) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (c = _.length; c--;)(h = _[c]) && (u = o ? J(i, h) : d[c]) > -1 && (i[u] = !(s[u] = h))
                    }
                } else _ = p(_ === s ? _.splice(g, _.length) : _), o ? o(null, s, _, l) : X.apply(s, _)
            })
        }
        ...
        function g(e) {
            for (var t, n, i, r = e.length, o = w.relative[e[0].type], s = o || w.relative[" "], a = o ? 1 : 0, l = h(function(e) {
                ...
                if (n = w.relative[e[a].type]) f = [h(d(f), n)];
                else {
                    if (n = w.filter[e[a].type].apply(null, e[a].matches), n[L]) {
                        for (i = ++a; i < r && !w.relative[e[i].type]; i++);
                        return m(a > 1 && d(f), a > 1 && c(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(oe, "$1"), n, a < i && g(e.slice(a, i)), i < r && g(e = e.slice(i)), i < r && c(e))
                    }
                    f.push(n)
                }
            return d(f)
            ...
            var r = n.length > 0,
                ...
                s = function(i, s, a, l, u) {
                    var c, h, d, f = 0,
                        ...
                        x = _.length;
                    for (u && (S = s === E || s || u); m !== x && null != (c = _[m]); m++) {
                        if (o && c) {
                            for (h = 0, s || c.ownerDocument === E || (A(c), a = !O); d = e[h++];)
                                if (d(c, s || E, a)) {
                                    l.push(c);
                                    break
                                }
        ...
        var y, _, w, b, x, k, T, D, S, C, M, A, E, P, O, N, I, j, R, L = "sizzle" + 1 * new Date,
            F = e.document,
            H = 0,
            z = 0,
            W = n(),
        ...
        try {
            X.apply(V = K.call(F.childNodes), F.childNodes), V[F.childNodes.length].nodeType
        } catch (e) {
            X = {
        ...
        _ = t.support = {}, x = t.isXML = function(e) {
            ...
            return i !== E && 9 === i.nodeType && i.documentElement ? (E = i, P = E.documentElement, O = !x(E), (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), _.attributes = r(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), _.getElementsByTagName = r(function(e) {
                return e.appendChild(E.createComment("")), !e.getElementsByTagName("*").length
            }), _.getElementsByClassName = pe.test(E.getElementsByClassName), _.getById = r(function(e) {
            ...
            }, I = [], N = [], (_.qsa = pe.test(E.querySelectorAll)) && (r(function(e) {
            ...
            })), (_.matchesSelector = pe.test(j = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && r(function(e) {
                _.disconnectedMatch = j.call(e, "div"), j.call(e, "[s!='']:x"), I.push("!=", ie)
            }), N = N.length && new RegExp(N.join("|")), I = I.length && new RegExp(I.join("|")), t = pe.test(P.compareDocumentPosition), R = t || pe.test(P.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !_.sortDetached && t.compareDocumentPosition(e) === n ? e === E || e.ownerDocument === F && R(F, e) ? -1 : t === E || t.ownerDocument === F && R(F, t) ? 1 : C ? J(C, e) - J(C, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return M = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
                    ...
                    a = [e],
                    l = [t];
                if (!r || !o) return e === E ? -1 : t === E ? 1 : r ? -1 : o ? 1 : C ? J(C, e) - J(C, t) : 0;
                if (r === o) return s(e, t);
            ...
            if ((e.ownerDocument || e) !== E && A(e), n = n.replace(le, "='$1']"), _.matchesSelector && O && !$[n + " "] && (!I || !I.test(n)) && (!N || !N.test(n))) try {
                var i = j.call(e, n);
                if (i || _.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (e) {}
            return t(n, E, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== E && A(e), R(e, t)
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== E && A(e);
            var n = w.attrHandle[t.toLowerCase()],
                i = n && B.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !O) : void 0;
            ...
            var t, n = [],
                i = 0,
                r = 0;
            if (M = !_.detectDuplicates, C = !_.sortStable && e.slice(0), e.sort(Y), M) {
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (p = [s ? g.firstChild : g.lastChild], s && y) {
                                for (d = g, h = d[L] || (d[L] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[e] || [], f = u[0] === H && u[1], _ = f && u[2], d = f && g.childNodes[f]; d = ++f && d && d[m] || (_ = f = 0) || p.pop();)
                                    if (1 === d.nodeType && ++_ && d === t) {
                                        c[e] = [H, f, _];
                                        break
                                    }
                            } else if (y && (d = t, h = d[L] || (d[L] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[e] || [], f = u[0] === H && u[1], _ = f), _ === !1)
                                for (;
                                    (d = ++f && d && d[m] || (_ = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++_ || (y && (h = d[L] || (d[L] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), c[e] = [H, _]), d !== t)););
            ...
            pseudos: {
                ...
                lang: i(function(e) {
                    return ce.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(ye, _e).toLowerCase(),
                        function(t) {
                            var n;
                            do {
        ...
        return u.prototype = w.filters = w.pseudos, w.setFilters = new u, k = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                o = $[e + " "];
            if (!o) {
                for (t || (t = k(e)), n = t.length; n--;) o = g(t[n]), o[L] ? i.push(o) : r.push(o);
                o = $(e, v(r, i)), o.selector = e
            }
            return o
        }, D = t.select = function(e, t, n, i) {
            var r, o, s, a, u, h = "function" == typeof e && e,
                d = !i && k(e = h.selector || e);
            if (n = n || [], 1 === d.length) {
                if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && _.getById && 9 === t.nodeType && O && w.relative[o[1].type]) {
                    if (!(t = (w.find.ID(s.matches[0].replace(ye, _e), t) || [])[0])) return n;
                    h && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (r = he.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !w.relative[a = s.type]);)
                    if ((u = w.find[a]) && (i = u(s.matches[0].replace(ye, _e), ge.test(o[0].type) && l(t.parentNode) || t))) {
                        if (o.splice(r, 1), !(e = i.length && c(o))) return X.apply(n, i), n;
                        break
                    }
            }
            return (h || T(e, d))(i, t, !O, n, !t || ge.test(e) && l(t.parentNode) || t), n
        }, _.sortStable = L.split("").sort(Y).join("") === L, _.detectDuplicates = !!M, A(), _.sortDetached = r(function(e) {
    ...
    de.filter = function(e, t, n) {
        ...
        find: function(e) {
            ...
            for (t = 0; t < r; t++) de.find(e, i[t], n);
            return n = this.pushStack(r > 1 ? de.unique(n) : n), n.selector = this.selector ? this.selector + " " + e : e, n
        },
        filter: function(e) {
        ...
        is: function(e) {
            return !!i(this, "string" == typeof e && ve.test(e) ? de(e) : e || [], !1).length
        }
    });
    var we, be = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (de.fn.init = function(e, t, n) {
        ...
        if (n = n || we, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof de ? t[0] : t, de.merge(this, de.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ie, !0)), ye.test(i[1]) && de.isPlainObject(t))
    ...
    de.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, i = 0, r = this.length, o = [], s = ve.test(e) || "string" != typeof e ? de(e, t || this.context) : 0; i < r; i++)
        ...
        de.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = de.filter(i, r)), this.length > 1 && (ke[e] || (r = de.uniqueSort(r)), xe.test(e) && (r = r.reverse())), this.pushStack(r)
        }
    });
    var Te = /\S+/g;
    de.Callbacks = function(e) {
            ...
            c = {
                add: function() {
                    return s && (n && !t && (l = s.length - 1, a.push(n)), function t(n) {
                        de.each(n, function(n, i) {
                            de.isFunction(i) ? e.unique && c.has(i) || s.push(i) : i && i.length && "string" !== de.type(i) && t(i)
                        })
                ...
                remove: function() {
                    return de.each(arguments, function(e, t) {
                        for (var n;
                            (n = de.inArray(t, s, n)) > -1;) s.splice(n, 1), n <= l && l--
                    }), this
                },
                has: function(e) {
        ...
        Deferred: function(e) {
            var t = [
                        ...
                        return de.Deferred(function(n) {
                            de.each(t, function(t, o) {
                                ...
                                r[o[1]](function() {
                                    ...
                                    e && de.isFunction(e.promise) ? e.promise().progress(n.notify).done(n.resolve).fail(n.reject) : n[o[0] + "With"](this === i ? n.promise() : this, s ? [e] : arguments)
                                })
                            }), e = null
                        }).promise()
                    },
                ...
                r = {};
            return i.pipe = i.then, de.each(t, function(e, o) {
                var s = o[2],
                    a = o[3];
        ...
        when: function(e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), i = new Array(s); r < s; r++) o[r] && de.isFunction(o[r].promise) ? o[r].promise().progress(u(r, n, t)).done(u(r, i, o)).fail(l.reject) : --a;
    ...
    de.fn.ready = function(e) {
        ...
        ready: function(e) {
            (e === !0 ? --de.readyWait : de.isReady) || (de.isReady = !0, e !== !0 && --de.readyWait > 0 || (De.resolveWith(ie, [de]), de.fn.triggerHandler && (de(ie).triggerHandler("ready"), de(ie).off("ready"))))
        }
    }), de.ready.promise = function(t) {
        if (!De)
            if (De = de.Deferred(), "complete" === ie.readyState || "loading" !== ie.readyState && !ie.documentElement.doScroll) e.setTimeout(de.ready);
    ...
    var Se;
    for (Se in de(he)) break;
    he.ownFirst = "0" === Se, he.inlineBlockNeedsLayout = !1, de(function() {
            var e, t, n, i;
    ...
    de.extend({
            ...
            data: function(e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (r = de.data(o), 1 === o.nodeType && !de._data(o, "parsedAttrs"))) {
                        for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = de.camelCase(i.slice(5)), l(o, i, r[i])));
            ...
            queue: function(e, t, n) {
                var i;
                if (e) return t = (t || "fx") + "queue", i = de._data(e, t), n && (!i || de.isArray(n) ? i = de._data(e, t, de.makeArray(n)) : i.push(n)), i || []
            },
            ...
            promise: function(e, t) {
                ...
                for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)(n = de._data(o[s], e + "queueHooks")) && n.empty && (i++, n.empty.add(a));
    ...
    de.event = {
        ...
        add: function(e, t, n, i, r) {
            var o, s, a, l, u, c, h, d, f, p, m, g = de._data(e);
            if (g) {
                for (n.handler && (l = n, n = l.handler, r = l.selector), n.guid || (n.guid = de.guid++), (s = g.events) || (s = g.events = {}), (c = g.handle) || (c = g.handle = function(e) {
                        return void 0 === de || e && de.event.triggered === e.type ? void 0 : de.event.dispatch.apply(c.elem, arguments)
                    }, c.elem = e), t = (t || "").match(Te) || [""], a = t.length; a--;) o = Ve.exec(t[a]) || [], f = m = o[1], p = (o[2] || "").split(".").sort(), f && (u = de.event.special[f] || {}, f = (r ? u.delegateType : u.bindType) || f, u = de.event.special[f] || {}, h = de.extend({
                    type: f,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: p.join(".")
                }, l), (d = s[f]) || (d = s[f] = [], d.delegateCount = 0, u.setup && u.setup.call(e, i, p, c) !== !1 || (e.addEventListener ? e.addEventListener(f, c, !1) : e.attachEvent && e.attachEvent("on" + f, c))), u.add && (u.add.call(e, h), h.handler.guid || (h.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, h) : d.push(h), de.event.global[f] = !0);
                e = null
            }
        },
        remove: function(e, t, n, i, r) {
            var o, s, a, l, u, c, h, d, f, p, m, g = de.hasData(e) && de._data(e);
            if (g && (c = g.events)) {
                for (t = (t || "").match(Te) || [""], u = t.length; u--;)
                    if (a = Ve.exec(t[u]) || [], f = m = a[1], p = (a[2] || "").split(".").sort(), f) {
                        for (h = de.event.special[f] || {}, f = (i ? h.delegateType : h.bindType) || f, d = c[f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = d.length; o--;) s = d[o], !r && m !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (d.splice(o, 1), s.selector && d.delegateCount--, h.remove && h.remove.call(e, s));
                        l && !d.length && (h.teardown && h.teardown.call(e, p, g.handle) !== !1 || de.removeEvent(e, f, g.handle), delete c[f])
                    } else
        ...
        trigger: function(t, n, i, r) {
            ...
            if (a = c = i = i || ie, 3 !== i.nodeType && 8 !== i.nodeType && !Be.test(f + de.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), s = f.indexOf(":") < 0 && "on" + f, t = t[de.expando] ? t : new de.Event(f, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : de.makeArray(n, [t]), u = de.event.special[f] || {}, r || !u.trigger || u.trigger.apply(i, n) !== !1)) {
                if (!r && !u.noBubble && !de.isWindow(i)) {
                    for (l = u.delegateType || f, Be.test(l + f) || (a = a.parentNode); a; a = a.parentNode) d.push(a), c = a;
                    c === (i.ownerDocument || ie) && d.push(c.defaultView || c.parentWindow || e)
                }
                for (h = 0;
                    (a = d[h++]) && !t.isPropagationStopped();) t.type = h > 1 ? l : u.bindType || f, o = (de._data(a, "events") || {})[t.type] && de._data(a, "handle"), o && o.apply(a, n), (o = s && a[s]) && o.apply && Ce(a) && (t.result = o.apply(a, n), t.result === !1 && t.preventDefault());
                if (t.type = f, !r && !t.isDefaultPrevented() && (!u._default || u._default.apply(d.pop(), n) === !1) && Ce(i) && s && i[f] && !de.isWindow(i)) {
                    c = i[s], c && (i[s] = null), de.event.triggered = f;
                    try {
                        i[f]()
                    } catch (e) {}
                    de.event.triggered = void 0, c && (i[s] = c)
                }
                return t.result
            }
        },
        dispatch: function(e) {
            ...
            var t, n, i, r, o, s = [],
                a = re.call(arguments),
                l = (de._data(this, "events") || {})[e.type] || [],
                u = de.event.special[e.type] || {};
            if (a[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
                for (s = de.event.handlers.call(this, e, l), t = 0;
                    (r = s[t++]) && !e.isPropagationStopped();)
                    for (e.currentTarget = r.elem, n = 0;
                        (o = r.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(o.namespace) || (e.handleObj = o, e.data = o.data, void 0 !== (i = ((de.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a)) && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
            ...
            if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
                        for (i = [], n = 0; n < a; n++) o = t[n], r = o.selector + " ", void 0 === i[r] && (i[r] = o.needsContext ? de(r, this).index(l) > -1 : de.find(r, this, null, [l]).length), i[r] && i.push(o);
                        i.length && s.push({
                            elem: l,
                            handlers: i
                        })
        ...
        fix: function(e) {
            ...
            var t, n, i, r = e.type,
                o = e,
                s = this.fixHooks[r];
            for (s || (this.fixHooks[r] = s = qe.test(r) ? this.mouseHooks : Ye.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new de.Event(o), t = i.length; t--;) n = i[t], e[n] = o[n];
        ...
        simulate: function(e, t, n) {
            ...
            de.event.trigger(i, null, t), i.isDefaultPrevented() && n.preventDefault()
        }
    }, de.removeEvent = ie.removeEventListener ? function(e, t, n) {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? y : _) : this.type = e, t && de.extend(this, t), this.timeStamp = e && e.timeStamp || de.now(), this[de.expando] = !0
    }, de.Event.prototype = {
    ...
    }), he.submit || (de.event.special.submit = {
        setup: function() {
        ...
        setup: function() {
            if ($e.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (de.event.add(this, "propertychange._change", function(e) {
            ...
            de.event.add(this, "beforeactivate._change", function(e) {
                var t = e.target;
                $e.test(t.nodeName) && !de._data(t, "change") && (de.event.add(t, "change._change", function(e) {
        ...
        teardown: function() {
            return de.event.remove(this, "._change"), !$e.test(this.nodeName)
        }
    }), he.focusin || de.each({
        focus: "focusin",
        blur: "focusout"
        ...
        de.event.special[t] = {
            setup: function() {
                var i = this.ownerDocument || this,
                    r = de._data(i, t);
                r || i.addEventListener(e, n, !0), de._data(i, t, (r || 0) + 1)
            },
            teardown: function() {
                var i = this.ownerDocument || this,
                    r = de._data(i, t) - 1;
                r ? de._data(i, t, r) : (i.removeEventListener(e, n, !0), de._removeData(i, t))
            }
        }
    }), de.fn.extend({
        on: function(e, t, n, i) {
    ...
    var Qe = new RegExp("<(?:" + He + ")[\\s/>]", "i"),
        Ge = /<script|<style|<link/i,
        Xe = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Ke = /^true\/(.*)/,
        Je = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        Ze = f(ie),
        et = Ze.appendChild(ie.createElement("div"));
    de.extend({
        htmlPrefilter: function(e) {
            return e.replace(/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, "<$1></$2>")
        },
        clone: function(e, t, n) {
            var i, r, o, s, a, l = de.contains(e.ownerDocument, e);
            if (he.html5Clone || de.isXMLDoc(e) || !Qe.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (et.innerHTML = e.outerHTML, et.removeChild(o = et.firstChild)), !(he.noCloneEvent && he.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || de.isXMLDoc(e)))
                for (i = p(o), a = p(e), s = 0; null != (r = a[s]); ++s) i[s] && S(r, i[s]);
            if (t)
                if (n)
                    for (a = a || p(e), i = i || p(o), s = 0; null != (r = a[s]); s++) D(r, i[s]);
                else D(e, o);
            return i = p(o, "script"), i.length > 0 && m(i, !l && p(e, "script")), i = a = r = null, o
        },
        cleanData: function(e, t) {
            for (var n, i, r, o, s = 0, a = de.expando, l = de.cache, u = he.attributes, c = de.event.special; null != (n = e[s]); s++)
                if ((t || Ce(n)) && (r = n[a], o = r && l[r])) {
                    if (o.events)
                        for (i in o.events) c[i] ? de.event.remove(n, i) : de.removeEvent(n, i, o.handle);
        ...
        text: function(e) {
            return Ie(this, function(e) {
                return void 0 === e ? de.text(this) : this.empty().append((this[0] && this[0].ownerDocument || ie).createTextNode(e))
        ...
        html: function(e) {
            return Ie(this, function(e) {
                ...
                if ("string" == typeof e && !Ge.test(e) && (he.htmlSerialize || !Qe.test(e)) && (he.leadingWhitespace || !Fe.test(e)) && !ze[(Re.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = de.htmlPrefilter(e);
                    try {
                        for (; n < i; n++) t = this[n] || {}, 1 === t.nodeType && (de.cleanData(p(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        de.fn[e] = function(e) {
            for (var n, i = 0, r = [], o = de(e), s = o.length - 1; i <= s; i++) n = i === s ? this : this.clone(!0), de(o[i])[t](n), se.apply(r, n.get());
    ...
    var at, lt, ut = /^(top|right|bottom|left)$/;
    e.getComputedStyle ? (at = function(t) {
        var n = t.ownerDocument.defaultView;
        return n && n.opener || (n = e), n.getComputedStyle(t)
    }, lt = function(e, t, n) {
        var i, r, o, s, a = e.style;
        return n = n || at(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || de.contains(e.ownerDocument, e) || (s = de.style(e, t)), n && !he.pixelMarginRight() && rt.test(s) && it.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o), void 0 === s ? s : s + ""
    }) : st.currentStyle && (at = function(e) {
        return e.currentStyle
    }, lt = function(e, t, n) {
        var i, r, o, s, a = e.style;
        return n = n || at(e), s = n ? n[t] : void 0, null == s && a && a[t] && (s = a[t]), rt.test(s) && !ut.test(t) && (i = a.left, r = e.runtimeStyle, o = r && r.left, o && (r.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em" : s, s = a.pixelLeft + "px", a.left = i, o && (r.left = o)), void 0 === s ? s : s + "" || "auto"
    });
    var ct = /alpha\([^)]*\)/i,
        ht = /opacity\s*=\s*([^)]*)/i,
        dt = /^(none|table(?!-c[ea]).+)/,
    ...
    de.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = de.camelCase(t),
                    l = e.style;
                if (t = de.cssProps[a] || (de.cssProps[a] = O(a) || a), s = de.cssHooks[t] || de.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : l[t];
                if (o = typeof n, "string" === o && (r = Pe.exec(n)) && r[1] && (n = d(e, t, r), o = "number"), null != n && n === n && ("number" === o && (n += r && r[3] || (de.cssNumber[a] ? "" : "px")), he.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(s && "set" in s && void 0 === (n = s.set(e, n, i))))) try {
                    l[t] = n
                } catch (e) {}
            }
        },
        css: function(e, t, n, i) {
            var r, o, s, a = de.camelCase(t);
            return t = de.cssProps[a] || (de.cssProps[a] = O(a) || a), s = de.cssHooks[t] || de.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = lt(e, t, i)), "normal" === o && t in mt && (o = mt[t]), "" === n || n ? (r = parseFloat(o), n === !0 || isFinite(r) ? r || 0 : o) : o
        }
        ...
        de.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var r = i && at(e);
                return I(e, n, i ? j(e, t, i, he.boxSizing && "border-box" === de.css(e, "boxSizing", !1, r), r) : 0)
            }
        }
    }), he.opacity || (de.cssHooks.opacity = {
        get: function(e, t) {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1, (t >= 1 || "" === t) && "" === de.trim(o.replace(ct, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || i && !i.filter) || (n.filter = ct.test(o) ? o.replace(ct, r) : o + " " + r)
        }
    }), de.cssHooks.marginRight = P(he.reliableMarginRight, function(e, t) {
        if (t) return ot(e, {
            display: "inline-block"
        }, lt, [e, "marginRight"])
    }), de.cssHooks.marginLeft = P(he.reliableMarginLeft, function(e, t) {
        if (t) return (parseFloat(lt(e, "marginLeft")) || (de.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - ot(e, {
            marginLeft: 0
        }, function() {
        ...
        }, it.test(e) || (de.cssHooks[e + t].set = I)
    }), de.fn.extend({
        css: function(e, t) {
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                Ne(this) ? de(this).show() : de(this).hide()
            })
        }
    ...
    de.Animation = de.extend($, {
            ...
            tweener: function(e, t) {
                de.isFunction(e) ? (t = e, e = ["*"]) : e = e.match(Te);
    ...
    de.fn.extend({
        val: function(e) {
            var t, n, i, r = this[0]; {
                ...
                if (r) return (t = de.valHooks[r.type] || de.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(/\r/g, "") : null == n ? "" : n)
            }
        }
    }), de.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || r < 0, s = o ? null : [], a = o ? r + 1 : i.length, l = r < 0 ? a : o ? r : 0; l < a; l++)
                        if (n = i[l], (n.selected || l === r) && (he.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !de.nodeName(n.parentNode, "optgroup"))) {
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, o = de.makeArray(t), s = r.length; s--;)
                        if (i = r[s], de.inArray(de.valHooks.option.get(i), o) > -1) try {
                            i.selected = n = !0
                        } catch (e) {
                            i.scrollHeight
                        } else i.selected = !1;
    ...
    var xt, kt, Tt = de.expr.attrHandle,
        Dt = /^(?:checked|selected)$/i,
        St = he.getSetAttribute,
        Ct = he.input;
    de.fn.extend({
        attr: function(e, t) {
            return Ie(this, de.attr, e, t, arguments.length > 1)
        },
        ...
        attr: function(e, t, n) {
            var i, r, o = e.nodeType;
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? de.prop(e, t, n) : (1 === o && de.isXMLDoc(e) || (t = t.toLowerCase(), r = de.attrHooks[t] || (de.expr.match.bool.test(t) ? kt : xt)), void 0 !== n ? null === n ? void de.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = de.find.attr(e, t), null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
                    if (!he.radioValue && "radio" === t && de.nodeName(e, "input")) {
                        var n = e.value;
        ...
        removeAttr: function(e, t) {
            var n, i, r = 0,
                o = t && t.match(Te);
            if (o && 1 === e.nodeType)
                for (; n = o[r++];) i = de.propFix[n] || n, de.expr.match.bool.test(n) ? Ct && St || !Dt.test(n) ? e[i] = !1 : e[de.camelCase("default-" + n)] = e[i] = !1 : de.attr(e, n, ""), e.removeAttribute(St ? n : i)
        }
    }), kt = {
        set: function(e, t, n) {
            return t === !1 ? de.removeAttr(e, n) : Ct && St || !Dt.test(n) ? e.setAttribute(!St && de.propFix[n] || n, n) : e[de.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, de.each(de.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var n = Tt[t] || de.find.attr;
        Ct && St || !Dt.test(t) ? Tt[t] = function(e, t, i) {
            var r, o;
            return i || (o = Tt[t], Tt[t] = r, r = null != n(e, t, i) ? t.toLowerCase() : null, Tt[t] = o), r
        } : Tt[t] = function(e, t, n) {
            if (!n) return e[de.camelCase("default-" + t)] ? t.toLowerCase() : null
        }
    }), Ct && St || (de.attrHooks.value = {
        set: function(e, t, n) {
            if (!de.nodeName(e, "input")) return xt && xt.set(e, t, n);
            e.defaultValue = t
        }
    }), St || (xt = {
        set: function(e, t, n) {
    ...
    de.fn.extend({
        prop: function(e, t) {
            return Ie(this, de.prop, e, t, arguments.length > 1)
        },
    ...
    }), he.hrefNormalized || de.each(["href", "src"], function(e, t) {
        de.propHooks[t] = {
            get: function(e) {
                return e.getAttribute(t, 4)
            }
        }
    }), he.optSelected || (de.propHooks.selected = {
        get: function(e) {
            var t = e.parentNode;
    ...
    }), he.enctype || (de.propFix.enctype = "encoding");
    de.fn.extend({
        addClass: function(e) {
            var t, n, i, r, o, s, a, l = 0;
            if (de.isFunction(e)) return this.each(function(t) {
                de(this).addClass(e.call(this, t, Y(this)))
            });
            if ("string" == typeof e && e)
                for (t = e.match(Te) || []; n = this[l++];)
                    if (r = Y(n), i = 1 === n.nodeType && (" " + r + " ").replace(/[\t\r\n\f]/g, " ")) {
                        for (s = 0; o = t[s++];) i.indexOf(" " + o + " ") < 0 && (i += o + " ");
                        a = de.trim(i), r !== a && de.attr(n, "class", a)
                    }
            return this
        },
        removeClass: function(e) {
            var t, n, i, r, o, s, a, l = 0;
            if (de.isFunction(e)) return this.each(function(t) {
                de(this).removeClass(e.call(this, t, Y(this)))
            });
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : de.isFunction(e) ? this.each(function(n) {
                de(this).toggleClass(e.call(this, n, Y(this), t), t)
            }) : this.each(function() {
                var t, i, r, o;
                if ("string" === n)
                    for (i = 0, r = de(this), o = e.match(Te) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = Y(this), t && de._data(this, "__className__", t), de.attr(this, "class", t || e === !1 ? "" : de._data(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + Y(n) + " ").replace(/[\t\r\n\f]/g, " ").indexOf(t) > -1) return !0;
            return !1
        }
    ...
    de.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, r) {
                var o, h, y, _, b, k = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), c = void 0, a = r || "", x.readyState = t > 0 ? 4 : 0, o = t >= 200 && t < 300 || 304 === t, i && (_ = Q(d, x, i)), _ = G(d, _, x, o), o ? (d.ifModified && (b = x.getResponseHeader("Last-Modified"), b && (de.lastModified[s] = b), (b = x.getResponseHeader("etag")) && (de.etag[s] = b)), 204 === t || "HEAD" === d.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = _.state, h = _.data, y = _.error, o = !y)) : (y = k, !t && k || (k = "error", t < 0 && (t = 0))), x.status = t, x.statusText = (n || k) + "", o ? m.resolveWith(f, [h, k, x]) : m.rejectWith(f, [x, k, y]), x.statusCode(v), v = void 0, u && p.trigger(o ? "ajaxSuccess" : "ajaxError", [x, d, o ? h : y]), g.fireWith(f, [x, k]), u && (p.trigger("ajaxComplete", [x, d]), --de.active || de.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var r, o, s, a, l, u, c, h, d = de.ajaxSetup({}, n),
                f = d.context || d,
                p = d.context && (f.nodeType || f.jquery) ? de(f) : de.event,
                m = de.Deferred(),
                ...
                x = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (2 === w) {
                            if (!h)
                                for (h = {}; t = It.exec(a);) h[t[1].toLowerCase()] = t[2];
                            t = h[e.toLowerCase()]
                        }
                    ...
                    setRequestHeader: function(e, t) {
                        var n = e.toLowerCase();
                        return w || (e = _[n] = _[n] || e, y[e] = t), this
                    },
            ...
            if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((t || d.url || Wt) + "").replace(/#.*$/, "").replace(/^\/\//, Ut[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = de.trim(d.dataType || "*").toLowerCase().match(Te) || [""], null == d.crossDomain && (r = Lt.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === Ut[1] && r[2] === Ut[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Ut[3] || ("http:" === Ut[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = de.param(d.data, d.traditional)), B(Ft, d, n, x), 2 === w) return x;
            u = de.event && d.global, u && 0 == de.active++ && de.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Rt.test(d.type), s = d.url, d.hasContent || (d.data && (s = d.url += (Ot.test(s) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Nt.test(s) ? s.replace(Nt, "$1_=" + Pt++) : s + (Ot.test(s) ? "&" : "?") + "_=" + Pt++)), d.ifModified && (de.lastModified[s] && x.setRequestHeader("If-Modified-Since", de.lastModified[s]), de.etag[s] && x.setRequestHeader("If-None-Match", de.etag[s])), (d.data && d.hasContent && d.contentType !== !1 || n.contentType) && x.setRequestHeader("Content-Type", d.contentType), x.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + zt + "; q=0.01" : "") : d.accepts["*"]);
            ...
            if (c = B(Ht, d, n, x)) {
                if (x.readyState = 1, u && p.trigger("ajaxSend", [x, d]), 2 === w) return x;
    ...
    de.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !de(this).is(":disabled") && qt.test(this.nodeName) && !Yt.test(e) && (this.checked || !je.test(e))
            }).map(function(e, t) {
                var n = de(this).val();
    ...
    var Bt = 0,
        Vt = {},
        Qt = de.ajaxSettings.xhr();
    e.attachEvent && e.attachEvent("onunload", function() {
        for (var e in Vt) Vt[e](void 0, !0)
    }), he.cors = !!Qt && "withCredentials" in Qt, Qt = he.ajax = !!Qt, Qt && de.ajaxTransport(function(t) {
                ...
                send: function(i, r) {
                    ...
                    s.send(t.hasContent && t.data || null), n = function(e, i) {
                        ...
                        if (n && (i || 4 === s.readyState))
                            if (delete Vt[a], n = void 0, s.onreadystatechange = de.noop, i) 4 !== s.readyState && s.abort();
                            else {
                    ...
                    }, t.async ? 4 === s.readyState ? e.setTimeout(n) : s.onreadystatechange = Vt[a] = n : n()
                },
                abort: function() {
                    n && n(void 0, !0)
                }
        ...
        if (e.crossDomain) {
            var t, n = ie.head || de("head")[0] || ie.documentElement;
            return {
                send: function(i, r) {
    ...
    de.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Gt.pop() || de.expando + "_" + Pt++;
            return this[e] = !0, e
        }
    }), de.ajaxPrefilter("json jsonp", function(t, n, i) {
        var r, o, s, a = t.jsonp !== !1 && (Xt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(t.data) && "data");
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = de.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Xt, "$1" + r) : t.jsonp !== !1 && (t.url += (Ot.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return s || de.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
            s = arguments
        }, i.always(function() {
            void 0 === o ? de(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Gt.push(r)), s && de.isFunction(o) && o(s[0]), s = o = void 0
        }), "script"
        ...
        var i = ye.exec(e),
            r = !n && [];
        return i ? [t.createElement(i[1])] : (i = v([e], t, r), r && r.length && de(r).remove(), de.merge([], i.childNodes))
    };
    var Kt = de.fn.load;
    de.fn.load = function(e, t, n) {
        ...
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = de.trim(e.slice(a, e.length)), e = e.slice(0, a)), de.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), s.length > 0 && de.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, u, c = de.css(e, "position"),
                h = de(e),
                d = {};
            "static" === c && (e.style.position = "relative"), a = h.offset(), o = de.css(e, "top"),
                l = de.css(e, "left"), u = ("absolute" === c || "fixed" === c) && de.inArray("auto", [o, l]) > -1, u ? (i = h.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), de.isFunction(t) && (t = t.call(e, n, de.extend({}, a))), null != t.top && (d.top = t.top - a.top + s), null != t.left && (d.left = t.left - a.left + r), "using" in t ? t.using.call(e, d) : h.css(d)
        }
    }, de.fn.extend({
        offset: function(e) {
            ...
            var t, n, i = {
                ...
                r = this[0],
                o = r && r.ownerDocument;
            if (o) return t = o.documentElement, de.contains(t, r) ? (void 0 !== r.getBoundingClientRect && (i = r.getBoundingClientRect()), n = te(o), {
        ...
        de.fn[e] = function(i) {
            return Ie(this, function(e, i, r) {
                ...
                o ? o.scrollTo(n ? de(o).scrollLeft() : r, n ? r : de(o).scrollTop()) : e[i] = r
            }, e, i, arguments.length, null)
        }
    }), de.each(["top", "left"], function(e, t) {
        de.cssHooks[t] = P(he.pixelPosition, function(e, n) {
            if (n) return n = lt(e, t), rt.test(n) ? de(e).position()[t] + "px" : n
        })
    }), de.each({
        Height: "height",
        Width: "width"
        ...
        de.each({
            ...
            de.fn[i] = function(i, r) {
                ...
                return Ie(this, function(t, n, i) {
                    var r;
                    return de.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement, Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === i ? de.css(t, n, s) : de.style(t, n, i, s)
                }, t, o ? i : void 0, o, null)
            }
        })
    }), de.fn.extend({
    ...
    return de.noConflict = function(t) {
        return e.$ === de && (e.$ = Zt), t && e.jQuery === de && (e.jQuery = Jt), de
    }, t || (e.jQuery = e.$ = de), de
}),
function(e, t, n) {
    function i(n) {
    ...
    r(e, "attrFn", s || {}, "jQuery.attrFn is deprecated"), e.attr = function(t, n, r, o) {
        var l = n.toLowerCase(),
            u = t && t.nodeType;
        return o && (a.length < 4 && i("jQuery.fn.attr( props, pass ) is deprecated"), t && !h.test(u) && (s ? n in s : e.isFunction(e.fn[n]))) ? e(t)[n](r) : ("type" === n && void 0 !== r && c.test(t.nodeName) && t.parentNode && i("Can't change the 'type' of an input or button in IE 6/7/8"), !e.attrHooks[l] && d.test(l) && (e.attrHooks[l] = {
            get: function(t, n) {
                var i, r = e.prop(t, n);
                return r === !0 || "boolean" != typeof r && (i = t.getAttributeNode(n)) && i.nodeValue !== !1 ? n.toLowerCase() : void 0
            },
            set: function(t, n, i) {
                var r;
                return n === !1 ? e.removeAttr(t, i) : (r = e.propFix[i] || i, r in t && (t[r] = !0), t.setAttribute(i, i.toLowerCase())), i
            }
        }, f.test(l) && i("jQuery.fn.attr('" + l + "') might use property instead of attribute")), a.call(e, t, n, r))
    }, e.attrHooks.value = {
        get: function(e, t) {
    ...
    e.fn.init = function(t, n, r) {
        var o, s;
        return t && "string" == typeof t && !e.isPlainObject(n) && (o = b.exec(e.trim(t))) && o[0] && (_.test(t) || i("$(html) HTML strings must start with '<' character"), o[3] && i("$(html) HTML text after last tag is ignored"), "#" === o[0].charAt(0) && (i("HTML string cannot start with a '#' character"), e.error("JQMIGRATE: Invalid selector string (XSS)")), n && n.context && n.context.nodeType && (n = n.context), e.parseHTML) ? g.call(this, e.parseHTML(o[2], n && n.ownerDocument || n || document, !0), n, r) : (s = g.apply(this, arguments), t && void 0 !== t.selector ? (s.selector = t.selector, s.context = t.context) : (s.selector = "string" == typeof t ? t : "", t && (s.context = t.nodeType ? t : n || document)), s)
    }, e.fn.init.prototype = e.fn, e.find = function(e) {
        var t = Array.prototype.slice.call(arguments);
        if ("string" == typeof e && w.test(e)) try {
            document.querySelector(e)
        } catch (n) {
            e = e.replace(/\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, function(e, t, n, i) {
                return "[" + t + n + '"' + i + '"]'
            });
            try {
    ...
    var x;
    for (x in v) Object.prototype.hasOwnProperty.call(v, x) && (e.find[x] = v[x]);
    ...
    e.swap && e.each(["height", "width", "reliableMarginRight"], function(t, n) {
        ...
        i && (e.cssHooks[n].get = function() {
            var e;
            return k = !0, e = i.apply(this, arguments), k = !1, e
        })
    }), e.swap = function(e, t, n, r) {
        var o, s, a = {};
        k || i("jQuery.swap() is undocumented and deprecated");
    ...
    e.fn.data = function(t) {
        var n, r, o = this[0];
        return !o || "events" !== t || 1 !== arguments.length || (n = e.data(o, t), r = e._data(o, t), void 0 !== n && n !== r || void 0 === r) ? T.apply(this, arguments) : (i("Use of jQuery.fn.data('events') is deprecated"), r)
    };
    ...
    e.clean || (e.clean = function(t, n, r, o) {
        ...
        if (e.merge(c, e.buildFragment(t, n).childNodes), r)
            for (l = function(e) {
                    if (!e.type || D.test(e.type)) return o ? o.push(e.parentNode ? e.parentNode.removeChild(e) : e) : r.appendChild(e)
                }, s = 0; null != (a = c[s]); s++) e.nodeName(a, "script") && l(a) || (r.appendChild(a), void 0 !== a.getElementsByTagName && (u = e.grep(e.merge([], a.getElementsByTagName("script")), l), c.splice.apply(c, [s + 1, 0].concat(u)), s += u.length));
        return c
    });
    var S = e.event.add,
        C = e.event.remove,
    ...
    e.event.props && "attrChange" !== e.event.props[0] && e.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), e.event.dispatch && r(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), e.event.add = function(e, t, n, r, o) {
        e !== document && I.test(t) && i("AJAX events should be attached to document: " + t), S.call(this, e, R(t || ""), n, r, o)
    }, e.event.remove = function(e, t, n, i, r) {
        C.call(this, e, R(t) || "", n, i, r)
        ...
        return i("jQuery.fn.live() is deprecated"), E ? E.apply(this, arguments) : (e(this.context).on(t, this.selector, n, r), this)
    }, e.fn.die = function(t, n) {
        return i("jQuery.fn.die() is deprecated"), P ? P.apply(this, arguments) : (e(this.context).off(t, this.selector || "**", n), this)
    }, e.event.trigger = function(e, t, n, r) {
        return n || I.test(e) || i("Global events are undocumented and deprecated"), M.call(this, e, t, n || document, r)
...
function(e, t) {
    ...
    e.rails = n = {
        ...
        isRemote: function(e) {
            return void 0 !== e.data("remote") && e.data("remote") !== !1
        },
        handleRemote: function(t) {
            var i, r, o, s, a, l;
            if (n.fire(t, "ajax:before")) {
                if (s = t.data("with-credentials") || null, a = t.data("type") || e.ajaxSettings && e.ajaxSettings.dataType, t.is("form")) {
                    i = t.data("ujs:submit-button-formmethod") || t.attr("method"), r = t.data("ujs:submit-button-formaction") || t.attr("action"), o = e(t[0]).serializeArray();
                    var u = t.data("ujs:submit-button");
                    u && (o.push(u), t.data("ujs:submit-button", null)), t.data("ujs:submit-button-formmethod", null), t.data("ujs:submit-button-formaction", null)
                } else t.is(n.inputChangeSelector) ? (i = t.data("method"), r = t.data("url"), o = t.serialize(), t.data("params") && (o = o + "&" + t.data("params"))) : t.is(n.buttonClickSelector) ? (i = t.data("method") || "get", r = t.data("url"), o = t.serialize(), t.data("params") && (o = o + "&" + t.data("params"))) : (i = t.data("method"), r = n.href(t), o = t.data("params") || null);
                return l = {
                    type: i || "GET",
                    data: o,
                    dataType: a,
                    beforeSend: function(e, i) {
                        if (void 0 === i.dataType && e.setRequestHeader("accept", "*/*;q=0.5, " + i.accepts.script), !n.fire(t, "ajax:beforeSend", [e, i])) return !1;
                        t.trigger("ajax:send", e)
                    },
                    success: function(e, n, i) {
                        t.trigger("ajax:success", [e, n, i])
                    },
                    complete: function(e, n) {
                        t.trigger("ajax:complete", [e, n])
                    },
                    error: function(e, n, i) {
                        t.trigger("ajax:error", [e, n, i])
                    },
        ...
        handleMethod: function(t) {
            ...
            void 0 === a || void 0 === s || n.isCrossDomain(i) || (u += '<input name="' + a + '" value="' + s + '" type="hidden" />'), o && l.attr("target", o), l.hide().append(u).appendTo("body"), l.submit()
        },
        ...
        disableFormElement: function(e) {
            var t, n;
            t = e.is("button") ? "html" : "val", n = e.data("disable-with"), void 0 !== n && (e.data("ujs:enable-with", e[t]()), e[t](n)), e.prop("disabled", !0), e.data("ujs:disabled", !0)
        },
        ...
        enableFormElement: function(e) {
            ...
            void 0 !== e.data("ujs:enable-with") && (e[t](e.data("ujs:enable-with")), e.removeData("ujs:enable-with")), e.prop("disabled", !1), e.removeData("ujs:disabled")
        },
        ...
        blankInputs: function(t, n, i) {
            ...
            return c.each(function() {
                r = e(this), r.is("input[type=radio]") ? (a = r.attr("name"), h[a] || (0 === t.find('input[type=radio]:checked[name="' + a + '"]').length && (s = t.find('input[type=radio][name="' + a + '"]'), l = l.add(s)), h[a] = a)) : (o = r.is("input[type=checkbox],input[type=radio]") ? r.is(":checked") : !!r.val()) === i && (l = l.add(r))
            }), !!l.length && l
        },
        ...
        disableElement: function(e) {
            ...
            void 0 !== t && (e.data("ujs:enable-with", e.html()), e.html(t)), e.bind("click.railsDisable", function(e) {
                return n.stopEverything(e)
            }), e.data("ujs:disabled", !0)
        },
        enableElement: function(e) {
            void 0 !== e.data("ujs:enable-with") && (e.html(e.data("ujs:enable-with")), e.removeData("ujs:enable-with")), e.unbind("click.railsDisable"), e.removeData("ujs:disabled")
        }
    ...
    }), i.on("submit.rails", n.formSubmitSelector, function(t) {
        var i, r, o = e(this),
            s = n.isRemote(o);
        if (!n.allowAction(o)) return n.stopEverything(t);
        if (void 0 === o.attr("novalidate"))
            if (void 0 === o.data("ujs:formnovalidate-button")) {
                if ((i = n.blankInputs(o, n.requiredInputSelector, !1)) && n.fire(o, "ajax:aborted:required", [i])) return n.stopEverything(t)
        ...
        if (s) {
            if (r = n.nonBlankInputs(o, n.fileInputSelector)) {
                ...
                var a = n.fire(o, "ajax:aborted:file", [r]);
    ...
    function(e, t) {
        ...
        n.defaults = {}, n.expiresMultiplier = 86400, n.set = function(t, n, r) {
            if (i.isPlainObject(t))
                ...
                var s = void 0 !== r.expires ? r.expires : this.defaults.expires || "",
                    a = typeof s;
                "string" === a && "" !== s ? s = new Date(s) : "number" === a && (s = new Date(+new Date + 1e3 * this.expiresMultiplier * s)), "" !== s && "toGMTString" in s && (s = ";expires=" + s.toGMTString());
                var l = r.path || this.defaults.path;
                l = l ? ";path=" + l : "";
                var u = r.domain || this.defaults.domain;
                u = u ? ";domain=" + u : "";
                var c = r.secure || this.defaults.secure ? ";secure" : "";
                r.secure === !1 && (c = ""), e.cookie = i.encode(t) + "=" + i.encode(n) + s + l + u + c
            }
            return this
        }, n.setDefault = function(e, t, r) {
            if (i.isPlainObject(e)) {
                for (var o in e) void 0 === this.get(o) && this.set(o, e[o], t);
                return n
            }
    ...
    function() {
        ...
        function t(e) {
            return function(t, n, i) {
                n = w(n, i);
                for (var r = D(t), o = e > 0 ? 0 : r - 1; o >= 0 && o < r; o += e)
        ...
        y.each = y.forEach = function(e, t, n) {
            ...
            var i;
            if (void 0 !== (i = S(e) ? y.findIndex(e, t, n) : y.findKey(e, t, n)) && i !== -1) return e[i]
            ...
            if (null == t && null != e) {
                e = S(e) ? e : y.values(e);
                for (var a = 0, l = e.length; a < l; a++)(i = e[a]) > o && (o = i)
            ...
            for (var t, n = S(e) ? e : y.values(e), i = n.length, r = Array(i), o = 0; o < i; o++) t = y.random(0, o), t !== o && (r[o] = r[t]), r[t] = n[o];
            return r
        ...
        var M = function(e, t, n, i) {
            for (var r = [], o = 0, s = i || 0, a = D(e); s < a; s++) {
                var l = e[s];
        ...
        y.flatten = function(e, t) {
            ...
            for (var t = [], n = arguments.length, i = 0, r = D(e); i < r; i++) {
                var o = e[i];
                if (!y.contains(t, o)) {
            ...
            for (var t = e && y.max(e, D).length || 0, n = Array(t), i = 0; i < t; i++) n[i] = y.pluck(e, i);
            return n
        }, y.object = function(e, t) {
            for (var n = {}, i = 0, r = D(e); i < r; i++) t ? n[e[i]] = t[i] : n[e[i][0]] = e[i][1];
            return n
        }, y.findIndex = t(1), y.findLastIndex = t(-1), y.sortedIndex = function(e, t, n, i) {
            n = w(n, i, 1);
            for (var r = n(t), o = 0, s = D(e); o < s;) {
        ...
        y.bind = function(e, t) {
            ...
            var n = c.call(arguments, 2),
                i = function() {
                    return A(e, i, t, this, n.concat(c.call(arguments)))
                };
            return i
        ...
        y.escape = j(N), y.unescape = j(I), y.result = function(e, t, n) {
        ...
        y.template = function(e, t, n) {
            ...
            e.replace(i, function(t, n, i, s, a) {
                return o += e.slice(r, a).replace(/\\|'|\r|\n|\u2028|\u2029/g, F), r = a + t.length, n ? o += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : i ? o += "'+\n((__t=(" + i + "))==null?'':__t)+\n'" : s && (o += "';\n" + s + "\n__p+='"), t
        ...
        y.mixin = function(e) {
            y.each(y.functions(e), function(t) {
                ...
                y.prototype[t] = function() {
                    var e = [this._wrapped];
                    return u.apply(e, arguments), H(this, n.apply(y, e))
                }
            })
    ...
    function(e, t) {
        ...
        function i(e, t) {
            return "onerror" === e ? void ve.on("error", t) : 2 !== arguments.length ? ve[e] : void(ve[e] = t)
        }
        ...
        function l() {
            setTimeout(function() {
                for (var e = 0; e < xe.length; e++) {
                    var t = xe[e],
                        n = t.payload;
                    n.guid = n.key + n.id, n.childGuid = n.key + n.childId, n.error && (n.stack = n.error.stack), ve.trigger(t.name, t.payload)
                }
                xe.length = 0
            }, 50)
        }
        ...
        function u(e, t, n) {
            1 === xe.push({
                ...
                payload: {
                    ...
                    label: t._label,
                    timeStamp: we(),
                    error: ve["instrument-with-stack"] ? new Error(t._label) : null
                }
            }) && l()
        }
        ...
        function g(e, t) {
            t._state === Te ? w(e, t._result) : t._state === De ? (t._onError = null, b(e, t._result)) : x(t, void 0, function(n) {
                t !== n ? y(e, n, void 0) : w(e, n)
            }, function(t) {
                return b(e, t)
            })
        }
        ...
        function v(e, t, n) {
            t.constructor === e.constructor && n === M && e.constructor.resolve === c ? g(e, t) : n === Se ? b(e, Se.error) : void 0 === n ? w(e, t) : o(n) ? m(e, t, n) : w(e, t)
        }

        function y(e, t) {
            e === t ? w(e, t) : r(t) ? v(e, t, f(t)) : w(e, t)
        }
        ...
        function w(e, t) {
            e._state === ke && (e._result = t, e._state = Te, 0 === e._subscribers.length ? ve.instrument && u("fulfilled", e) : ve.async(k, e))
        }

        function b(e, t) {
            e._state === ke && (e._state = De, e._result = t, ve.async(_, e))
        }

        function x(e, t, n, i) {
            var r = e._subscribers,
                o = r.length;
            e._onError = null, r[o] = t, r[o + Te] = n, r[o + De] = i, 0 === o && e._state && ve.async(k, e)
        }

        function k(e) {
            var t = e._subscribers,
                n = e._state;
            if (ve.instrument && u(n === Te ? "fulfilled" : "rejected", e), 0 !== t.length) {
                for (var i = void 0, r = void 0, o = e._result, s = 0; s < t.length; s += 3) i = t[s], r = t[s + n], i ? S(n, i, r, o) : r(o);
        ...
        function S(e, t, n, i) {
            var r = o(n),
                ...
                u = void 0;
            if (r) {
                if (s = D(n, i), s === Ce ? (u = !0, a = s.error, s = null) : l = !0, t === s) return void b(t, h())
            } else s = i, l = !0;
            t._state !== ke || (r && l ? y(t, s) : u ? b(t, a) : e === Te ? w(t, s) : e === De && b(t, s))
        }
        ...
        function M(e, t, n) {
            var i = arguments,
                r = this,
                o = r._state;
            if (o === Te && !e || o === De && !t) return ve.instrument && u("chained", r, r), r;
            r._onError = null;
            var s = new r.constructor(d, n),
                a = r._result;
            return ve.instrument && u("chained", r, s), o ? function() {
                var e = i[o - 1];
                ve.async(function() {
                    return S(o, s, e, a)
                })
        ...
        function E(e, t, n, i) {
            this._instanceConstructor = e, this.promise = new e(d, i), this._abortOnReject = n, this._validateInput(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._init(), 0 === this.length ? w(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && w(this.promise, this._result))) : b(this.promise, this._validationError())
        }

        function P(e, t) {
            return new E(this, e, !0, t).promise
        }

        function O(e, t) {
            var n = this,
                i = new n(d, t);
            if (!_e(e)) return b(i, new TypeError("You must pass an array to race.")), i;
            for (var r = 0; i._state === ke && r < e.length; r++) x(n.resolve(e[r]), void 0, function(e) {
                return y(i, e)
            }, function(e) {
                return b(i, e)
            });
        ...
        function R(e, t) {
            this._id = Ae++, this._label = t, this._state = void 0, this._result = void 0, this._subscribers = [], ve.instrument && u("created", this), d !== e && ("function" != typeof e && I(), this instanceof R ? C(this, e) : j())
        }
        ...
        function $(e, t) {
            var n = function() {
                ...
                return r[i] = function(e, n) {
                    e ? b(u, e) : void 0 === t ? y(u, n) : t === !0 ? y(u, W(arguments)) : _e(t) ? y(u, z(arguments, t)) : y(u, n)
                }, o ? q(u, r, e, n) : Y(u, r, e, n)
            };
        ...
        function le(e, t, n) {
            return (_e(e) ? se(e, n) : ae(e, n)).then(function(e) {
        ...
        function ue(e, t) {
            He[Oe] = e, He[Oe + 1] = t, 2 === (Oe += 2) && ze()
        }

        function ce() {
            return void 0 !== Ne ? function() {
                Ne(de)
            } : he()
        }
        ...
        function he() {
            return function() {
                return setTimeout(de, 1)
            }
        }

        function de() {
            for (var e = 0; e < Oe; e += 2) {
                (0, He[e])(He[e + 1]), He[e] = void 0, He[e + 1] = void 0
            }
            Oe = 0
        }
        ...
        function pe() {
            ve.on.apply(ve, arguments)
        }

        function me() {
            ve.off.apply(ve, arguments)
        }
        var ge = {
                mixin: function(e) {
                ...
                off: function(e, i) {
                    ...
                    o = r[e], (s = t(o, i)) !== -1 && o.splice(s, 1)
                },
                trigger: function(e, t, i) {
                    var r = n(this),
                        o = void 0;
                    if (o = r[e])
                        for (var s = 0; s < o.length; s++)(0, o[s])(t, i)
                }
            },
            ve = {
                instrument: !1
        ...
        E.prototype._validateInput = function(e) {
            ...
            for (var e = this.length, t = this.promise, n = this._input, i = 0; t._state === ke && i < e; i++) this._eachEntry(n[i], i)
        }, E.prototype._settleMaybeThenable = function(e, t) {
            var n = this._instanceConstructor,
                i = n.resolve;
            if (i === c) {
                var r = f(e);
                if (r === M && e._state !== ke) e._onError = null, this._settledAt(e._state, t, e._result);
                else if ("function" != typeof r) this._remaining--, this._result[t] = this._makeResult(Te, t, e);
                else if (n === R) {
                    var o = new n(d);
            ...
            s(e) ? this._settleMaybeThenable(e, t) : (this._remaining--, this._result[t] = this._makeResult(Te, t, e))
        }, E.prototype._settledAt = function(e, t, n) {
            var i = this.promise;
            i._state === ke && (this._remaining--, this._abortOnReject && e === De ? b(i, n) : this._result[t] = this._makeResult(e, t, n)), 0 === this._remaining && w(i, this._result)
            ...
            x(e, void 0, function(e) {
                ...
                return n._settledAt(De, t, e)
            })
        };
        var Me = "rsvp_" + we() + "-",
            Ae = 0;
        R.cast = c, R.all = P, R.race = O, R.resolve = c, R.reject = N, R.prototype = {
            constructor: R,
            _guidKey: Me,
            _onError: function(e) {
                var t = this;
                ve.after(function() {
                    t._onError && ve.trigger("error", e, t._label)
                })
            },
            then: M,
            catch: function(e, t) {
        ...
        var Ee = new L,
            Pe = new L;
        Q.prototype = be(E.prototype), Q.prototype._superConstructor = E, Q.prototype._makeResult = A, Q.prototype._validationError = function() {
            return new Error("allSettled must be called with an array")
        }, K.prototype = be(E.prototype), K.prototype._superConstructor = E, K.prototype._init = function() {
            this._result = {}
            ...
            var e = this,
                ...
                n = e._input,
                i = [];
            for (var r in n) t._state === ke && Object.prototype.hasOwnProperty.call(n, r) && i.push({
                position: r,
                entry: n[r]
            });
            var o = i.length;
            e._remaining = o;
            for (var s = void 0, a = 0; t._state === ke && a < o; a++) s = i[a], e._eachEntry(s.entry, s.position)
        }, Z.prototype = be(K.prototype), Z.prototype._superConstructor = E, Z.prototype._makeResult = A, Z.prototype._validationError = function() {
            return new Error("hashSettled must be called with an object")
        };
        var Oe = 0,
            Ne = void 0,
            Ie = "undefined" != typeof window ? window : void 0,
            je = Ie || {},
            Re = je.MutationObserver || je.WebKitMutationObserver,
            Le = "undefined" == typeof self && "undefined" != typeof process && "[object process]" === {}.toString.call(process),
            Fe = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel,
            He = new Array(1e3),
            ze = void 0;
        ze = Le ? function() {
            ...
            return e.port1.onmessage = de,
                function() {
                    return e.port2.postMessage(0)
                }
        }() : void 0 === Ie && "function" == typeof require ? function() {
            try {
                var e = require,
                    t = e("vertx");
                return Ne = t.runOnLoop || t.runOnContext, ce()
            } catch (e) {
                return he()
            }
        }() : he();
        ...
        var We;
        ve.async = ue, ve.after = function(e) {
        ...
        if ("undefined" != typeof window && "object" == typeof window.__PROMISE_INSTRUMENTATION__) {
            ...
            i("instrument", !0);
            for (var qe in Ye) Ye.hasOwnProperty(qe) && pe(qe, Ye[qe])
        }
        var Be = (We = {
            cast: Ue,
            Promise: R,
            ...
            reject: oe,
            map: ie
        }, fe(We, "async", $e), fe(We, "filter", le), We);
        e.default = Be, e.cast = Ue, e.Promise = R, e.EventTarget = ge, e.all = V, e.allSettled = G, e.race = X, e.hash = J, e.hashSettled = ee, e.rethrow = te, e.defer = ne, e.denodeify = $, e.configure = i, e.on = pe, e.off = me, e.resolve = re, e.reject = oe, e.map = ie, e.async = $e, e.filter = le, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    }),
    function(e) {
    ...
    function(e) {
        ...
        return function() {
            ...
            e.position = {
                ...
                }), 1 === b.length && (b[1] = b[0]), "right" === r.at[0] ? g.left += f : "center" === r.at[0] && (g.left += f / 2), "bottom" === r.at[1] ? g.top += p : "center" === r.at[1] && (g.top += p / 2), h = t(x.at, f, p), g.left += h[0], g.top += h[1], this.each(function() {
                    var i, a, l = e(this),
                        u = l.outerWidth(),
                        c = l.outerHeight(),
                        d = n(this, "marginLeft"),
                        v = n(this, "marginTop"),
                        k = u + d + n(this, "marginRight") + w.width,
                        T = c + v + n(this, "marginBottom") + w.height,
                        D = e.extend({}, g),
                        S = t(x.my, l.outerWidth(), l.outerHeight());
                    "right" === r.my[0] ? D.left -= u : "center" === r.my[0] && (D.left -= u / 2), "bottom" === r.my[1] ? D.top -= c : "center" === r.my[1] && (D.top -= c / 2), D.left += S[0], D.top += S[1], i = {
                        marginLeft: d,
                        marginTop: v
                    }, e.each(["left", "top"], function(t, n) {
                        e.ui.position[b[t]] && e.ui.position[b[t]][n](D, {
                            targetWidth: f,
                            targetHeight: p,
                            elemWidth: u,
                            elemHeight: c,
                ...
                fit: {
                    left: function(e, t) {
                        ...
                        t.collisionWidth > s ? l > 0 && u <= 0 ? (n = e.left + l + t.collisionWidth - s - r, e.left += l - n) : e.left = u > 0 && l <= 0 ? r : l > u ? r + s - t.collisionWidth : r : l > 0 ? e.left += l : u > 0 ? e.left -= u : e.left = o(e.left - a, e.left)
                    },
                    top: function(e, t) {
                        var n, i = t.within,
                        ...
                        t.collisionHeight > s ? l > 0 && u <= 0 ? (n = e.top + l + t.collisionHeight - s - r, e.top += l - n) : e.top = u > 0 && l <= 0 ? r : l > u ? r + s - t.collisionHeight : r : l > 0 ? e.top += l : u > 0 ? e.top -= u : e.top = o(e.top - a, e.top)
                    }
                },
                flip: {
                    left: function(e, t) {
                        var n, i, r = t.within,
                            ...
                            p = -2 * t.offset[0];
                        c < 0 ? ((n = e.left + d + f + p + t.collisionWidth - a - o) < 0 || n < s(c)) && (e.left += d + f + p) : h > 0 && ((i = e.left - t.collisionPosition.marginLeft + d + f + p - l) > 0 || s(i) < h) && (e.left += d + f + p)
                    },
                    top: function(e, t) {
                        var n, i, r = t.within,
                            ...
                            m = -2 * t.offset[1];
                        c < 0 ? ((i = e.top + f + p + m + t.collisionHeight - a - o) < 0 || i < s(c)) && (e.top += f + p + m) : h > 0 && ((n = e.top - t.collisionPosition.marginTop + f + p + m - l) > 0 || s(n) < h) && (e.top += f + p + m)
                    }
                },
                flipfit: {
                    left: function() {
        ...
        return e.widget("ui.resizable", e.ui.mouse, {
            ...
            _mouseStart: function(t) {
                var n, i, r, o = this.options,
                    s = this.element;
                return this.resizing = !0, this._renderProxy(), n = this._num(this.helper.css("left")), i = this._num(this.helper.css("top")),
                    o.containment && (n += e(o.containment).scrollLeft() || 0, i += e(o.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                        left: n,
                        top: i
            ...
            start: function() {
                e(e(this).resizable("instance").options.alsoResize).each(function() {
                    var t = e(this);
    ...
    function(e) {
        ...
        return e.widget("ui.button", {
            ...
            _setOption: function(e, t) {
                if ("text" === e) return void this._super("showLabel", t);
                "showLabel" === e && (this.options.text = t), "icon" === e && (this.options.icons.primary = t), "icons" === e && (t.primary ? (this._super("icon", t.primary), this._super("iconPosition", "beginning")) : t.secondary && (this._super("icon", t.secondary), this._super("iconPosition", "end"))), this._superApply(arguments)
            }
        ...
        return e.extend(n.prototype, {
            ...
            _attachments: function(t, n) {
                var i, r, o, s = this._get(n, "appendText"),
                    a = this._get(n, "isRTL");
                n.append && n.append.remove(), s && (n.append = e("<span class='" + this._appendClass + "'>" + s + "</span>"), t[a ? "before" : "after"](n.append)), t.off("focus", this._showDatepicker), n.trigger && n.trigger.remove(), i = this._get(n, "showOn"), "focus" !== i && "both" !== i || t.on("focus", this._showDatepicker), "button" !== i && "both" !== i || (r = this._get(n, "buttonText"), o = this._get(n, "buttonImage"),
                ...
                for (r = 0; r < t.length; r++)
                    if (_) "'" !== t.charAt(r) || w("'") ? k() : _ = !1;
                        ...
                        case "y":
                            ...
                            break;
                        case "@":
                            a = new Date(b("@")), m = a.getFullYear(), g = a.getMonth() + 1, v = a.getDate();
                            break;
                        case "!":
                            a = new Date((b("!") - this._ticksTo1970) / 1e4), m = a.getFullYear(), g = a.getMonth() + 1, v = a.getDate();
                            break;
                        case "'":
                            w("'") ? k() : _ = !0;
                            break;
            ...
            _generateHTML: function(e) {
                var t, n, i, r, o, s, a, l, u, c, h, d, f, p, m, g, v, y, _, w, b, x, k, T, D, S, C, M, A, E, P, O, N, I, j, R, L, F, H, z = new Date,
                    ...
                    ee = e.drawYear;
                if (Z < 0 && (Z += 12, ee--), J)
                    for (t = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - B[0] * B[1] + 1, J.getDate())), t = K && t < K ? K : t; this._daylightSavingAdjust(new Date(ee, Z, 1)) > t;) --Z < 0 && (Z = 11, ee--);
                for (e.drawMonth = Z, e.drawYear = ee, n = this._get(e, "prevText"), n = q ? this.formatDate(n, this._daylightSavingAdjust(new Date(ee, Z - Q, 1)), this._getFormatConfig(e)) : n, i = this._canAdjustMonth(e, -1, ee, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "e" : "w") + "'>" + n + "</span></a>" : Y ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "e" : "w") + "'>" + n + "</span></a>", r = this._get(e, "nextText"), r = q ? this.formatDate(r, this._daylightSavingAdjust(new Date(ee, Z + Q, 1)), this._getFormatConfig(e)) : r, o = this._canAdjustMonth(e, 1, ee, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + r + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "w" : "e") + "'>" + r + "</span></a>" : Y ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + r + "'><span class='ui-icon ui-icon-circle-triangle-" + (U ? "w" : "e") + "'>" + r + "</span></a>", s = this._get(e, "currentText"), a = this._get(e, "gotoCurrent") && e.currentDay ? X : W, s = q ? this.formatDate(s, a, this._getFormatConfig(e)) : s, l = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", u = $ ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (U ? l : "") + (this._isInRange(e, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + s + "</button>" : "") + (U ? "" : l) + "</div>" : "", c = parseInt(this._get(e, "firstDay"), 10), c = isNaN(c) ? 0 : c, h = this._get(e, "showWeek"), d = this._get(e, "dayNames"), f = this._get(e, "dayNamesMin"), p = this._get(e, "monthNames"), m = this._get(e, "monthNamesShort"), g = this._get(e, "beforeShowDay"), v = this._get(e, "showOtherMonths"), y = this._get(e, "selectOtherMonths"), _ = this._getDefaultDate(e), w = "", x = 0; x < B[0]; x++) {
                    for (k = "", this.maxRows = 4, T = 0; T < B[1]; T++) {
                        if (D = this._daylightSavingAdjust(new Date(ee, Z, e.selectedDay)), S = " ui-corner-all", C = "", G) {
                            if (C += "<div class='ui-datepicker-group", B[1] > 1) switch (T) {
                                case 0:
                                    C += " ui-datepicker-group-first", S = " ui-corner-" + (U ? "right" : "left");
                                    break;
                                case B[1] - 1:
                                    C += " ui-datepicker-group-last", S = " ui-corner-" + (U ? "left" : "right");
                                    break;
                                default:
                        ...
                        for (C += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === x ? U ? o : i : "") + (/all|right/.test(S) && 0 === x ? U ? i : o : "") + this._generateMonthYearHeader(e, Z, ee, K, J, x > 0 || T > 0, p, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", M = h ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", b = 0; b < 7; b++) A = (b + c) % 7, M += "<th scope='col'" + ((b + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[A] + "'>" + f[A] + "</span></th>";
                        for (C += M + "</tr></thead><tbody>", E = this._getDaysInMonth(ee, Z), ee === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, E)), P = (this._getFirstDayOfMonth(ee, Z) - c + 7) % 7, O = Math.ceil((P + E) / 7), N = G && this.maxRows > O ? this.maxRows : O, this.maxRows = N, I = this._daylightSavingAdjust(new Date(ee, Z, 1 - P)), j = 0; j < N; j++) {
                            for (C += "<tr>", R = h ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(I) + "</td>" : "", b = 0; b < 7; b++) L = g ? g.apply(e.input ? e.input[0] : null, [I]) : [!0, ""], F = I.getMonth() !== Z, H = F && !y || !L[0] || K && I < K || J && I > J, R += "<td class='" + ((b + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (I.getTime() === D.getTime() && Z === e.selectedMonth && e._keyEvent || _.getTime() === I.getTime() && _.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (H ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !v ? "" : " " + L[1] + (I.getTime() === X.getTime() ? " " + this._currentClass : "") + (I.getTime() === W.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !v || !L[2] ? "" : " title='" + L[2].replace(/'/g, "&#39;") + "'") + (H ? "" : " data-handler='selectDay' data-event='click' data-month='" + I.getMonth() + "' data-year='" + I.getFullYear() + "'") + ">" + (F && !v ? "&#xa0;" : H ? "<span class='ui-state-default'>" + I.getDate() + "</span>" : "<a class='ui-state-default" + (I.getTime() === W.getTime() ? " ui-state-highlight" : "") + (I.getTime() === X.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + I.getDate() + "</a>") + "</td>", I.setDate(I.getDate() + 1), I = this._daylightSavingAdjust(I);
                            C += R + "</tr>"
                        }
                        Z++, Z > 11 && (Z = 0, ee++), C += "</tbody></table>" + (G ? "</div>" + (B[0] > 0 && T === B[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), k += C
                    }
                    w += k
                }
            ...
            _generateMonthYearHeader: function(e, t, n, i, r, o, s, a) {
                ...
                if (o || !g) w += "<span class='ui-datepicker-month'>" + s[t] + "</span>";
                    ...
                    for (l = i && i.getFullYear() === n, u = r && r.getFullYear() === n, w += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", c = 0; c < 12; c++)(!l || c >= i.getMonth()) && (!u || c <= r.getMonth()) && (w += "<option value='" + c + "'" + (c === t ? " selected='selected'" : "") + ">" + a[c] + "</option>");
                    w += "</select>"
                }
                if (y || (_ += w + (!o && g && v ? "" : "&#xa0;")), !e.yearshtml)
                ...
                return _ += this._get(e, "yearSuffix"), y && (_ += (!o && g && v ? "" : "&#xa0;") + w), _ += "</div>"
            },
    ...
    function(e) {
        ...
        return e.widget("ui.menu", {
            ...
            nextPage: function(t) {
                ...
                this.isLastItem() || (this._hasScroll() ? (i = this.active.offset().top, r = this.element.height(), this.active.nextAll(".ui-menu-item").each(function() {
            ...
            previousPage: function(t) {
                var n, i, r;
                if (!this.active) return void this.next(t);
                this.isFirstItem() || (this._hasScroll() ? (i = this.active.offset().top, r = this.element.height(), this.active.prevAll(".ui-menu-item").each(function() {
                    return n = e(this), n.offset().top - i + r > 0
    ...
    function(e) {
        ...
        return e.widget("ui.slider", e.ui.mouse, {
            ...
            _mouseCapture: function(t) {
                ...
                }), this._start(t, s) !== !1 && (this._mouseSliding = !0, this._handleIndex = s, this._addClass(o, null, "ui-state-active"), o.trigger("focus"), a = o.offset(), l = !e(t.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = l ? {
                    left: 0,
                    top: 0
                } : {
            ...
            _slide: function(e, t, n) {
                var i, r = this.value(),
                    o = this.values();
                this._hasMultipleValues() && (i = this.values(t ? 0 : 1), r = this.values(t), 2 === this.options.values.length && this.options.range === !0 && (n = 0 === t ? Math.min(i, n) : Math.max(i, n)), o[t] = n), n !== r && this._trigger("slide", e, this._uiHash(t, n, o)) !== !1 && (this._hasMultipleValues() ? this.values(t, n) : this.value(n))
            },
            _stop: function(e, t) {
            ...
            _handleEvents: {
                keydown: function(t) {
                    ...
                    switch (t.keyCode) {
                        ...
                        case e.ui.keyCode.DOWN:
                        case e.ui.keyCode.LEFT:
                            if (t.preventDefault(), !this._keySliding && (this._keySliding = !0, this._addClass(e(t.target), null, "ui-state-active"), this._start(t, o) === !1)) return
                    }
    ...
    function(e) {
        ...
        i.prototype = {
            ...
            getTitle: function() {
                ...
                return "string" == typeof n.title ? e = t.attr("title" == n.title ? "original-title" : n.title) : "function" == typeof n.title && (e = n.title.call(t[0])), (e = ("" + e).replace(/(^\s*|\s*$)/, "")) || n.fallback
            },
            tip: function() {
    ...
    function(e, t, n) {
        ...
        r.special.smartresize = {
            ...
            _placeBrick: function(e) {
                var n, i, r, o, s, a = t(e);
                if (n = Math.ceil(a.outerWidth(!0) / (this.columnWidth + this.options.gutterWidth)), 1 === (n = Math.min(n, this.cols))) r = this.colYs;
                else
    ...
    function(e, t, n) {
        t.extend(!0, t.Mason.settings, {
            ...
            if (n = Math.ceil(s.outerWidth(!0) / (this.columnWidth + this.options.gutterWidth)), 1 === (n = Math.min(n, this.cols))) r = this.colYs;
            else {
                i = this.cols + 1 - n, r = [];
                for (var l = 0; l < i; l++) o = this.colYs.slice(l, l + n), r[l] = Math.max.apply(Math, o)
            }
            var u = Math.min.apply(Math, r),
                c = {
                    top: 0
                };
            c[a] = 0;
            ...
            if (void 0 != h) {
                var d = h.$el.outerWidth(!0),
                    f = h.style[a] - this.offset.x;
                c[a] = f + d, c.top = h.style.top;
                c[a] + n * this.columnWidth > this.cols * this.columnWidth && (c[a] = 0)
            }
            for (var p = this.options.layoutPriorities, m = [], g = 0, v = r.length; g < v; g++) {
                var y = Math.abs(c[a] - this.columnWidth * g),
                    _ = Math.abs(c.top - r[g]),
                    w = Math.pow(y, 2) + Math.pow(_, 2),
                    b = Math.round(Math.sqrt(w)),
                    x = p.shelfOrder * b,
                    k = p.upperPosition * (r[g] - u);
                m[g] = k + x
            }
            var T = Math.min.apply(null, m);
            ...
            D[a] = this.columnWidth * shortCol + this.offset.x, this.styleQueue.push({
                $el: s,
                style: D
            });
            var S = r[shortCol] + s.outerHeight(!0),
                C = this.cols + 1 - v;
            for (g = 0; g < C; g++) this.colYs[shortCol + g] = S
        }
    }(window, jQuery),
    function(e) {
        function t() {
            function t(e) {
                var a = e < 1e12 ? i ? performance.now() + performance.timing.navigationStart : n() : e || n();
                a - s >= 1e3 && (r._updateTargets(), s = a), o(t)
            }
        ...
        function n(t, n) {
            return "option" == t && (0 == n.length || 1 == n.length && "string" == typeof n[0]) || e.inArray(t, i) > -1
        }
        e.extend(t.prototype, {
            ...
            _determineTime: function(e, t) {
                var n = null == e ? t : "string" == typeof e ? function(e) {
                    e = e.toLowerCase();
                    for (var t = new Date, n = t.getFullYear(), i = t.getMonth(), o = t.getDate(), s = t.getHours(), a = t.getMinutes(), l = t.getSeconds(), u = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, c = u.exec(e); c;) {
                        switch (c[2] || "s") {
                            case "s":
                                l += parseInt(c[1], 10);
                                break;
                            ...
                            case "w":
                                ...
                                break;
                            case "o":
                                i += parseInt(c[1], 10), o = Math.min(o, r._getDaysInMonth(n, i));
                                break;
                            case "y":
                                n += parseInt(c[1], 10), o = Math.min(o, r._getDaysInMonth(n, i))
                        }
                        c = u.exec(e)
                    }
                    return new Date(n, i, o, s, a, l, 0)
            ...
            _generateHTML: function(t) {
                ...
                for (var i = !1, o = 0, s = t.options.significant, a = e.extend({}, t._show), l = 0; l <= 6; l++) i |= "?" == t._show[l] && t._periods[l] > 0, a[l] = "?" != t._show[l] || i ? t._show[l] : null, o += a[l] ? 1 : 0, s -= t._periods[l] > 0 ? 1 : 0;
                for (var u = [!1, !1, !1, !1, !1, !1, !1], l = 6; l >= 0; l--) t._show[l] && (t._periods[l] ? u[l] = !0 : (u[l] = s > 0, s--));
                var c = t.options.compact ? t.options.compactLabels : t.options.labels,
                    h = t.options.whichLabels || this._normalLabels,
                    d = function(e) {
                        var i = t.options["compactLabels" + h(t._periods[e])];
                        return a[e] ? n._translateDigits(t, t._periods[e]) + (i ? i[e] : c[e]) + " " : ""
                    },
                    f = function(e) {
                        var i = t.options["labels" + h(t._periods[e])];
                        return !t.options.significant && a[e] || t.options.significant && u[e] ? '<span class="' + r._sectionClass + '"><span class="' + r._amountClass + '">' + n._translateDigits(t, t._periods[e]) + "</span><br/>" + (i ? i[e] : c[e]) + "</span>" : ""
                    };
                return t.options.layout ? this._buildLayout(t, a, t.options.layout, t.options.compact, t.options.significant, u) : (t.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (t._hold ? " " + this._holdingClass : "") + '">' + d(0) + d(1) + d(2) + d(3) + (a[4] ? this._minDigits(t, t._periods[4], 2) : "") + (a[5] ? (a[4] ? t.options.timeSeparator : "") + this._minDigits(t, t._periods[5], 2) : "") + (a[6] ? (a[4] || a[5] ? t.options.timeSeparator : "") + this._minDigits(t, t._periods[6], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (t.options.significant || o) + (t._hold ? " " + this._holdingClass : "") + '">' + f(0) + f(1) + f(2) + f(3) + f(4) + f(5) + f(6)) + "</span>" + (t.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + t.options.description + "</span>" : "")
            },
            _buildLayout: function(t, n, i, r, o, s) {
                for (var a = t.options[r ? "compactLabels" : "labels"], l = t.options.whichLabels || this._normalLabels, u = function(e) {
                        return (t.options[(r ? "compactLabels" : "labels") + l(t._periods[e])] || a)[e]
                    }, c = function(e, n) {
                    ...
                    var p = "yowdhms".charAt(f),
                        m = new RegExp("\\{" + p + "<\\}([\\s\\S]*)\\{" + p + ">\\}", "g");
                    d = d.replace(m, !o && n[f] || o && s[f] ? "$1" : "")
                }
            ...
            _calculatePeriods: function(e, t, n, i) {
                ...
                var s = [0, 0, 0, 0, 0, 0, 0];
                if (t[0] || t[1]) {
                    var a = r._getDaysInMonth(i.getFullYear(), i.getMonth()),
                        l = r._getDaysInMonth(o.getFullYear(), o.getMonth()),
                        u = o.getDate() == i.getDate() || o.getDate() >= Math.min(a, l) && i.getDate() >= Math.min(a, l),
                        c = function(e) {
                            return 60 * (60 * e.getHours() + e.getMinutes()) + e.getSeconds()
                        },
                        h = Math.max(0, 12 * (o.getFullYear() - i.getFullYear()) + o.getMonth() - i.getMonth() + (o.getDate() < i.getDate() && !u || u && c(o) < c(i) ? -1 : 0));
                    s[0] = t[0] ? Math.floor(h / 12) : 0, s[1] = t[1] ? h - 12 * s[0] : 0, i = new Date(i.getTime());
                    var d = i.getDate() == a,
                        f = r._getDaysInMonth(i.getFullYear() + s[0], i.getMonth() + s[1]);
                    i.getDate() > f && i.setDate(f), i.setFullYear(i.getFullYear() + s[0]), i.setMonth(i.getMonth() + s[1]), d && i.setDate(f)
                }
                var p = Math.floor((o.getTime() - i.getTime()) / 1e3),
                    m = function(e, n) {
                        s[e] = t[e] ? Math.floor(p / n) : 0, p -= s[e] * n
                    };
                if (m(2, 604800), m(3, 86400), m(4, 3600), m(5, 60), m(6, 1), p > 0 && !e._since)
                    for (var g = [1, 12, 4.3482, 7, 24, 60, 60], v = 6, y = 1, _ = 6; _ >= 0; _--) t[_] && (s[v] >= y && (s[v] = 0, p = 1), p > 0 && (s[_]++, p = 0, v = _, y = 1)), y *= g[_];
                if (n)
                    for (var _ = 0; _ <= 6; _++) n && s[_] ? n-- : n || (s[_] = 0);
                return s
            }
        });
        var i = ["getTimes"];
        e.fn.countdown = function(e) {
            ...
            return n(e, t) ? r["_" + e + "Plugin"].apply(r, [this[0]].concat(t)) : this.each(function() {
                if ("string" == typeof e) {
                    if (!r["_" + e + "Plugin"]) throw "Unknown command: " + e;
                    r["_" + e + "Plugin"].apply(r, [this].concat(t))
                } else r._attachPlugin(this, e || {})
            })
        };
        var r = e.countdown = new t
    }(jQuery),
    function(e) {
        ...
        if (!(this.closed || this.$bar && this.$bar.hasClass("i-am-closing-now"))) {
            ...
            e.$bar.addClass("i-am-closing-now"), e.options.callback.onClose && e.options.callback.onClose.apply(e), e.$bar.clearQueue().stop().animate(e.options.animation.close, e.options.animation.speed, e.options.animation.easing, function() {
                ...
                e.options.modal && ($.notyRenderer.setModalCount(-1), 0 == $.notyRenderer.getModalCount() && $(".noty_modal").fadeOut("fast", function() {
                    $(this).remove()
                })), $.notyRenderer.setLayoutCountFor(e, -1), 0 == $.notyRenderer.getLayoutCountFor(e) && $(e.options.layout.container.selector).remove(), void 0 !== e.$bar && null !== e.$bar && (e.$bar.remove(), e.$bar = null, e.closed = !0), delete $.noty.store[e.options.id], e.options.theme.callback && e.options.theme.callback.onClose && e.options.theme.callback.onClose.apply(e), e.options.dismissQueue || ($.noty.ontap = !0, $.notyRenderer.render()), e.options.maxVisible > 0 && e.options.dismissQueue && $.notyRenderer.render()
            })
        }
    },
    setText: function(e) {
                ...
                switch (this.$bar.css({
                    ...
                    case "top":
                        this.$bar.css({
                            ...
                            width: "14",
                            height: "14",
                            background: "url('data:image/png;base64,')"
                        });
                        break;
                    case "topCenter":
                    case "center":
                    case "bottomCenter":
                        this.$closeButton.css({
                            ...
                            width: "14",
                            height: "14",
                            background: "url('data:image/png;base64,')"
                        });
                    case "inline":
                        this.$bar.css({
                            borderRadius: "2px",
                ...
                a = o.SHA1 = r.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var n = this._hash.words, i = n[0], r = n[1], o = n[2], a = n[3], l = n[4], u = 0; u < 80; u++) {
                            ...
                            h += u < 20 ? 1518500249 + (r & o | ~r & a) : u < 40 ? 1859775393 + (r ^ o ^ a) : u < 60 ? (r & o | r & a | o & a) - 1894007588 : (r ^ o ^ a) - 899497514, l = a, a = o, o = r << 30 | r >>> 2, r = i, i = h
                        }
...
! function(e) {
    ...
    function d(e, n) {
        n = n || v.tags;
        for (var r, s, a, l = u(n), d = new o(e), f = [], p = [], m = !1, g = !1; !d.eos();) {
            if (s = d.scanUntil(l[0]))
                for (var w = 0, T = s.length; w < T; ++w) a = s.charAt(w), t(a) ? p.push(f.length) : g = !0, f.push({
                    type: "text",
                    value: a
                }), "\n" === a && function() {
                    if (m && !g)
            ...
            if (!d.scan(l[0])) break;
            if (m = !0, r = d.scan(k) || "name", d.scan(y), "=" === r) s = d.scanUntil(b), d.scan(b), d.scanUntil(l[1]);
            else if ("{" === r) {
                var D = new RegExp("\\s*" + i("}" + n[1]));
                s = d.scanUntil(D), d.scan(x), d.scanUntil(l[1])
    ...
    var y = /\s*/,
        ...
        D = /[\x00-\x2F\x3A-\x40\x5B-\x60\x7B-\xFF\u2028\u2029]/gm,
        S = {
            "&": "&amp;",
            "<": "&lt;",
            ">": "&gt;",
    ...
    v.isWhitespace = t, v.isArray = T, v.quote = n, v.escapeRe = i, v.escapeHtml = r, o.prototype.eos = function() {
        return "" === this.tail
        ...
        var i = t.lookup(e);
        return null == i || i === !1 || T(i) && 0 === i.length ? n(t, this) : ""
            ...
            n = {
                ...
                grabTemplates: function() {
                    var t, i, r, o = document.getElementsByTagName("script"),
                        s = [];
                    for (t = 0, i = o.length; t < i; t++)(r = o[t]) && r.innerHTML && r.id && ("text/html" === r.type || "text/x-icanhaz" === r.type) && (n.addTemplate(r.id, e(r.innerHTML)), s.unshift(r));
    ...
    m.defaults = {}, l(m.prototype, {
        ...
        function() {
            ...
            !s(t, "transform") && t.adj ? (f.addRule(".spin-vml", "behavior:url(#default#VML)"), m.prototype.lines = function(t, n) {
                ...
                var r = e.firstChild;
                i = i.shadow && i.lines || 0, r && t + i < r.childNodes.length && (r = r.childNodes[t + i], r = r && r.firstChild, (r = r && r.firstChild) && (r.opacity = n))
            }) : c = s(t, "animation")
        }(), e.Spinner = m
}(window, document),
function(e) {
...
function(e, t) {
    ...
    i.encodeReserved = d("reserved", "encode"), i.parse = function(e, t) {
        var n;
        return t || (t = {}), n = e.indexOf("#"), n > -1 && (t.fragment = e.substring(n + 1) || null, e = e.substring(0, n)), n = e.indexOf("?"), n > -1 && (t.query = e.substring(n + 1) || null, e = e.substring(0, n)), "//" === e.substring(0, 2) ? (t.protocol = "", e = e.substring(2), e = i.parseAuthority(e, t)) : (n = e.indexOf(":")) > -1 && (t.protocol = e.substring(0, n), t.protocol && !t.protocol.match(i.protocol_expression) ? t.protocol = void 0 : "file" === t.protocol ? e = e.substring(n + 3) : "//" === e.substring(n + 1, n + 3) ? (e = e.substring(n + 3), e = i.parseAuthority(e, t)) : (e = e.substring(n + 1), t.urn = !0)), t.path = e, t
...
function(e, t) {
    ...
    function e() {
        if (!Y && document.getElementsByTagName("body")[0]) {
            try {
                var e, t = v("span");
                t.style.display = "none", e = L.getElementsByTagName("body")[0].appendChild(t), e.parentNode.removeChild(e), e = null, t = null
            } catch (e) {
                return
            }
            Y = !0;
            for (var n = z.length, i = 0; n > i; i++) z[i]()
        }
    }
    ...
    function n(e) {
        if (typeof R.addEventListener !== E) R.addEventListener("load", e, !1);
        else if (typeof L.addEventListener !== E) L.addEventListener("load", e, !1);
        else if (typeof R.attachEvent !== E) _(R, "onload", e);
        ...
        if (n) {
            ...
            ! function o() {
                if (typeof n.GetVariable !== E) try {
                    ...
                    s && (s = s.split(" ")[1].split(","), Q.pv = [y(s[0]), y(s[1]), y(s[2])])
                } catch (e) {
                    Q.pv = [8, 0, 0]
        ...
        if (e > 0)
            for (var t = 0; e > t; t++) {
                ...
                if (Q.pv[0] > 0) {
                    var u = g(n);
                    if (u)
                        if (!w(W[t].swfVersion) || Q.wk && Q.wk < 312)
                            if (W[t].expressInstall && s()) {
                                var c = {};
                                c.data = W[t].expressInstall, c.width = u.getAttribute("width") || "0", c.height = u.getAttribute("height") || "0", u.getAttribute("class") && (c.styleclass = u.getAttribute("class")), u.getAttribute("align") && (c.align = u.getAttribute("align"));
    ...
    function o(e) {
        var t = null,
            n = g(e);
        return n && "OBJECT" === n.nodeName.toUpperCase() && (t = typeof n.SetVariable !== E ? n : n.getElementsByTagName(P)[0] || n), t
    }

    function s() {
        return !q && w("6.0.65") && (Q.win || Q.mac) && !(Q.wk && Q.wk < 312)
    }

    function a(e, t, n, i) {
        var r = g(n);
        if (n = m(n), q = !0, S = i || null, C = {
                success: !1,
                id: n
            }, r) {
            "OBJECT" === r.nodeName.toUpperCase() ? (T = u(r), D = null) : (T = r, D = n), e.id = I, (typeof e.width === E || !/%$/.test(e.width) && y(e.width) < 310) && (e.width = "310"), (typeof e.height === E || !/%$/.test(e.height) && y(e.height) < 137) && (e.height = "137");
            var o = Q.ie ? "ActiveX" : "PlugIn",
                s = "MMredirectURL=" + encodeURIComponent(("" + R.location).replace(/&/g, "%26")) + "&MMplayerType=" + o + "&MMdoctitle=" + encodeURIComponent(L.title.slice(0, 47) + " - Flash Player Installation");
            if (typeof t.flashvars !== E ? t.flashvars += "&" + s : t.flashvars = s, Q.ie && 4 != r.readyState) {
                var a = v("div");
    ...
    function h(e, t, n) {
        ...
        if (r) {
            ...
            Q.ie ? U[U.length] = e.id : (l.setAttribute("type", N), l.setAttribute("data", e.data)), r.parentNode.replaceChild(l, r), i = l
        }
        return i
    }
    ...
    function b(e, t, n, i) {
        ...
        if (r) {
            ...
            if (i && (M = null, A = null), !M || A != o) {
                var s = v("style");
                s.setAttribute("type", "text/css"), s.setAttribute("media", o), M = r.appendChild(s), Q.ie && typeof L.styleSheets !== E && L.styleSheets.length > 0 && (M = L.styleSheets[L.styleSheets.length - 1]), A = o
            }
            M && (typeof M.addRule !== E ? M.addRule(e, t) : typeof L.createTextNode !== E && M.appendChild(L.createTextNode(e + " {" + t + "}")))
        }
    }
    ...
    function x(e, t) {
        if (B) {
            var n = t ? "visible" : "hidden",
                i = g(e);
            Y && i ? i.style.visibility = n : "string" == typeof e && b("#" + e, "visibility:" + n)
        }
    }

    function k(e) {
        return null !== /[\\\"<>\.;]/.exec(e) && typeof encodeURIComponent !== E ? encodeURIComponent(e) : e
    }
    var T, D, S, C, M, A, E = "undefined",
        P = "object",
        O = "Shockwave Flash",
        ...
        Q = function() {
            var e = typeof L.getElementById !== E && typeof L.getElementsByTagName !== E && typeof L.createElement !== E,
                ...
                s = "Microsoft Internet Explorer" === F.appName,
                a = [0, 0, 0],
                l = null;
            if (typeof F.plugins !== E && typeof F.plugins[O] === P)(l = F.plugins[O].description) && typeof F.mimeTypes !== E && F.mimeTypes[N] && F.mimeTypes[N].enabledPlugin && (H = !0, s = !1, l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = y(l.replace(/^(.*)\..*$/, "$1")), a[1] = y(l.replace(/^.*\.(.*)\s.*$/, "$1")), a[2] = /[a-zA-Z]/.test(l) ? y(l.replace(/^.*[a-zA-Z]+(.*)$/, "$1")) : 0);
            else if (typeof R.ActiveXObject !== E) try {
                var u = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                u && (l = u.GetVariable("$version")) && (s = !0, l = l.split(" ")[1].split(","), a = [y(l[0]), y(l[1]), y(l[2])])
            } catch (e) {}
            return {
                w3: e,
                pv: a,
    ...
    return function() {
            Q.w3 && ((typeof L.readyState !== E && ("complete" === L.readyState || "interactive" === L.readyState) || typeof L.readyState === E && (L.getElementsByTagName("body")[0] || L.body)) && e(), Y || (typeof L.addEventListener !== E && L.addEventListener("DOMContentLoaded", e, !1), Q.ie && (L.attachEvent(j, function t() {
                "complete" === L.readyState && (L.detachEvent(j, t), e())
            }), R == top && function t() {
                if (!Y) {
                    try {
                ...
                return Y ? void 0 : /loaded|complete/.test(L.readyState) ? void e() : void setTimeout(t, 0)
            }()))
        }(), z[0] = function() {
            H ? i() : r()
        },
        function() {
            Q.ie && window.attachEvent("onunload", function() {
                ...
                for (var n = U.length, i = 0; n > i; i++) f(U[i]);
            ...
            registerObject: function(e, t, n, i) {
                if (Q.w3 && e && t) {
                    var r = {};
                    r.id = e, r.swfVersion = t, r.expressInstall = n, r.callbackFn = i, W[W.length] = r, x(e, !1)
                } else i && i({
                    success: !1,
                    id: e
                })
            ...
            embedSWF: function(e, n, i, r, o, l, u, c, d, f) {
                ...
                Q.w3 && (!Q.wk || Q.wk >= 312) && e && n && i && r && o ? (x(p, !1), t(function() {
                    i += "", r += "";
                    var t = {};
                    if (d && typeof d === P)
                    ...
                    if (u && typeof u === P)
                        for (var _ in u)
                            if (u.hasOwnProperty(_)) {
                                var b = V ? encodeURIComponent(_) : _,
                                    k = V ? encodeURIComponent(u[_]) : u[_];
                                typeof v.flashvars !== E ? v.flashvars += "&" + b + "=" + k : v.flashvars = b + "=" + k
                            }
                    if (w(o)) {
                        var T = h(t, v, n);
                        t.id == p && x(p, !0), g.success = !0, g.ref = T, g.id = T.id
                    } else {
            ...
            expressInstallCallback: function() {
                if (q) {
                    var e = g(I);
                    e && T && (e.parentNode.replaceChild(T, e), D && (x(D, !0), Q.ie && (T.style.display = "block")), S && S(C)), q = !1
                }
            },
            version: "2.3"
        }
    ...
    function() {
        ...
        for (var c = 0; c < o.length; c++) e[o[c].toUpperCase()] = e[o[c].toUpperCase().substring(0, 3)] = c, e[o[c]] = e[o[c].substring(0, 3)] = function(t) {
            return function() {
                var i = e.today(),
                    r = t - i.getDay();
                return 0 === t && 1 === n.firstDayOfWeek && 0 !== i.getDay() && (r += 7), i.addDays(r)
            }
        }(c), t[o[c]] = t[o[c].substring(0, 3)] = function(t) {
            return function() {
        ...
        for (var h = 0; h < s.length; h++) e[s[h].toUpperCase()] = e[s[h].toUpperCase().substring(0, 3)] = h, e[s[h]] = e[s[h].substring(0, 3)] = function(t) {
            return function() {
                return e.today().set({
                    month: t,
                    day: 1
        ...
        }(h), t[s[h]] = t[s[h].substring(0, 3)] = function(e) {
            return function() {
        ...
        for (var d = function(e) {
            ...
            }, f = 0; f < a.length; f++) r = a[f].toLowerCase(), t[r] = t[r + "s"] = d(a[f]), i[r] = i[r + "s"] = function(e) {
            return function() {
        ...
        for (var p = function(e) {
            ...
            }, m = 0; m < u.length; m++) t[u[m]] = p(0 === m ? -1 : m)
    }(),
    function() {
        Date.Parsing = {
        ...
        for (var e = Date.Parsing, t = e.Operators = {
            ...
            }, n = "optional not ignore cache".split(/\s/), i = 0; i < n.length; i++) t[n[i]] = function(e) {
            return function() {
                var t = null,
                    n = [];
        ...
        for (var o = "each any all".split(/\s/), s = 0; s < o.length; s++) t[o[s]] = function(e) {
            return function() {
    ...
    function(e, t) {
        ...
        return function(e) {
            ...
            function i(e, t, n) {
                ...
                i.open(t.method || "GET", e, !0), t.headers && Object.keys(t.headers).forEach(function(e) {
                    i.setRequestHeader(e, t.headers[e])
                }), i.onreadystatechange = function() {
                    switch (i.readyState) {
                        case r:
                            return void(200 <= i.status && i.status < 300 ? n(null, i.responseText) : n(new Error("XHR error: " + i.status + " " + e), null))
                    }
                }, i.send(t.body)
            }
            var r = 4;
            t.fetch = function(e, t, r) {
                t.injectScript ? n(e, r || function() {}) : i(e, t, r || function() {})
            }
        }])
    }),
    function(e, t) {
    ...
    function(e, t) {
        ...
        function m(t) {
            p(this, t), this._d = new Date(null != t._d ? t._d.getTime() : NaN), mi === !1 && (mi = !0, e.updateOffset(this), mi = !1)
        }
        ...
        function x(t, n) {
            null != e.deprecationHandler && e.deprecationHandler(t, n), gi[t] || (w(n), gi[t] = !0)
        }
        ...
        function j(e) {
            var t, n, i = {};
            for (n in e) s(e, n) && (t = I(n)) && (i[t] = e[n]);
            return i
        }
        ...
        function F(t, n) {
            return function(i) {
                return null != i ? (z(this, t, i), e.updateOffset(this, n), this) : H(this, t)
            }
        }
        ...
        function U(e, t) {
            if ("object" == typeof e) {
                e = j(e);
                for (var n = L(e), i = 0; i < n.length; i++) this[n[i].unit](e[n[i].unit])
            } else if (e = I(e), k(this[e])) return this[e](t);
            return this
        }
        ...
        function B(e) {
            ...
            for (t = 0, n = i.length; t < n; t++) Ci[i[t]] ? i[t] = Ci[i[t]] : i[t] = q(i[t]);
            return function(t) {
                var r, o = "";
        ...
        function V(e, t) {
            return e.isValid() ? (t = Q(t, e.localeData()), Si[t] = Si[t] || B(t), Si[t](e)) : e.localeData().invalidDate()
        }
        ...
        function G(e, t, n) {
            Oi[e] = k(t) ? t : function(e, i) {
                return e && n ? n : t
            }
        }

        function X(e, t) {
            return s(Oi, e) ? Oi[e](t._strict, t._locale) : new RegExp(K(e))
        }

        function K(e) {
            return J(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(e, t, n, i, r) {
                return t || n || i || r
            }))
        }
        ...
        function ie(e, n) {
            return t(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || $i).test(n) ? "format" : "standalone"][e.month()]
        }

        function re(e, n) {
            return t(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[$i.test(n) ? "format" : "standalone"][e.month()]
        }

        function oe(e, t, n) {
            var i, r, o, s = e.toLocaleLowerCase();
            if (!this._monthsParse)
                for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; i < 12; ++i) o = l([2e3, i]), this._shortMonthsParse[i] = this.monthsShort(o, "").toLocaleLowerCase(), this._longMonthsParse[i] = this.months(o, "").toLocaleLowerCase();
            return n ? "MMM" === t ? (r = yi.call(this._shortMonthsParse, s), r !== -1 ? r : null) : (r = yi.call(this._longMonthsParse, s), r !== -1 ? r : null) : "MMM" === t ? (r = yi.call(this._shortMonthsParse, s)) !== -1 ? r : (r = yi.call(this._longMonthsParse, s), r !== -1 ? r : null) : (r = yi.call(this._longMonthsParse, s)) !== -1 ? r : (r = yi.call(this._shortMonthsParse, s), r !== -1 ? r : null)
        }
        ...
        function le(t) {
            return null != t ? (ae(this, t), e.updateOffset(this, !0), this) : H(this, "Month")
        }
        ...
        function ce(e) {
            return this._monthsParseExact ? (s(this, "_monthsRegex") || de.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (s(this, "_monthsShortRegex") || (this._monthsShortRegex = Bi), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex)
        }

        function he(e) {
            return this._monthsParseExact ? (s(this, "_monthsRegex") || de.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (s(this, "_monthsRegex") || (this._monthsRegex = Vi), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex)
        }
        ...
        function de() {
            ...
            for (i.sort(e), r.sort(e), o.sort(e), t = 0; t < 12; t++) i[t] = J(i[t]), r[t] = J(r[t]);
        ...
        function _e(e, t, n, i, r) {
            var o, s, a = (7 + n - i) % 7,
                l = ye(e, i, r),
                u = 1 + 7 * (t - 1) + a + l;
            return u <= 0 ? (o = e - 1, s = fe(o) + u) : u > fe(e) ? (o = e + 1, s = u - fe(e)) : (o = e, s = u), {
                year: o,
                dayOfYear: s
            }
        }
        ...
        function we(e, t, n) {
            ...
            return s < 1 ? (r = e.year() - 1, i = s + be(r, t, n)) : s > be(e.year(), t, n) ? (i = s - be(e.year(), t, n), r = e.year() + 1) : (r = e.year(), i = s), {
                week: i,
                year: r
            }
        }
        ...
        function Oe(e, t, n) {
            ...
            if (!this._weekdaysParse)
                for (this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], i = 0; i < 7; ++i) o = l([2e3, 1]).day(i), this._minWeekdaysParse[i] = this.weekdaysMin(o, "").toLocaleLowerCase(), this._shortWeekdaysParse[i] = this.weekdaysShort(o, "").toLocaleLowerCase(), this._weekdaysParse[i] = this.weekdays(o, "").toLocaleLowerCase();
            return n ? "dddd" === t ? (r = yi.call(this._weekdaysParse, s), r !== -1 ? r : null) : "ddd" === t ? (r = yi.call(this._shortWeekdaysParse, s), r !== -1 ? r : null) : (r = yi.call(this._minWeekdaysParse, s), r !== -1 ? r : null) : "dddd" === t ? (r = yi.call(this._weekdaysParse, s)) !== -1 ? r : (r = yi.call(this._shortWeekdaysParse, s)) !== -1 ? r : (r = yi.call(this._minWeekdaysParse, s), r !== -1 ? r : null) : "ddd" === t ? (r = yi.call(this._shortWeekdaysParse, s)) !== -1 ? r : (r = yi.call(this._weekdaysParse, s)) !== -1 ? r : (r = yi.call(this._minWeekdaysParse, s), r !== -1 ? r : null) : (r = yi.call(this._minWeekdaysParse, s)) !== -1 ? r : (r = yi.call(this._weekdaysParse, s)) !== -1 ? r : (r = yi.call(this._shortWeekdaysParse, s), r !== -1 ? r : null)
        }
        ...
        function Le(e) {
            return this._weekdaysParseExact ? (s(this, "_weekdaysRegex") || ze.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (s(this, "_weekdaysRegex") || (this._weekdaysRegex = Zi), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex)
        }

        function Fe(e) {
            return this._weekdaysParseExact ? (s(this, "_weekdaysRegex") || ze.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (s(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = er), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        }

        function He(e) {
            return this._weekdaysParseExact ? (s(this, "_weekdaysRegex") || ze.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (s(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = tr), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
        }
        ...
        function ze() {
            ...
            var t, n, i, r, o, s = [],
                ...
                u = [],
                c = [];
            for (t = 0; t < 7; t++) n = l([2e3, 1]).day(t), i = this.weekdaysMin(n, ""), r = this.weekdaysShort(n, ""), o = this.weekdays(n, ""), s.push(i), a.push(r), u.push(o), c.push(i), c.push(r), c.push(o);
            for (s.sort(e), a.sort(e), u.sort(e), c.sort(e), t = 0; t < 7; t++) a[t] = J(a[t]), u[t] = J(u[t]), c[t] = J(c[t]);
        ...
        function Ge(e) {
            var t = null;
            if (!or[e] && "undefined" != typeof module && module && module.exports) try {
                t = nr._abbr, require("./locale/" + e), Xe(t)
            } catch (e) {}
            return or[e]
        }
        ...
        function Xe(e, t) {
            var n;
            return e && (n = f(t) ? Ze(e) : Ke(e, t)) && (nr = n), nr._abbr
        }

        function Ke(e, t) {
            if (null !== t) {
                var n = rr;
                return t.abbr = e, null != or[e] ? (x("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = or[e]._config) : null != t.parentLocale && (null != or[t.parentLocale] ? n = or[t.parentLocale]._config : x("parentLocaleUndefined", "specified parentLocale is not defined yet. See http://momentjs.com/guides/#/warnings/parent-locale/")), or[e] = new S(D(n, t)), Xe(e), or[e]
            }
        ...
        function Je(e, t) {
            if (null != t) {
                var n, i = rr;
                null != or[e] && (i = or[e]._config), t = D(i, t), n = new S(t), n.parentLocale = or[e], or[e] = n, Xe(e)
        ...
        function Ze(e) {
            var n;
            if (e && e._locale && e._locale._abbr && (e = e._locale._abbr), !e) return nr;
            if (!t(e)) {
                if (n = Ge(e)) return n;
                e = [e]
            }
        ...
        function tt(e) {
            var t, n = e._a;
            return n && c(e).overflow === -2 && (t = n[ji] < 0 || n[ji] > 11 ? ji : n[Ri] < 1 || n[Ri] > ne(n[Ii], n[ji]) ? Ri : n[Li] < 0 || n[Li] > 24 || 24 === n[Li] && (0 !== n[Fi] || 0 !== n[Hi] || 0 !== n[zi]) ? Li : n[Fi] < 0 || n[Fi] > 59 ? Fi : n[Hi] < 0 || n[Hi] > 59 ? Hi : n[zi] < 0 || n[zi] > 999 ? zi : -1, c(e)._overflowDayOfYear && (t < Ii || t > Ri) && (t = Ri), c(e)._overflowWeeks && t === -1 && (t = Wi), c(e)._overflowWeekday && t === -1 && (t = Ui), c(e).overflow = t), e
        }

        function nt(e) {
            var t, n, i, r, o, s, a = e._i,
                l = sr.exec(a) || ar.exec(a);
            if (l) {
                for (c(e).iso = !0, t = 0, n = ur.length; t < n; t++)
                    if (ur[t][1].exec(l[1])) {
                        r = ur[t][0], i = ur[t][2] !== !1;
                        break
                    }
                ...
                if (l[4]) {
                    if (!lr.exec(l[4])) return void(e._isValid = !1);
                    s = "Z"
                }
                e._f = r + (o || "") + (s || ""), lt(e)
            } else e._isValid = !1
        ...
        function it(t) {
            ...
            nt(t), t._isValid === !1 && (delete t._isValid, e.createFromInputFallback(t))
        }
        ...
        function st(e) {
            var t, n, i, r, o = [];
            if (!e._d) {
                for (i = ot(e), e._w && null == e._a[Ri] && null == e._a[ji] && at(e), e._dayOfYear && (r = rt(e._a[Ii], i[Ii]), e._dayOfYear > fe(r) && (c(e)._overflowDayOfYear = !0), n = ve(r, 0, e._dayOfYear), e._a[ji] = n.getUTCMonth(), e._a[Ri] = n.getUTCDate()), t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = o[t] = i[t];
                for (; t < 7; t++) e._a[t] = o[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
                24 === e._a[Li] && 0 === e._a[Fi] && 0 === e._a[Hi] && 0 === e._a[zi] && (e._nextDay = !0, e._a[Li] = 0), e._d = (e._useUTC ? ve : ge).apply(null, o), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[Li] = 24)
            }
        }

        function at(e) {
            var t, n, i, r, o, s, a, l;
            t = e._w, null != t.GG || null != t.W || null != t.E ? (o = 1, s = 4, n = rt(t.GG, e._a[Ii], we(gt(), 1, 4).year), i = rt(t.W, 1), ((r = rt(t.E, 1)) < 1 || r > 7) && (l = !0)) : (o = e._locale._week.dow, s = e._locale._week.doy, n = rt(t.gg, e._a[Ii], we(gt(), o, s).year), i = rt(t.w, 1), null != t.d ? ((r = t.d) < 0 || r > 6) && (l = !0) : null != t.e ? (r = t.e + o, (t.e < 0 || t.e > 6) && (l = !0)) : r = o), i < 1 || i > be(n, o, s) ? c(e)._overflowWeeks = !0 : null != l ? c(e)._overflowWeekday = !0 : (a = _e(n, i, r, o, s), e._a[Ii] = a.year, e._dayOfYear = a.dayOfYear)
        }
        ...
        function lt(t) {
            ...
            var n, i, r, o, s, a = "" + t._i,
                l = a.length,
                u = 0;
            for (r = Q(t._f, t._locale).match(Ti) || [], n = 0; n < r.length; n++) o = r[n], i = (a.match(X(o, t)) || [])[0], i && (s = a.substr(0, a.indexOf(i)), s.length > 0 && c(t).unusedInput.push(s), a = a.slice(a.indexOf(i) + i.length), u += i.length), Ci[o] ? (i ? c(t).empty = !1 : c(t).unusedTokens.push(o), te(o, i, t)) : t._strict && !i && c(t).unusedTokens.push(o);
            c(t).charsLeftOver = l - u, a.length > 0 && c(t).unusedInput.push(a), t._a[Li] <= 12 && c(t).bigHour === !0 && t._a[Li] > 0 && (c(t).bigHour = void 0), c(t).parsedDateParts = t._a.slice(0), c(t).meridiem = t._meridiem, t._a[Li] = ut(t._locale, t._a[Li], t._meridiem), st(t), tt(t)
        }
        ...
        function ct(e) {
            ...
            for (r = 0; r < e._f.length; r++) o = 0, t = p({}, e), null != e._useUTC && (t._useUTC = e._useUTC), t._f = e._f[r], lt(t), h(t) && (o += c(t).charsLeftOver, o += 10 * c(t).unusedTokens.length, c(t).score = o, (null == i || o < i) && (i = o, n = t));
            a(e, n || t)
        }
        ...
        function ft(e) {
            var n = e._i,
                i = e._f;
            return e._locale = e._locale || Ze(e._l), null === n || void 0 === i && "" === n ? d({
                nullInput: !0
            }) : ("string" == typeof n && (e._i = n = e._locale.preparse(n)), g(n) ? new m(tt(n)) : (t(i) ? ct(e) : r(n) ? e._d = n : i ? lt(e) : pt(e), h(e) || (e._d = null), e))
        }
        ...
        function pt(n) {
            ...
            void 0 === i ? n._d = new Date(e.now()) : r(i) ? n._d = new Date(i.valueOf()) : "string" == typeof i ? it(n) : t(i) ? (n._a = o(i.slice(0), function(e) {
                return parseInt(e, 10)
            }), st(n)) : "object" == typeof i ? ht(n) : "number" == typeof i ? n._d = new Date(i) : e.createFromInputFallback(n)
        }

        function mt(e, r, o, s, a) {
            var l = {};
            return "boolean" == typeof o && (s = o, o = void 0), (n(e) && i(e) || t(e) && 0 === e.length) && (e = void 0), l._isAMomentObject = !0, l._useUTC = l._isUTC = a, l._l = o, l._i = e, l._f = r, l._strict = s, dt(l)
        }
        ...
        function wt(e) {
            var t = j(e),
                ...
                u = t.second || 0,
                c = t.millisecond || 0;
            this._milliseconds = +c + 1e3 * u + 6e4 * l + 1e3 * a * 60 * 60, this._days = +s + 7 * o, this._months = +r + 3 * i + 12 * n, this._data = {}, this._locale = Ze(), this._bubble()
        }
        ...
        function St(t, n) {
            ...
            return this.isValid() ? null != t ? ("string" == typeof t ? t = kt(Ei, t) : Math.abs(t) < 16 && (t *= 60), !this._isUTC && n && (i = Dt(this)), this._offset = t, this._isUTC = !0, null != i && this.add(i, "m"), r !== t && (!n || this._changeInProgress ? $t(this, Lt(t - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, e.updateOffset(this, !0), this._changeInProgress = null)), this) : this._isUTC ? r : Dt(this) : null != t ? this : NaN
        }
        ...
        function Et() {
            return this._tzm ? this.utcOffset(this._tzm) : "string" == typeof this._i && this.utcOffset(kt(Ai, this._i)), this
        }
        ...
        function Lt(e, t) {
            ...
            return bt(e) ? o = {
                ...
                d: e._days,
                M: e._months
            } : "number" == typeof e ? (o = {}, t ? o[t] = e : o.milliseconds = e) : (a = gr.exec(e)) ? (n = "-" === a[1] ? -1 : 1, o = {
                y: 0,
                d: y(a[Ri]) * n,
                h: y(a[Li]) * n,
                m: y(a[Fi]) * n,
                ...
                m: Ft(a[7], n),
                s: Ft(a[8], n)
            }) : null == o ? o = {} : "object" == typeof o && ("from" in o || "to" in o) && (r = zt(gt(o.from), gt(o.to)), o = {}, o.ms = r.milliseconds, o.M = r.months), i = new wt(o), bt(e) && s(e, "_locale") && (i._locale = e._locale), i
        }
        ...
        function zt(e, t) {
            var n;
            return e.isValid() && t.isValid() ? (t = Tt(t, e), e.isBefore(t) ? n = Ht(e, t) : (n = Ht(t, e), n.milliseconds = -n.milliseconds, n.months = -n.months), n) : {
                milliseconds: 0,
                months: 0
            }
        }
        ...
        function Ut(e, t) {
            return function(n, i) {
                var r, o;
                return null === i || isNaN(+i) || (x(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), o = n, n = i, i = o), n = "string" == typeof n ? +n : n, r = Lt(n, i), $t(this, r, e), this
            }
        }
        ...
        function $t(t, n, i, r) {
            var o = n._milliseconds,
                s = Wt(n._days),
                a = Wt(n._months);
            t.isValid() && (r = null == r || r, o && t._d.setTime(t._d.valueOf() + o * i), s && z(t, "Date", H(t, "Date") + s * i), a && ae(t, H(t, "Month") + a * i), r && e.updateOffset(t, s || a))
        }
        ...
        function Vt(e, t) {
            var n = g(e) ? e : gt(e);
            return !(!this.isValid() || !n.isValid()) && (t = I(f(t) ? "millisecond" : t), "millisecond" === t ? this.valueOf() > n.valueOf() : n.valueOf() < this.clone().startOf(t).valueOf())
        }

        function Qt(e, t) {
            var n = g(e) ? e : gt(e);
            return !(!this.isValid() || !n.isValid()) && (t = I(f(t) ? "millisecond" : t), "millisecond" === t ? this.valueOf() < n.valueOf() : this.clone().endOf(t).valueOf() < n.valueOf())
        }
        ...
        function Xt(e, t) {
            var n, i = g(e) ? e : gt(e);
            return !(!this.isValid() || !i.isValid()) && (t = I(t || "millisecond"), "millisecond" === t ? this.valueOf() === i.valueOf() : (n = i.valueOf(), this.clone().startOf(t).valueOf() <= n && n <= this.clone().endOf(t).valueOf()))
        }
        ...
        function Zt(e, t, n) {
            var i, r, o, s;
            return this.isValid() ? (i = Tt(e, this), i.isValid() ? (r = 6e4 * (i.utcOffset() - this.utcOffset()), t = I(t), "year" === t || "month" === t || "quarter" === t ? (s = en(this, i), "quarter" === t ? s /= 3 : "year" === t && (s /= 12)) : (o = this - i, s = "second" === t ? o / 1e3 : "minute" === t ? o / 6e4 : "hour" === t ? o / 36e5 : "day" === t ? (o - r) / 864e5 : "week" === t ? (o - r) / 6048e5 : o), n ? s : v(s)) : NaN) : NaN
        }
        ...
        function nn() {
            ...
            return 0 < e.year() && e.year() <= 9999 ? k(Date.prototype.toISOString) ? this.toDate().toISOString() : V(e, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : V(e, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
        }
        ...
        function on(e, t) {
            return this.isValid() && (g(e) && e.isValid() || gt(e).isValid()) ? Lt({
                to: this,
                from: e
        ...
        function un(e) {
            var t;
            return void 0 === e ? this._locale._abbr : (t = Ze(e), null != t && (this._locale = t), this)
        }
        ...
        function Mn(e, t, n, i, r) {
            var o;
            return null == e ? we(this, i, r).year : (o = be(e, i, r), t > o && (t = o), An.call(this, e, t, n, i, r))
        }
        ...
        function Hn(e, t, n) {
            if ("number" == typeof e && (t = e, e = void 0), e = e || "", null != t) return Fn(e, t, n, "month");
            var i, r = [];
        ...
        function zn(e, t, n, i) {
            ...
            var r = Ze(),
                o = e ? r._week.dow : 0;
            if (null != n) return Fn(t, (n + o) % 7, i, "day");
            var s, a = [];
            for (s = 0; s < 7; s++) a[s] = Fn(t, (s + o) % 7, i, "day");
            return a
        }
        ...
        function Kn() {
            var e, t, n, i, r, o = this._milliseconds,
                ...
                a = this._months,
                l = this._data;
            return o >= 0 && s >= 0 && a >= 0 || o <= 0 && s <= 0 && a <= 0 || (o += 864e5 * Xn(Zn(a) + s), s = 0, a = 0), l.milliseconds = o % 1e3, e = v(o / 1e3), l.seconds = e % 60, t = v(e / 60), l.minutes = t % 60, n = v(t / 60), l.hours = n % 24, s += v(n / 24), r = v(Jn(s)), a += r, s -= Xn(Zn(r)), i = v(a / 12), a %= 12, l.days = s, l.months = a, l.years = i, this
        }
        ...
        function ei(e) {
            ...
            if ("month" === (e = I(e)) || "year" === e) return t = this._days + i / 864e5, n = this._months + Jn(t), "month" === e ? n : n / 12;
        ...
        function ai(e, t, n) {
            var i = Lt(e).abs(),
                ...
                l = qr(i.as("M")),
                u = qr(i.as("y")),
                c = r < Br.s && ["s", r] || o <= 1 && ["m"] || o < Br.m && ["mm", o] || s <= 1 && ["h"] || s < Br.h && ["hh", s] || a <= 1 && ["d"] || a < Br.d && ["dd", a] || l <= 1 && ["M"] || l < Br.M && ["MM", l] || u <= 1 && ["y"] || ["yy", u];
            return c[2] = t, c[3] = +e > 0, c[4] = n, si.apply(null, c)
        }
        ...
        function ui(e, t) {
            return void 0 !== Br[e] && (void 0 === t ? Br[e] : (Br[e] = t, !0))
        }
        ...
        function hi() {
            var e, t, n, i = Vr(this._milliseconds) / 1e3,
                r = Vr(this._days),
                o = Vr(this._months);
        ...
        yi = Array.prototype.indexOf ? Array.prototype.indexOf : function(e) {
        ...
        }), N("month", "M"), R("month", 8), G("M", /\d\d?/), G("MM", /\d\d?/, /\d\d/), G("MMM", function(e, t) {
            ...
            null != r ? t[ji] = r : c(n).invalidMonth = e
        });
        var $i = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
        ...
        }), Y(0, ["YYYY", 4], 0, "year"), Y(0, ["YYYYY", 5], 0, "year"), Y(0, ["YYYYYY", 6, !0], 0, "year"), N("year", "y"), R("year", 1), G("Y", /[+-]?\d+/), G("YY", /\d\d?/, /\d\d/), G("YYYY", /\d{1,4}/, /\d{4}/), G("YYYYY", /[+-]?\d{1,6}/, Mi), G("YYYYYY", /[+-]?\d{1,6}/, Mi), Z(["YYYYY", "YYYYYY"], Ii), Z("YYYY", function(t, n) {
            n[Ii] = 2 === t.length ? e.parseTwoDigitYear(t) : y(t)
        }), Z("YY", function(t, n) {
            n[Ii] = e.parseTwoDigitYear(t)
        }), Z("Y", function(e, t) {
            t[Ii] = parseInt(e, 10)
        ...
        var Qi = F("FullYear", !0);
        Y("w", ["ww", 2], "wo", "week"), Y("W", ["WW", 2], "Wo", "isoWeek"), N("week", "w"), N("isoWeek", "W"), R("week", 5), R("isoWeek", 5), G("w", /\d\d?/), G("ww", /\d\d?/, /\d\d/), G("W", /\d\d?/), G("WW", /\d\d?/, /\d\d/), ee(["w", "ww", "W", "WW"], function(e, t, n, i) {
            t[i.substr(0, 1)] = y(e)
        });
        var Gi = {
            dow: 0,
        ...
        }), Y("e", 0, 0, "weekday"), Y("E", 0, 0, "isoWeekday"), N("day", "d"), N("weekday", "e"), N("isoWeekday", "E"), R("day", 11), R("weekday", 11), R("isoWeekday", 11), G("d", /\d\d?/), G("e", /\d\d?/), G("E", /\d\d?/), G("dd", function(e, t) {
        ...
        var Xi = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
            Ki = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),
            Ji = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"),
            Zi = Pi,
            er = Pi,
            tr = Pi;
        Y("H", ["HH", 2], 0, "hour"), Y("h", ["hh", 2], 0, We), Y("k", ["kk", 2], 0, Ue), Y("hmm", 0, 0, function() {
        ...
        }), $e("a", !0), $e("A", !1), N("hour", "h"), R("hour", 13), G("a", Ye), G("A", Ye), G("H", /\d\d?/), G("h", /\d\d?/), G("HH", /\d\d?/, /\d\d/), G("hh", /\d\d?/, /\d\d/), G("hmm", /\d\d\d\d?/), G("hmmss", /\d\d\d\d\d\d?/), G("Hmm", /\d\d\d\d?/), G("Hmmss", /\d\d\d\d\d\d?/), Z(["H", "HH"], Li), Z(["a", "A"], function(e, t, n) {
            n._isPm = n._locale.isPM(e), n._meridiem = e
        }), Z(["h", "hh"], function(e, t, n) {
            t[Li] = y(e), c(n).bigHour = !0
        }), Z("hmm", function(e, t, n) {
            var i = e.length - 2;
            t[Li] = y(e.substr(0, i)), t[Fi] = y(e.substr(i)), c(n).bigHour = !0
        }), Z("hmmss", function(e, t, n) {
            var i = e.length - 4,
                r = e.length - 2;
            t[Li] = y(e.substr(0, i)), t[Fi] = y(e.substr(i, 2)), t[Hi] = y(e.substr(r)), c(n).bigHour = !0
        }), Z("Hmm", function(e, t, n) {
            var i = e.length - 2;
            t[Li] = y(e.substr(0, i)), t[Fi] = y(e.substr(i))
        }), Z("Hmmss", function(e, t, n) {
            var i = e.length - 4,
                r = e.length - 2;
            t[Li] = y(e.substr(0, i)), t[Fi] = y(e.substr(i, 2)), t[Hi] = y(e.substr(r))
        });
        var nr, ir = F("Hours", !0),
            rr = {
                calendar: _i,
        ...
        var dr = b("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
            ...
            fr = b("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                var e = gt.apply(null, arguments);
                return this.isValid() && e.isValid() ? e > this ? this : e : d()
            }),
            pr = function() {
        ...
        xt("Z", ":"), xt("ZZ", ""), G("Z", Ei), G("ZZ", Ei), Z(["Z", "ZZ"], function(e, t, n) {
            n._useUTC = !0, n._tzm = kt(Ei, e)
        });
        var mr = /([\+\-]|\d\d)/gi;
        e.updateOffset = function() {};
        var gr = /^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/,
            vr = /^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/;
        Lt.fn = wt.prototype;
        var yr = Ut(1, "add"),
            _r = Ut(-1, "subtract");
        e.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ", e.defaultFormatUtc = "YYYY-MM-DDTHH:mm:ss[Z]";
        var wr = b("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(e) {
        ...
        Y(0, ["gg", 2], 0, function() {
            ...
            }), kn("gggg", "weekYear"), kn("ggggg", "weekYear"), kn("GGGG", "isoWeekYear"), kn("GGGGG", "isoWeekYear"), N("weekYear", "gg"), N("isoWeekYear", "GG"),
            R("weekYear", 1), R("isoWeekYear", 1), G("G", /[+-]?\d+/), G("g", /[+-]?\d+/), G("GG", /\d\d?/, /\d\d/), G("gg", /\d\d?/, /\d\d/), G("GGGG", /\d{1,4}/, /\d{4}/), G("gggg", /\d{1,4}/, /\d{4}/), G("GGGGG", /[+-]?\d{1,6}/, Mi), G("ggggg", /[+-]?\d{1,6}/, Mi), ee(["gggg", "ggggg", "GGGG", "GGGGG"], function(e, t, n, i) {
                t[i.substr(0, 2)] = y(e)
            }), ee(["gg", "GG"], function(t, n, i, r) {
                n[r] = e.parseTwoDigitYear(t)
            }), Y("Q", 0, "Qo", "quarter"), N("quarter", "Q"), R("quarter", 7), G("Q", /\d/), Z("Q", function(e, t) {
                t[ji] = 3 * (y(e) - 1)
            }), Y("D", ["DD", 2], "Do", "date"), N("date", "D"), R("date", 9), G("D", /\d\d?/), G("DD", /\d\d?/, /\d\d/), G("Do", function(e, t) {
                return e ? t._ordinalParse : t._ordinalParseLenient
            }), Z(["D", "DD"], Ri), Z("Do", function(e, t) {
                t[Ri] = y(e.match(/\d\d?/)[0], 10)
            });
        var br = F("Date", !0);
        Y("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), N("dayOfYear", "DDD"), R("dayOfYear", 4), G("DDD", /\d{1,3}/), G("DDDD", /\d{3}/), Z(["DDD", "DDDD"], function(e, t, n) {
            n._dayOfYear = y(e)
        }), Y("m", ["mm", 2], 0, "minute"), N("minute", "m"), R("minute", 14), G("m", /\d\d?/), G("mm", /\d\d?/, /\d\d/), Z(["m", "mm"], Fi);
        var xr = F("Minutes", !1);
        Y("s", ["ss", 2], 0, "second"), N("second", "s"), R("second", 15), G("s", /\d\d?/), G("ss", /\d\d?/, /\d\d/), Z(["s", "ss"], Hi);
        var kr = F("Seconds", !1);
        Y("S", 0, 0, function() {
        ...
        }), N("millisecond", "ms"), R("millisecond", 16), G("S", /\d{1,3}/, /\d/), G("SS", /\d{1,3}/, /\d\d/), G("SSS", /\d{1,3}/, /\d{3}/);
        var Tr;
        for (Tr = "SSSS"; Tr.length <= 9; Tr += "S") G(Tr, /\d+/);
        for (Tr = "S"; Tr.length <= 9; Tr += "S") Z(Tr, On);
        var Dr = F("Milliseconds", !1);
        Y("z", 0, 0, "zoneAbbr"), Y("zz", 0, 0, "zoneName");
        var Sr = m.prototype;
        Sr.add = yr, Sr.calendar = qt, Sr.clone = Bt, Sr.diff = Zt, Sr.endOf = dn, Sr.format = rn, Sr.from = on, Sr.fromNow = sn, Sr.to = an, Sr.toNow = ln, Sr.get = W, Sr.invalidAt = bn, Sr.isAfter = Vt, Sr.isBefore = Qt, Sr.isBetween = Gt, Sr.isSame = Xt, Sr.isSameOrAfter = Kt, Sr.isSameOrBefore = Jt, Sr.isValid = _n, Sr.lang = wr, Sr.locale = un, Sr.localeData = cn, Sr.max = fr, Sr.min = dr, Sr.parsingFlags = wn, Sr.set = U, Sr.startOf = hn, Sr.subtract = _r, Sr.toArray = gn, Sr.toObject = vn, Sr.toDate = mn, Sr.toISOString = nn, Sr.toJSON = yn, Sr.toString = tn, Sr.unix = pn, Sr.valueOf = fn, Sr.creationData = xn, Sr.year = Qi, Sr.isLeapYear = me, Sr.weekYear = Tn, Sr.isoWeekYear = Dn, Sr.quarter = Sr.quarters = En, Sr.month = le, Sr.daysInMonth = ue, Sr.week = Sr.weeks = De, Sr.isoWeek = Sr.isoWeeks = Se, Sr.weeksInYear = Cn, Sr.isoWeeksInYear = Sn, Sr.date = br, Sr.day = Sr.days = Ie, Sr.weekday = je, Sr.isoWeekday = Re, Sr.dayOfYear = Pn, Sr.hour = Sr.hours = ir, Sr.minute = Sr.minutes = xr, Sr.second = Sr.seconds = kr, Sr.millisecond = Sr.milliseconds = Dr, Sr.utcOffset = St, Sr.utc = Mt, Sr.local = At, Sr.parseZone = Et, Sr.hasAlignedHourOffset = Pt, Sr.isDST = Ot, Sr.isLocal = It, Sr.isUtcOffset = jt, Sr.isUtc = Rt, Sr.isUTC = Rt, Sr.zoneAbbr = Nn, Sr.zoneName = In, Sr.dates = b("dates accessor is deprecated. Use date instead.", br), Sr.months = b("months accessor is deprecated. Use month instead", le), Sr.years = b("years accessor is deprecated. Use year instead", Qi), Sr.zone = b("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Ct), Sr.isDSTShifted = b("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Nt);
        var Cr = Sr,
            Mr = S.prototype;
        Mr.calendar = C, Mr.longDateFormat = M, Mr.invalidDate = A, Mr.ordinal = E, Mr.preparse = Ln, Mr.postformat = Ln, Mr.relativeTime = P, Mr.pastFuture = O, Mr.set = T, Mr.months = ie, Mr.monthsShort = re, Mr.monthsParse = se, Mr.monthsRegex = he, Mr.monthsShortRegex = ce, Mr.week = xe, Mr.firstDayOfYear = Te, Mr.firstDayOfWeek = ke, Mr.weekdays = Ae, Mr.weekdaysMin = Pe, Mr.weekdaysShort = Ee, Mr.weekdaysParse = Ne, Mr.weekdaysRegex = Le, Mr.weekdaysShortRegex = Fe, Mr.weekdaysMinRegex = He, Mr.isPM = qe, Mr.meridiem = Be, Xe("en", {
            ordinalParse: /\d{1,2}(th|st|nd|rd)/,
            ordinal: function(e) {
                var t = e % 10;
                return e + (1 === y(e % 100 / 10) ? "th" : 1 === t ? "st" : 2 === t ? "nd" : 3 === t ? "rd" : "th")
            }
        }), e.lang = b("moment.lang is deprecated. Use moment.locale instead.", Xe), e.langData = b("moment.langData is deprecated. Use moment.localeData instead.", Ze);
        var Ar = Math.abs,
            Er = ni("ms"),
            Pr = ni("s"),
            Or = ni("m"),
            ...
            Vr = Math.abs,
            Qr = wt.prototype;
        return Qr.abs = Bn, Qr.add = Qn, Qr.subtract = Gn, Qr.as = ei, Qr.asMilliseconds = Er, Qr.asSeconds = Pr, Qr.asMinutes = Or, Qr.asHours = Nr, Qr.asDays = Ir, Qr.asWeeks = jr, Qr.asMonths = Rr, Qr.asYears = Lr, Qr.valueOf = ti, Qr._bubble = Kn, Qr.get = ii, Qr.milliseconds = Fr, Qr.seconds = Hr, Qr.minutes = zr, Qr.hours = Wr, Qr.days = Ur, Qr.weeks = oi, Qr.months = $r, Qr.years = Yr, Qr.humanize = ci, Qr.toISOString = hi, Qr.toString = hi, Qr.toJSON = hi, Qr.locale = un, Qr.localeData = cn, Qr.toIsoString = b("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", hi), Qr.lang = wr, Y("X", 0, 0, "unix"), Y("x", 0, 0, "valueOf"), G("x", /[+-]?\d+/), G("X", /[+-]?\d+(\.\d{1,3})?/), Z("X", function(e, t, n) {
            ...
            function(e) {
                di = e
            }(gt), e.fn = Cr, e.min = yt, e.max = _t, e.now = pr, e.utc = l, e.unix = jn, e.months = Wn, e.isDate = r, e.locale = Xe, e.invalid = d, e.duration = Lt, e.isMoment = g, e.weekdays = $n, e.parseZone = Rn, e.localeData = Ze, e.isDuration = bt, e.monthsShort = Un, e.weekdaysMin = qn, e.defineLocale = Ke, e.updateLocale = Je, e.locales = et, e.weekdaysShort = Yn, e.normalizeUnits = I, e.relativeTimeRounding = li, e.relativeTimeThreshold = ui, e.calendarFormat = Yt, e.prototype = Cr, e
    }),
    function(e, t) {
        ...
        return t.prototype.constructor = t, t.prototype.clone = function() {
            ...
            return e(this.start + this.diff() / 2)
    ...
    function(e, t) {
        "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Dobbin = t() : e.Dobbin = t()
    }(this, function() {
        return function(e) {
            function t(i) {
                if (n[i]) return n[i].exports;
            ...
            function r(e, t) {
                if (o.g && navigator.sendBeacon) {
                    var n = new Blob([t], {
                        type: "application/x-www-form-urlencoded; charset=UTF-8"
                    });
                    if (navigator.sendBeacon(e, n)) return o.f.resolve("sendBeacon")
                }
                return i("POST", e, {
                    "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"
                }, t)
            ...
            var i = n(3),
                ...
                a = n(9),
                l = n(2);
            n.d(t, "extractSpadeURL", function() {
                return r.a
            ...
            var u = function() {
                function e() {}
                return e.trackEvent = function(e, t, i) {
                    void 0 === i && (i = [r.b, r.c]);
                    var o = {
                        event: e,
                        properties: t
            ...
            var s = function() {
                ...
                a = function() {
                    function e() {
                        this.services = (e = {}, e[i.c] = new s(i.c), e[i.b] = new s(i.b), e[i.e] = new s(i.e), e);
                        var e
                    }
                ...
                function t(i) {
                    i - n < 24 ? e({
                        ...
                        timeRemaining: function() {
                            return Math.max(0, 24 - (performance.now() - i))
                        }
...
googletag.cmd = googletag.cmd || [],
            ...
            startTracking: function() {
                ...
                if ("embed" !== e && "chat" !== e) {
                    var t, n = {},
                        ...
                        o = function(e) {
                            var t = Twitch.storage.getObject("Notifications:Dismissed") || [];
                            t.push(e), Twitch.storage.setObject("Notifications:Dismissed", t)
                        },
                        s = function(e) {
                            var t = Twitch.storage.getObject("Notifications:Dismissed") || [];
                        ...
                        a = function(e, t, r) {
                            s(e) || (n[e] = Twitch.notify[t](r, i, function() {
                                o(e)
                            }))
                        },
                        l = (_.after(2, function(e) {
                            if (e)
                    ...
                    Twitch.user.isLoggedIn() ? Twitch.user(function(e) {
                        if (e.is_partner && u.push("partners"), e.is_broadcaster && e.last_broadcast_time) {
                            (new Date).getTime() - new Date(e.last_broadcast_time).getTime() < 2628e6 && u.push("recent_broadcasters")
                        }
                        l(u)
                    }, function() {
                        l(u)
    ...
    function(e) {
        ...
        var t = function(t, n) {
            ...
            n = {
                "https://passport.twitch.tv": !0,
                "https://passport-staging.internal.twitch.tv": !0,
                "https://passport-dev1.internal.twitch.tv": !0,
                "https://passport-dev2.internal.twitch.tv": !0,
                "https://passport-dev3.internal.twitch.tv": !0
            };
        window.addEventListener("message", function(i) {
            if (window && document && n[i.origin]) {
                var r;
                switch (r = i.data && "{" === i.data[0] ? JSON.parse(i.data) : i.data, r.messageType) {
                    case "loaded":
                        return void t(i, function(t) {
                            var n = {
                    ...
                    case "height":
                        return void t(i, function(t) {
                            e("#passport_iframe_container").css({
                                ...
                                visibility: "visible"
                            }), r.focus && e(t).find("#username").focus()
                        });
                    case "passportCallback":
                        return void t(i, function() {
                            window.location.assign(r.redirectURI)
                        })
                }
            }
        });
        ...
        e.showAuthenticationOverlay = function(t, n) {
            var r, o = t + "_subwindow",
                s = "/user/" + t + "_popup",
                a = t + "-click",
                l = "login" === t ? "#login_user_login" : "#user_login";
            n = n || {}, n.params && (s += "?" + e.param(n.params)), r = {
                url: s,
                width: "420px",
                id: o,
                focusOnLoad: l,
                ...
                formType: t
            }, e("body").trigger("login.overlay.show", [r]), i(a, n.mpSourceAction)
        }, e.signup = function(t) {
        ...
        function t(t, n) {
            return n = e.extend({
                ...
                i.bind("click display", function(i) {
                    ...
                    t._contentFn ? ((0, t._contentFn)(t, o, i), t._contentFn = !1) : o(), n.focusOnLoad && e(n.focusOnLoad).focus(), n.openFn && n.openFn()
                })
            })
        }
        var n = {
    ...
    function(e, t) {
        ...
        s.userId = function() {
            return console.debug("Deprecation warning: Use Twitch.user() instead"), PP.user_id
        }, e.mixin({
            user: s
        })
    }(Twitch, jQuery),
    ...
    function(e, t) {
        const n = SiteOptions.experiments || {},
            i = {
                ...
                CHANNEL_SIGNUP_CTA: "1c7a531b-462b-4814-820e-5c3f2871cda9",
                CHANNEL_SIGNUP_CTA_V2: "e15d2a40-b2bb-4819-af2b-cb7a6f0e31cb",
                CHANNEL_LOGIN_CTA: "aece7525-dceb-49ba-af1b-242c1ae45831",
                CHANNEL_SIGNUP_COLUMN: "78360f5d-4ace-420d-8bca-df0d146ffdee",
            ...
            r = {
                ...
                "1c7a531b-462b-4814-820e-5c3f2871cda9": "control",
                "e15d2a40-b2bb-4819-af2b-cb7a6f0e31cb": "control",
                "aece7525-dceb-49ba-af1b-242c1ae45831": "yes",
                "78360f5d-4ace-420d-8bca-df0d146ffdee": "control",
        ...
        _.each(Object.keys(s), function(t) {
            o[i[t]] = e.user().then(function(e) {
                return e && e.is_staff ? s[t] : RSVP.Promise.reject()
            }, function(e) {
        ...
        const d = e.user().then(function(e) {
            ...
            p = function(e, t) {
                if (e && t) {
                    var n = {},
                        r = cookie.get("experiment_overrides"),
                        o = i[e];
                    try {
                        r && (n = JSON.parse(r))
                    } catch (e) {
    ...
    function(e, t) {
        ...
        var i = null,
            ...
            u = function() {
                (s = !0) && a && n.player.showChromecast(!0)
            },
            c = function(e) {
        ...
        n.canPlayHLS = function() {
            ...
            e.hls.getPlaylist(this.options.channel).then(function(n) {
                ...
                var r = {
                    ...
                    o = s.eventController = new e.player.EventController(s.options.channel, n, r),
                    a = function(e) {
                        t.ajax({
                            type: "GET",
                ...
                if (s.options.ads === !1) return a("ad"), setTimeout(a, 3e4, "adcompleted"), s.setSrc(n), console.info("HTML5Player.init success (no ads)"), void i();
                var l = new e.player.AdsController({
                    container: s.adContainer,
                    player: s.contentPlayer
                });
                t(l).on("start", function(e) {
                    a("ad"), o.sendVideoAdImpression("preroll", e.currentTarget.adsLoader.provider)
                }), t(l).on("contentResumeRequested adError", function() {
                    a("adcompleted"), s.setSrc(n), s.preloadContent(function() {
                        try {
                            s.play()
                        } catch (e) {}
                    })
                }), l.initialize().then(function() {
                    ~window.location.href.indexOf("errortest") && "production" !== e.deployFlavor && "beta" !== e.deployFlavor ? l.requestAds("invalid_ad_url") : ~window.location.href.indexOf("twitchtest") ? (l.requestAds(e.ads.hls.getAdTagUrl({
                        provider: "test"
                    }), "test"), o.sendVideoAdOpportunity("preroll", "test")) : (l.requestAds(e.ads.hls.getAdTagUrl({
                        provider: "twitch",
                        platform: "html5",
                        channel: s.options.channel || "",
                        game: s.options.game || "",
                        referrer: document.referrer
                    }), "twitch"), o.sendVideoAdOpportunity("preroll", "twitch"))
    ...
    function(e, t) {
        var n = {},
            i = (window.location.toString(), function() {
                console.debug("Deprecation warning: use the asynchronous Twitch.asyncAds.ready(..)")
            }),
            r = function(e, t) {
        ...
        n.ready = function(t) {
            ...
            return n._readyData ? n._readyData.enabled : (i(), !PP.turbo)
        }, n.fetchAll = function() {
        ...
        var o = [];
        n.pushGoogleTag = function(i, r, s) {
            o.push(function() {
                var o = e.ads.dfpSlotPath(n.dfpSlotName()),
                    a = i + "_holder";
                googletag.pubads().setTargeting("pagetype", n.dfpPageType()), googletag.defineSlot(o, r, a).addService(googletag.pubads()), googletag.cmd.push(function() {
        ...
        }, n.dfpNetworkCode = "3576121", e.mixin({
            ads: n
        })
    }(Twitch, jQuery),
    function(e, t) {
    ...
    function(e, t) {
        var n = {};
        n.getPlaylist = function(t) {
            return new RSVP.Promise(function(n, i) {
                if (!t || !t.length) return i();
                e.api.get("/api/channels/{{channel}}/access_token".replace("{{channel}}", encodeURIComponent(t))).then(function(e) {
                    e.token && e.sig ? n("//usher.ttvnw.net/api/channel/hls/{{channel}}.m3u8?token={{{token}}}&sig={{{sig}}}".replace("{{channel}}", encodeURIComponent(t)).replace("{{{token}}}", e.token).replace("{{{sig}}}", e.sig)) : i()
                }, i)
            })
        }, e.mixin({
            hls: n
    ...
    function(e, t) {
        ...
        n.setup = function(e, n) {
            ...
            if ("function" != typeof Array.prototype.forEach || "function" != typeof Array.prototype.filter) return void t("#chart_container").text(i18n("Sorry, your browser is incompatible with Twitch stats. Please use a recent version of Google Chrome or Mozilla Firefox"));
                ...
                function(e) {
                    t.loggedInAjax({
                        ...
                        success: function(n, i, r) {
                            ...
                            }), e(null, o, t.makeArray(t(n).map(function(e, t) {
                                return t.label
                            })).sort())
                        }
                    })
                    ...
                    var c = function(n) {
                        var r = i.createArray(o[n].groupings);
                        l.autocomplete("option", "source", r), t.inArray(e.grouping(), r) === -1 && (e.grouping("none"), l.val("")), 1 === r.length ? l.attr("disabled", !0) : l.removeAttr("disabled"), e.load(o[n].identifier)
                    };
                    ...
                    }), l.bind("autocompleteselect", function(n, r) {
                        var o = i.getIdentifier(r.item.value);
    ...
    function(e, t) {
        if (!t.__SV) {
            ...
            window.mixpanel = t, n = e.createElement("script"), n.type = "text/javascript", n.async = !0, n.src = ("https:" === e.location.protocol ? "https:" : "http:") + "//cdn.mxpnl.com/libs/mixpanel-2.2.min.js", i = e.getElementsByTagName("script")[0], i.parentNode.insertBefore(n, i), t._i = [], t.init = function(e, n, i) {
                var s = t;
                for (void 0 !== i ? s = t[i] = [] : i = "mixpanel", s.people = s.people || [], s.toString = function(e) {
                        var t = "mixpanel";
                        return "mixpanel" !== i && (t += "." + i), e || (t += " (stub)"), t
                    }, s.people.toString = function() {
                        return s.toString(1) + ".people (stub)"
                    }, r = "disable track track_pageview track_links track_forms register register_once alias unregister identify name_tag set_config people.set people.set_once people.increment people.append people.track_charge people.clear_charges people.delete_user".split(" "), o = 0; o < r.length; o++) ! function(e, t) {
                    var n = t.split(".");
    ...
    function(e, t) {
        ...
        var o = {
            ...
            s = function(t, i, s) {
                r || (i = i || {}, i.distinct_id || (i.distinct_id = e.idsForMixpanel.getOrCreateUniqueId()), i.device_id = e.idsForMixpanel.getOrCreateUniqueId(), i.tab_session_id = e.idsForMixpanel.getOrCreateSessionStorageUniqueId(), e.geo.then(function(r) {
                    var a = {
                        ...
                        l = n.exec(window.document.referrer);
                    l && (a.referrer_host = l[0]);
                    var u = e.user.peek();
                    u && u.userData && (a.user_id = u.userData.id), i = _.extend(a, i), s === o.SPADE ? spade.track(t, i) : s === o.MIXPANEL && e.tracking.mixpanel.sendMixpanelBeacon(t, i), e.tracking.log.trackEvent(t, i, s)
                }))
            },
            a = function() {
        ...
        i.funnel = {
            ...
            handleCampaignClick: function(n) {
                var r = t(n.target).closest(i.funnel.campaignSelector);
                if (r.length) {
            ...
            trackPageView: function(n) {
                n = n || {};
                var r = new URI,
                    o = n.referrer || document.referrer,
                    s = o ? new URI(o) : {};
                RSVP.hash(this.data).then(function(a) {
                    n = _.defaults(c, n || {}, {
                        ...
                        medium: l.tt_medium,
                        content: l.tt_content,
                        content_index: l.tt_content_index ? parseInt(l.tt_content_index) : void 0,
                        ...
                        referrer: o || void 0
                    }), l = {}, c = {}, e.tracking.funnel.pageviewProperties = {
                        location: n.location,
                        content: n.content,
                        medium: n.medium,
            ...
            debugEnabled: function(t) {
                if (void 0 === t) return e.storage.getObject("Twitch.tracking.funnel.debugEnabled") === !0;
                e.storage.setObject("Twitch.tracking.funnel.debugEnabled", t)
            }
        };
        var h = function() {
                var e = f();
                setTimeout(function() {
                    try {
                        for (var n = 0; n < e; n++) t('<img style="display:none;" src="https://secure-login.twitch.tv/lc?q=' + Math.floor(1e9 * Math.random()) + '" />').prependTo(t("body"))
                    } catch (e) {}
                }, 2e3)
            },
            d = _.memoize(function() {
        ...
        i.log = {
            ...
            debugEnabled: function(t) {
                if (void 0 === t) return e.storage.getObject("Twitch.tracking.log.debugEnabled") === !0;
                e.storage.setObject("Twitch.tracking.log.debugEnabled", t)
            }
        }, t(document).on("click", i.funnel.campaignSelector, i.funnel.handleCampaignClick), i.gaq = {
            ...
            trackEvent: function(e, t) {
                i.spade.trackEvent(e, t), i.mixpanel.trackEvent(e, t)
            }
        }, i.spade = {
            trackEvent: function(e, t) {
                s(e, t, o.SPADE)
        ...
        }, i.getComscoreScript = _.memoize(function() {
        ...
        }), i.sendComscoreBeacon = function(t) {
            i.getComscoreScript().then(function() {
                if ("undefined" != typeof COMSCORE) {
                    COMSCORE.beacon({
                        ...
                        }(e.storage.legacy.get("psHashedUserId"))
                    })
                }
            })
        ...
        var p = "";
        i.didJustLoginAndFollow = function(e) {
            return p === e && (p = "", !0)
        }, e.mixin({
            tracking: i
        });
        var m = function(e, n) {
            ...
            window.App && void 0 !== window.App.get("currentPath") ? r = window.App.get("currentPath") : window.App && window.App.__container__ && (r = window.App.__container__.lookup("service:globals").get("currentPath")), i.spade.trackEvent("api-error", t.extend({
                platform: "web",
                application: r,
        ...
        if (e.api.on("fail", m), l.followed_flow) {
            var g = _.defaults(e.cache.read("LoginAndFollowTrackingData") || {}, {
                platform: "web"
            }, _.pick(l, "followed_flow"));
            p = g.channel, setTimeout(function() {
                i.spadeAndMixpanel.trackEvent("follow", g)
    ...
    function(e) {
        ...
        window.euCookieNotification = function() {
            e.storage.get("euCookieDismiss") || e.notify.alert(i18n("This site uses cookies. By continuing to browse the site, you are agreeing to our use of cookies. Review our <a href='/p/cookie-policy'>Cookie Policy</a> for more details."), {
                layout: "bottomCenter",
                timeout: !1,
                escape: !1
            }, function() {
    ...
    function(e) {
        function t(t, i) {
            function r(t) {
                t.preventDefault();
                var n = t.pageY;
                "horiz" === C && (n = t.pageX), x = n - b.offset()[E], e(document).on("mousemove", o), e(document).on("mouseup", s)
            }
            ...
            function c() {
                b.addClass("visible"), "number" == typeof k && window.clearTimeout(k), k = window.setTimeout(function() {
                    h()
                }, 1e3)
            }

            function h() {
                b.removeClass("visible"), "number" == typeof k && window.clearTimeout(k)
            }

            function d() {
                "rightAndBottom" === i.scrollbarHideStrategy && ("vert" === C ? _.css({
                    right: "-" + p() + "px"
                }) : _.css({
                    bottom: "-" + p() + "px"
                }))
            ...
            function f() {
                "vert" === C ? (_.width(D.width() + p()), _.height(D.height())) : (_.width(D.width()), _.height(D.height() + p()), S.height(D.height()))
            }
            ...
            function v() {
                S.insertBefore(w), w.remove(), _.remove(), S.css({
                    height: D.height() + "px",
                    "overflow-y": "scroll"
                }), y("onDestroy"), D.removeData("plugin_" + n)
            }
            ...
            return i = e.extend({}, e.fn[n].defaults, i),
                function() {
                    D.hasClass("horizontal") && (C = "horiz", M = "scrollLeft", A = "width", E = "left"), D.prepend('<div class="tse-scrollbar"><div class="drag-handle"></div></div>'), w = D.find(".tse-scrollbar"), b = D.find(".drag-handle"), i.wrapContent && S.wrap('<div class="tse-scroll-content" />'), _ = D.find(".tse-scroll-content"), d(), f(), D.on("mouseenter", u), b.on("mousedown", r), _.on("scroll", a), l()
                }(), {
                    option: g,
                    destroy: v,
                    recalculate: m
