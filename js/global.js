...
function toggle_live_player_popout(e) {
    ...
    function Y(e, t, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var t = Ct || F(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(r);
    ...
    var ve = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : z) !== I && P(t), t = t || I, N)) {
                ...
                if (b.qsa && !U[e + " "] && (!j || !j.test(e))) {
                    if (1 !== m) p = t, f = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(_e, "\\$&") : t.setAttribute("id", a = H), h = C(e), r = h.length, l = de.test(a) ? "#" + a : "[id='" + a + "']"; r--;) h[r] = l + " " + d(h[r]);
            ...
            var o = n.length > 0,
                ...
                s = function(i, s, a, l, u) {
                    var c, h, d, f = 0,
                        ...
                        b = _.length;
                    for (u && (M = s === I || s || u); p !== b && null != (c = _[p]); p++) {
                        if (r && c) {
        ...
        var w, b, x, k, S, C, T, D, M, E, A, P, I, O, N, j, R, L, F, H = "sizzle" + 1 * new Date,
            z = e.document,
            W = 0,
            $ = 0,
            Y = n(),
        ...
        b = t.support = {}, S = t.isXML = function(e) {
            ...
            return i !== I && 9 === i.nodeType && i.documentElement ? (I = i, O = I.documentElement, N = !S(I), (n = I.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), b.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), b.getElementsByTagName = o(function(e) {
                return e.appendChild(I.createComment("")), !e.getElementsByTagName("*").length
            }), b.getElementsByClassName = ge.test(I.getElementsByClassName), b.getById = o(function(e) {
            ...
            }, R = [], j = [], (b.qsa = ge.test(I.querySelectorAll)) && (o(function(e) {
            ...
            })), (b.matchesSelector = ge.test(L = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function(e) {
                b.disconnectedMatch = L.call(e, "div"), L.call(e, "[s!='']:x"), R.push("!=", re)
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === I || e.ownerDocument === z && F(z, e) ? -1 : t === I || t.ownerDocument === z && F(z, t) ? 1 : E ? ee(E, e) - ee(E, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== I && P(e), n = n.replace(ce, "='$1']"), b.matchesSelector && N && !U[n + " "] && (!R || !R.test(n)) && (!j || !j.test(n))) try {
                var i = L.call(e, n);
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (A = !b.detectDuplicates, E = !b.sortStable && e.slice(0), e.sort(B), A) {
        ...
        return h.prototype = x.filters = x.pseudos, x.setFilters = new h, C = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                r = U[e + " "];
            if (!r) {
                for (t || (t = C(e)), n = t.length; n--;) r = v(t[n]), r[H] ? i.push(r) : o.push(r);
                r = U(e, _(o, i)), r.selector = e
            }
            return r
        }, D = t.select = function(e, t, n, i) {
            var o, r, s, a, l, u = "function" == typeof e && e,
                h = !i && C(e = u.selector || e);
            if (n = n || [], 1 === h.length) {
                if (r = h[0] = h[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && b.getById && 9 === t.nodeType && N && x.relative[r[1].type]) {
                    if (t = (x.find.ID(s.matches[0].replace(we, be), t) || [])[0], !t) return n;
                    u && (t = t.parentNode), e = e.slice(r.shift().value.length)
                }
                for (o = fe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !x.relative[a = s.type]);)
                    if ((l = x.find[a]) && (i = l(s.matches[0].replace(we, be), ve.test(r[0].type) && c(t.parentNode) || t))) {
                        if (r.splice(o, 1), e = i.length && d(r), !e) return J.apply(n, i), n;
                        break
                    }
            }
            return (u || T(e, h))(i, t, !N, n, !t || ve.test(e) && c(t.parentNode) || t), n
        }, b.sortStable = H.split("").sort(B).join("") === H, b.detectDuplicates = !!A, P(), b.sortDetached = o(function(e) {
    ...
    fe.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, i = 0, o = this.length, r = [], s = be.test(e) || "string" != typeof e ? fe(e, t || this.context) : 0; i < o; i++)
    ...
    fe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (a = a || p(e), i = i || p(r), s = 0; null != (o = a[s]); s++) C(o, i[s]);
                else C(e, r);
    ...
    fe.extend({
        ...
        fe.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return _t.test(fe.css(e, "display")) && 0 === e.offsetWidth ? dt(e, bt, function() {
                    return R(e, t, i)
                }) : R(e, t, i)
            },
            set: function(e, n, i) {
    ...
    fe.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, o) {
                var r, h, v, _, b, k = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), c = void 0, a = o || "", x.readyState = t > 0 ? 4 : 0, r = t >= 200 && t < 300 || 304 === t, i && (_ = Q(d, x, i)), _ = G(d, _, x, r), r ? (d.ifModified && (b = x.getResponseHeader("Last-Modified"), b && (fe.lastModified[s] = b), b = x.getResponseHeader("etag"), b && (fe.etag[s] = b)), 204 === t || "HEAD" === d.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = _.state, h = _.data, v = _.error, r = !v)) : (v = k, !t && k || (k = "error", t < 0 && (t = 0))), x.status = t, x.statusText = (n || k) + "", r ? m.resolveWith(f, [h, k, x]) : m.rejectWith(f, [x, k, v]), x.statusCode(y), y = void 0, u && p.trigger(r ? "ajaxSuccess" : "ajaxError", [x, d, r ? h : v]), g.fireWith(f, [x, k]), u && (p.trigger("ajaxComplete", [x, d]), --fe.active || fe.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((t || d.url || en) + "").replace(qt, "").replace(Gt, tn[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = fe.trim(d.dataType || "*").toLowerCase().match(Ee) || [""], null == d.crossDomain && (o = Xt.exec(d.url.toLowerCase()), d.crossDomain = !(!o || o[1] === tn[1] && o[2] === tn[2] && (o[3] || ("http:" === o[1] ? "80" : "443")) === (tn[3] || ("http:" === tn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = fe.param(d.data, d.traditional)), B(Kt, d, n, x), 2 === w) return x;
...
function(e, t, n) {
    ...
    e.fn.init = function(t, o, r) {
        ...
        if ("string" == typeof e && w.test(e)) try {
            ...
            e = e.replace(b, function(e, t, n, i) {
                return "[" + t + n + '"' + i + '"]'
            });
            try {
    ...
    e.fn.data = function(t) {
        var o, r, s = this[0];
        return !s || "events" !== t || 1 !== arguments.length || (o = e.data(s, t), r = e._data(s, t), o !== n && o !== r || r === n) ? C.apply(this, arguments) : (i("Use of jQuery.fn.data('events') is deprecated"), r)
    };
    ...
    e.clean || (e.clean = function(t, n, o, r) {
        ...
        if (e.merge(c, e.buildFragment(t, n).childNodes), o)
            for (l = function(e) {
                    if (!e.type || T.test(e.type)) return r ? r.push(e.parentNode ? e.parentNode.removeChild(e) : e) : o.appendChild(e)
...
function(e, t) {
    ...
    function() {
        ...
        v.each = v.forEach = function(e, t, n) {
            ...
            t = w(t, n);
            for (var i = !T(e) && v.keys(e), o = (i || e).length, r = Array(o), s = 0; s < o; s++) {
                var a = i ? i[s] : s;
                r[s] = t(e[a], a, e)
            }
            return r
            ...
            var i;
            if (i = T(e) ? v.findIndex(e, t, n) : v.findKey(e, t, n), void 0 !== i && i !== -1) return e[i]
        }, v.filter = v.select = function(e, t, n) {
            var i = [];
            return t = w(t, n), v.each(e, function(e, n, o) {
                t(e, n, o) && i.push(e)
            }), i
            ...
            t = w(t, n);
            for (var i = !T(e) && v.keys(e), o = (i || e).length, r = 0; r < o; r++) {
                var s = i ? i[r] : r;
            ...
            for (var t, n = T(e) ? e : v.values(e), i = n.length, o = Array(i), r = 0; r < i; r++) t = v.random(0, r), t !== r && (o[r] = o[t]), o[t] = n[r];
            return o
        ...
        var D = function(e) {
            return function(t, n, i) {
                var o = {};
                return n = w(n, i), v.each(t, function(i, r) {
                    var s = n(i, r, t);
                    e(o, i, s)
                }), o
            }
        ...
        var M = function(e, t, n, i) {
            for (var o = [], r = 0, s = i || 0, a = C(e); s < a; s++) {
                var l = e[s];
        ...
        v.flatten = function(e, t) {
            ...
            for (var t = [], n = arguments.length, i = 0, o = C(e); i < o; i++) {
                var r = e[i];
                if (!v.contains(t, r)) {
            ...
            for (var t = e && v.max(e, C).length || 0, n = Array(t), i = 0; i < t; i++) n[i] = v.pluck(e, i);
            return n
        }, v.object = function(e, t) {
            for (var n = {}, i = 0, o = C(e); i < o; i++) t ? n[e[i]] = t[i] : n[e[i][0]] = e[i][1];
            return n
        }, v.findIndex = t(1), v.findLastIndex = t(-1), v.sortedIndex = function(e, t, n, i) {
            n = w(n, i, 1);
            for (var o = n(t), r = 0, s = C(e); r < s;) {
    ...
    function(e, t) {
        ...
        function i(e, t) {
            return "onerror" === e ? void be.on("error", t) : 2 !== arguments.length ? be[e] : void(be[e] = t)
        }
        ...
        function g(e, t) {
            t._state === Me ? w(e, t._result) : t._state === Ee ? (t._onError = null, b(e, t._result)) : x(t, void 0, function(n) {
        ...
        function y(e, t, n) {
            t.constructor === e.constructor && n === M && e.constructor.resolve === c ? g(e, t) : n === Ae ? b(e, Ae.error) : void 0 === n ? w(e, t) : r(n) ? m(e, t, n) : w(e, t)
        }

        function v(e, t) {
            e === t ? w(e, t) : o(t) ? y(e, t, f(t)) : w(e, t)
        }
        ...
        function w(e, t) {
            e._state === De && (e._result = t, e._state = Me, 0 === e._subscribers.length ? be.instrument && u("fulfilled", e) : be.async(k, e))
        }

        function b(e, t) {
            e._state === De && (e._state = Ee, e._result = t, be.async(_, e))
        }

        function x(e, t, n, i) {
            var o = e._subscribers,
                r = o.length;
            e._onError = null, o[r] = t, o[r + Me] = n, o[r + Ee] = i, 0 === r && e._state && be.async(k, e)
        }

        function k(e) {
            var t = e._subscribers,
                n = e._state;
            if (be.instrument && u(n === Me ? "fulfilled" : "rejected", e), 0 !== t.length) {
                for (var i = void 0, o = void 0, r = e._result, s = 0; s < t.length; s += 3) i = t[s], o = t[s + n], i ? T(n, i, o, r) : o(r);
        ...
        function T(e, t, n, i) {
            var o = r(n),
                ...
                u = void 0;
            if (o) {
                if (s = C(n, i), s === Pe ? (u = !0, a = s.error, s = null) : l = !0, t === s) return void b(t, h())
            } else s = i, l = !0;
            t._state !== De || (o && l ? v(t, s) : u ? b(t, a) : e === Me ? w(t, s) : e === Ee && b(t, s))
        }
        ...
        function M(e, t, n) {
            var i = arguments,
                o = this,
                r = o._state;
            if (r === Me && !e || r === Ee && !t) return be.instrument && u("chained", o, o), o;
            o._onError = null;
            var s = new o.constructor(d, n),
                a = o._result;
            return be.instrument && u("chained", o, s), r ? ! function() {
                var e = i[r - 1];
                be.async(function() {
                    return T(r, s, e, a)
                })
        ...
        function I(e, t) {
            var n = this,
                i = new n(d, t);
            if (!ke(e)) return b(i, new TypeError("You must pass an array to race.")), i;
        ...
        function R(e, t) {
            this._id = Oe++, this._label = t, this._state = void 0, this._result = void 0, this._subscribers = [], be.instrument && u("created", this), d !== e && ("function" != typeof e && N(), this instanceof R ? D(this, e) : j())
        }
        ...
        function Y(e, t) {
            var n = function() {
                ...
                return o[i] = function(e, n) {
                    e ? b(u, e) : void 0 === t ? v(u, n) : t === !0 ? v(u, W(arguments)) : ke(t) ? v(u, z(arguments, t)) : v(u, n)
        ...
        A.prototype._validateInput = function(e) {
            ...
            var i = this.promise;
            i._state === De && (this._remaining--, this._abortOnReject && e === Ee ? b(i, n) : this._result[t] = this._makeResult(e, t, n)), 0 === this._remaining && w(i, this._result)
        ...
        var Ne = new L,
            je = new L;
        Q.prototype = Ce(A.prototype), Q.prototype._superConstructor = A, Q.prototype._makeResult = E, Q.prototype._validationError = function() {
            return new Error("allSettled must be called with an array")
        }, K.prototype = Ce(A.prototype), K.prototype._superConstructor = A, K.prototype._init = function() {
            this._result = {}
        ...
        }, Z.prototype = Ce(K.prototype), Z.prototype._superConstructor = A, Z.prototype._makeResult = E, Z.prototype._validationError = function() {
        ...
        var Be;
        be.async = ue, be.after = function(e) {
        ...
        e.default = Ke, e.cast = Ve, e.Promise = R, e.EventTarget = we, e.all = V, e.allSettled = G, e.race = X, e.hash = J, e.hashSettled = ee, e.rethrow = te, e.defer = ne, e.denodeify = Y, e.configure = i, e.on = ve, e.off = _e, e.resolve = oe, e.reject = re, e.map = ie, e.async = Qe, e.filter = le, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    }),
    function(e) {
    ...
    function(e) {
        ...
        return function() {
            ...
            e.position = {
                ...
                }), 1 === b.length && (b[1] = b[0]), "right" === o.at[0] ? g.left += f : "center" === o.at[0] && (g.left += f / 2), "bottom" === o.at[1] ? g.top += p : "center" === o.at[1] && (g.top += p / 2), h = t(x.at, f, p), g.left += h[0], g.top += h[1], this.each(function() {
                    var i, a, l = e(this),
                        u = l.outerWidth(),
                        c = l.outerHeight(),
                        d = n(this, "marginLeft"),
                        ...
                        S = c + y + n(this, "marginBottom") + w.height,
                        C = e.extend({}, g),
                        T = t(x.my, l.outerWidth(), l.outerHeight());
                    "right" === o.my[0] ? C.left -= u : "center" === o.my[0] && (C.left -= u / 2), "bottom" === o.my[1] ? C.top -= c : "center" === o.my[1] && (C.top -= c / 2), C.left += T[0], C.top += T[1], i = {
                        marginLeft: d,
                        marginTop: y
                    }, e.each(["left", "top"], function(t, n) {
                        e.ui.position[b[t]] && e.ui.position[b[t]][n](C, {
                            targetWidth: f,
                            targetHeight: p,
                            elemWidth: u,
                            elemHeight: c,
    ...
    function(e) {
        ...
        return e.extend(n.prototype, {
                ...
                for (o = 0; o < t.length; o++)
                    if (_) "'" !== t.charAt(o) || w("'") ? k() : _ = !1;
                        ...
                        case "y":
                            ...
                            break;
                        case "@":
                            a = new Date(b("@")), m = a.getFullYear(), g = a.getMonth() + 1, y = a.getDate();
                            break;
                        case "!":
                            a = new Date((b("!") - this._ticksTo1970) / 1e4), m = a.getFullYear(), g = a.getMonth() + 1, y = a.getDate();
                            break;
                        case "'":
                            w("'") ? k() : _ = !0;
                            break;
            ...
            _generateHTML: function(e) {
                var t, n, i, o, r, s, a, l, u, c, h, d, f, p, m, g, y, v, _, w, b, x, k, S, C, T, D, M, E, A, P, I, O, N, j, R, L, F, H, z = new Date,
                ...
                for (e.drawMonth = Z, e.drawYear = ee, n = this._get(e, "prevText"), n = U ? this.formatDate(n, this._daylightSavingAdjust(new Date(ee, Z - Q, 1)), this._getFormatConfig(e)) : n, i = this._canAdjustMonth(e, -1, ee, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + ($ ? "e" : "w") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + ($ ? "e" : "w") + "'>" + n + "</span></a>", o = this._get(e, "nextText"), o = U ? this.formatDate(o, this._daylightSavingAdjust(new Date(ee, Z + Q, 1)), this._getFormatConfig(e)) : o, r = this._canAdjustMonth(e, 1, ee, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + o + "'><span class='ui-icon ui-icon-circle-triangle-" + ($ ? "w" : "e") + "'>" + o + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + o + "'><span class='ui-icon ui-icon-circle-triangle-" + ($ ? "w" : "e") + "'>" + o + "</span></a>", s = this._get(e, "currentText"), a = this._get(e, "gotoCurrent") && e.currentDay ? X : W, s = U ? this.formatDate(s, a, this._getFormatConfig(e)) : s, l = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", u = Y ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + ($ ? l : "") + (this._isInRange(e, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + s + "</button>" : "") + ($ ? "" : l) + "</div>" : "", c = parseInt(this._get(e, "firstDay"), 10), c = isNaN(c) ? 0 : c, h = this._get(e, "showWeek"), d = this._get(e, "dayNames"), f = this._get(e, "dayNamesMin"), p = this._get(e, "monthNames"), m = this._get(e, "monthNamesShort"), g = this._get(e, "beforeShowDay"), y = this._get(e, "showOtherMonths"), v = this._get(e, "selectOtherMonths"), _ = this._getDefaultDate(e), w = "", x = 0; x < B[0]; x++) {
                    for (k = "", this.maxRows = 4, S = 0; S < B[1]; S++) {
                        ...
                        for (D += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? $ ? r : i : "") + (/all|right/.test(T) && 0 === x ? $ ? i : r : "") + this._generateMonthYearHeader(e, Z, ee, K, J, x > 0 || S > 0, p, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", M = h ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", b = 0; b < 7; b++) E = (b + c) % 7, M += "<th scope='col'" + ((b + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[E] + "'>" + f[E] + "</span></th>";
                        for (D += M + "</tr></thead><tbody>", A = this._getDaysInMonth(ee, Z), ee === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, A)), P = (this._getFirstDayOfMonth(ee, Z) - c + 7) % 7, I = Math.ceil((P + A) / 7), O = G && this.maxRows > I ? this.maxRows : I, this.maxRows = O, N = this._daylightSavingAdjust(new Date(ee, Z, 1 - P)), j = 0; j < O; j++) {
                            for (D += "<tr>", R = h ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(N) + "</td>" : "", b = 0; b < 7; b++) L = g ? g.apply(e.input ? e.input[0] : null, [N]) : [!0, ""], F = N.getMonth() !== Z, H = F && !v || !L[0] || K && N < K || J && N > J, R += "<td class='" + ((b + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (N.getTime() === C.getTime() && Z === e.selectedMonth && e._keyEvent || _.getTime() === N.getTime() && _.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (H ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !y ? "" : " " + L[1] + (N.getTime() === X.getTime() ? " " + this._currentClass : "") + (N.getTime() === W.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !y || !L[2] ? "" : " title='" + L[2].replace(/'/g, "&#39;") + "'") + (H ? "" : " data-handler='selectDay' data-event='click' data-month='" + N.getMonth() + "' data-year='" + N.getFullYear() + "'") + ">" + (F && !y ? "&#xa0;" : H ? "<span class='ui-state-default'>" + N.getDate() + "</span>" : "<a class='ui-state-default" + (N.getTime() === W.getTime() ? " ui-state-highlight" : "") + (N.getTime() === X.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + N.getDate() + "</a>") + "</td>", N.setDate(N.getDate() + 1), N = this._daylightSavingAdjust(N);
                            D += R + "</tr>"
                        }
            ...
            _generateMonthYearHeader: function(e, t, n, i, o, r, s, a) {
                var l, u, c, h, d, f, p, m, g = this._get(e, "changeMonth"),
                    ...
                    w = "";
                if (r || !g) w += "<span class='ui-datepicker-month'>" + s[t] + "</span>";
                else {
                    for (l = i && i.getFullYear() === n, u = o && o.getFullYear() === n, w += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", c = 0; c < 12; c++)(!l || c >= i.getMonth()) && (!u || c <= o.getMonth()) && (w += "<option value='" + c + "'" + (c === t ? " selected='selected'" : "") + ">" + a[c] + "</option>");
                    w += "</select>"
                }
                if (v || (_ += w + (!r && g && y ? "" : "&#xa0;")), !e.yearshtml)
                ...
                return _ += this._get(e, "yearSuffix"), v && (_ += (!r && g && y ? "" : "&#xa0;") + w), _ += "</div>"
            },
    ...
    function(e) {
        function t(t, i) {
            function o() {
                T.hasClass("horizontal") && (E = "horiz", A = "scrollLeft", P = "width", I = "left"), T.prepend('<div class="tse-scrollbar"><div class="drag-handle"></div></div>'), b = T.find(".tse-scrollbar:first"), x = T.find(".drag-handle:first"), i.wrapContent && D.wrap('<div class="tse-scroll-content" />'), w = T.find(".tse-scroll-content:first"), p(), i.autoHide && T.on("mouseenter", h), x.on("mousedown", r), b.on("mousedown", l), w.on("scroll", u), c(), e(window).on("resize.trackpadScollEmulator", g), i.autoHide || d()
            }
            ...
            function p() {
                "vert" === E ? (w.width(T.width() + m()), w.height(T.height())) : (w.width(T.width()), w.height(T.height() + m()), D.height(T.height()))
            }
            ...
            function v() {
                D.insertBefore(b), b.remove(), w.remove(), D.css({
                    height: T.height() + "px",
                    "overflow-y": "scroll"
                }), e(window).off("resize.trackpadScollEmulator"), _("onDestroy"), T.removeData("plugin_" + n)
            }

            function _(e) {
                void 0 !== i[e] && i[e].call(C)
            }
            var w, b, x, k, S, C = t,
                T = e(t),
                D = T.find(".tse-content:first"),
                M = 7 / 8,
                E = "vert",
                A = "scrollTop",
                P = "height",
    ...
    function(e, t, n) {
        t.extend(!0, t.Mason.settings, {
            ...
            for (var y = this.options.layoutPriorities, v = [], _ = 0, w = r.length; _ < w; _++) {
                var b = Math.abs(h[l] - this.columnWidth * _),
                    x = Math.abs(h.top - r[_]),
                    k = Math.pow(b, 2) + Math.pow(x, 2),
                    S = Math.round(Math.sqrt(k)),
                    C = y.shelfOrder * S,
                    T = y.upperPosition * (r[_] - c);
                v[_] = T + C
            }
    ...
    function(e) {
        ...
        e.extend(t.prototype, {
            ...
            _generateHTML: function(t) {
                ...
                return t.options.layout ? this._buildLayout(t, p, t.options.layout, t.options.compact, t.options.significant, g) : (t.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (t._hold ? " " + this._holdingClass : "") + '">' + _(i) + _(o) + _(r) + _(s) + (p[a] ? this._minDigits(t, t._periods[a], 2) : "") + (p[l] ? (p[a] ? t.options.timeSeparator : "") + this._minDigits(t, t._periods[l], 2) : "") + (p[u] ? (p[a] || p[l] ? t.options.timeSeparator : "") + this._minDigits(t, t._periods[u], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (t.options.significant || d) + (t._hold ? " " + this._holdingClass : "") + '">' + w(i) + w(o) + w(r) + w(s) + w(a) + w(l) + w(u)) + "</span>" + (t.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + t.options.description + "</span>" : "")
            },
            ...
            _calculatePeriods: function(e, t, n, c) {
                ...
                if (t[i] || t[o]) {
                    ...
                    var _ = c.getDate() == p,
                        w = h._getDaysInMonth(c.getFullYear() + f[i], c.getMonth() + f[o]);
                    c.getDate() > w && c.setDate(w), c.setFullYear(c.getFullYear() + f[i]), c.setMonth(c.getMonth() + f[o]), _ && c.setDate(w)
                }
                var b = Math.floor((d.getTime() - c.getTime()) / 1e3),
                    x = function(e, n) {
                        f[e] = t[e] ? Math.floor(b / n) : 0, b -= f[e] * n
                    };
                if (x(r, 604800), x(s, 86400), x(a, 3600), x(l, 60), x(u, 1), b > 0 && !e._since)
                    for (var k = [1, 12, 4.3482, 7, 24, 60, 60], S = u, C = 1, T = u; T >= i; T--) t[T] && (f[S] >= C && (f[S] = 0, b = 1), b > 0 && (f[T]++, b = 0, S = T, C = 1)), C *= k[T];
                if (n)
                    for (var T = i; T <= u; T++) n && f[T] ? n-- : n || (f[T] = 0);
                return f
            }
        });
        var c = ["getTimes"];
...
! function(e) {
    ...
    function d(e, n) {
        n = n || y.tags;
        for (var o, s, a, l = u(n), d = new r(e), f = [], p = [], m = !1, g = !1, w = function() {
                if (m && !g)
            ...
            if (s = d.scanUntil(l[0]))
                for (var S = 0, C = s.length; S < C; ++S) a = s.charAt(S), t(a) ? p.push(f.length) : g = !0, f.push({
                    type: "text",
                    value: a
                }), "\n" === a && w();
            if (!d.scan(l[0])) break;
            if (m = !0, o = d.scan(k) || "name", d.scan(v), "=" === o) s = d.scanUntil(b), d.scan(b), d.scanUntil(l[1]);
            else if ("{" === o) {
    ...
    var v = /\s*/,
        ...
        C = /[\x00-\x2F\x3A-\x40\x5B-\x60\x7B-\xFF\u2028\u2029]/gm,
        T = {
            "&": "&amp;",
            "<": "&lt;",
            ">": "&gt;",
...
function(e) {
        ...
        if (e > 0)
            for (var t = 0; e > t; t++) {
                ...
                if (G.pv[0] > 0) {
                    var u = g(n);
                    if (u)
                        if (!w($[t].swfVersion) || G.wk && G.wk < 312)
    ...
    function s() {
        return !B && w("6.0.65") && (G.win || G.mac) && !(G.wk && G.wk < 312)
    }

    function a(e, t, n, i) {
        var o = g(n);
        if (n = m(n), B = !0, T = i || null, D = {
                success: !1,
                id: n
            }, o) {
            "OBJECT" === o.nodeName.toUpperCase() ? (S = u(o), C = null) : (S = o, C = n), e.id = j, (typeof e.width === A || !/%$/.test(e.width) && v(e.width) < 310) && (e.width = "310"), (typeof e.height === A || !/%$/.test(e.height) && v(e.height) < 137) && (e.height = "137");
    ...
    function x(e, t) {
        if (V) {
            var n = t ? "visible" : "hidden",
                i = g(e);
            U && i ? i.style.visibility = n : "string" == typeof e && b("#" + e, "visibility:" + n)
        }
    }
    ...
    return ! function() {
                ...
                if (u && typeof u === P)
                    for (var _ in u)
                        if (u.hasOwnProperty(_)) {
                            var b = Q ? encodeURIComponent(_) : _,
        ...
        expressInstallCallback: function() {
            if (B) {
                var e = g(j);
                e && S && (e.parentNode.replaceChild(S, e), C && (x(C, !0), G.ie && (S.style.display = "block")), T && T(D)), B = !1
            }
        },
        version: "2.3"
    }
    ...
    function() {
        ...
        for (var _ = function(e) {
            ...
            }, w = 0; w < u.length; w++) t[u[w]] = _(0 === w ? -1 : w)
    }(),
    function() {
        Date.Parsing = {
    ...
    function(e, t) {
        ...
        function k(t, n) {
            null != e.deprecationHandler && e.deprecationHandler(t, n), yi[t] || (b(n), yi[t] = !0)
        }
        ...
        function Xe(e) {
            ...
            if (!So[e] && "undefined" != typeof module && module && module.exports) try {
                t = wo._abbr, require("./locale/" + e), Ke(t)
            } catch (e) {}
            return So[e]
        }
        ...
        function Ze(e, t) {
            if (null != t) {
                var n, i = ko;
                null != So[e] && (i = So[e]._config), t = T(i, t), n = new D(t), n.parentLocale = So[e], So[e] = n, Ke(e)
        ...
        function lt(e) {
            var t, n, i, o, r, s, a, l;
            t = e._w, null != t.GG || null != t.W || null != t.E ? (r = 1, s = 4, n = rt(t.GG, e._a[Ki], be(yt(), 1, 4).year), i = rt(t.W, 1), o = rt(t.E, 1), (o < 1 || o > 7) && (l = !0)) : (r = e._locale._week.dow, s = e._locale._week.doy, n = rt(t.gg, e._a[Ki], be(yt(), r, s).year), i = rt(t.w, 1), null != t.d ? (o = t.d, (o < 0 || o > 6) && (l = !0)) : null != t.e ? (o = t.e + r, (t.e < 0 || t.e > 6) && (l = !0)) : o = r), i < 1 || i > xe(n, r, s) ? h(e)._overflowWeeks = !0 : null != l ? h(e)._overflowWeekday = !0 : (a = we(n, i, o, r, s), e._a[Ki] = a.year, e._dayOfYear = a.dayOfYear)
        }
        ...
        function Dt(t, n) {
            ...
            return this.isValid() ? null != t ? ("string" == typeof t ? t = St(Bi, t) : Math.abs(t) < 16 && (t *= 60), !this._isUTC && n && (i = Tt(this)), this._offset = t, this._isUTC = !0, null != i && this.add(i, "m"), o !== t && (!n || this._changeInProgress ? qt(this, Ft(t - o, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, e.updateOffset(this, !0), this._changeInProgress = null)), this) : this._isUTC ? o : Tt(this) : null != t ? this : NaN
        }
        ...
        function Ft(e, t) {
            ...
            return xt(e) ? r = {
                ...
                m: Ht(s[7], n),
                s: Ht(s[8], n)
            }) : null == r ? r = {} : "object" == typeof r && ("from" in r || "to" in r) && (o = Wt(yt(r.from), yt(r.to)), r = {}, r.ms = o.milliseconds, r.M = o.months), i = new bt(r), xt(e) && a(e, "_locale") && (i._locale = e._locale), i
        }
        ...
        function Wt(e, t) {
            var n;
            return e.isValid() && t.isValid() ? (t = Ct(t, e), e.isBefore(t) ? n = zt(e, t) : (n = zt(t, e), n.milliseconds = -n.milliseconds, n.months = -n.months), n) : {
                milliseconds: 0,
                months: 0
            }
        }
        ...
        function en(e, t, n) {
            var i, o, r, s;
            return this.isValid() ? (i = Ct(e, this), i.isValid() ? (o = 6e4 * (i.utcOffset() - this.utcOffset()), t = j(t), "year" === t || "month" === t || "quarter" === t ? (s = tn(this, i), "quarter" === t ? s /= 3 : "year" === t && (s /= 12)) : (r = this - i, s = "second" === t ? r / 1e3 : "minute" === t ? r / 6e4 : "hour" === t ? r / 36e5 : "day" === t ? (r - o) / 864e5 : "week" === t ? (r - o) / 6048e5 : r), n ? s : v(s)) : NaN) : NaN
        }
        ...
        function En(e, t, n, i, o) {
            var r;
            return null == e ? be(this, i, o).year : (r = xe(e, i, o), t > r && (t = r), An.call(this, e, t, n, i, o))
        }
        ...
        var Uo = g.prototype;
        Uo.add = Lo, Uo.calendar = Bt, Uo.clone = Vt, Uo.diff = en, Uo.endOf = fn, Uo.format = rn, Uo.from = sn, Uo.fromNow = an, Uo.to = ln, Uo.toNow = un, Uo.get = $, Uo.invalidAt = xn, Uo.isAfter = Qt, Uo.isBefore = Gt, Uo.isBetween = Xt, Uo.isSame = Kt, Uo.isSameOrAfter = Jt, Uo.isSameOrBefore = Zt, Uo.isValid = wn, Uo.lang = Ho, Uo.locale = cn, Uo.localeData = hn, Uo.max = Io, Uo.min = Po, Uo.parsingFlags = bn, Uo.set = Y, Uo.startOf = dn, Uo.subtract = Fo, Uo.toArray = yn, Uo.toObject = vn, Uo.toDate = gn, Uo.toISOString = on, Uo.toJSON = _n, Uo.toString = nn, Uo.unix = mn, Uo.valueOf = pn, Uo.creationData = kn, Uo.year = ho, Uo.isLeapYear = ge, Uo.weekYear = Cn, Uo.isoWeekYear = Tn, Uo.quarter = Uo.quarters = Pn, Uo.month = ue, Uo.daysInMonth = ce, Uo.week = Uo.weeks = Te, Uo.isoWeek = Uo.isoWeeks = De, Uo.weeksInYear = Mn, Uo.isoWeeksInYear = Dn, Uo.date = zo, Uo.day = Uo.days = je, Uo.weekday = Re, Uo.isoWeekday = Le, Uo.dayOfYear = In, Uo.hour = Uo.hours = xo, Uo.minute = Uo.minutes = Wo, Uo.second = Uo.seconds = $o, Uo.millisecond = Uo.milliseconds = qo, Uo.utcOffset = Dt, Uo.utc = Et, Uo.local = At, Uo.parseZone = Pt, Uo.hasAlignedHourOffset = It, Uo.isDST = Ot, Uo.isLocal = jt, Uo.isUtcOffset = Rt, Uo.isUtc = Lt, Uo.isUTC = Lt, Uo.zoneAbbr = Nn, Uo.zoneName = jn, Uo.dates = x("dates accessor is deprecated. Use date instead.", zo), Uo.months = x("months accessor is deprecated. Use month instead", ue), Uo.years = x("years accessor is deprecated. Use year instead", ho), Uo.zone = x("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Mt), Uo.isDSTShifted = x("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Nt);
        var Bo = Uo,
            Vo = D.prototype;
        Vo.calendar = M, Vo.longDateFormat = E, Vo.invalidDate = A, Vo.ordinal = P, Vo.preparse = Fn, Vo.postformat = Fn, Vo.relativeTime = I, Vo.pastFuture = O, Vo.set = C, Vo.months = oe, Vo.monthsShort = re, Vo.monthsParse = ae, Vo.monthsRegex = de, Vo.monthsShortRegex = he, Vo.week = ke, Vo.firstDayOfYear = Ce, Vo.firstDayOfWeek = Se, Vo.weekdays = Ae, Vo.weekdaysMin = Ie, Vo.weekdaysShort = Pe, Vo.weekdaysParse = Ne, Vo.weekdaysRegex = Fe, Vo.weekdaysShortRegex = He, Vo.weekdaysMinRegex = ze, Vo.isPM = Be, Vo.meridiem = Ve, Ke("en", {
...
googletag.cmd = googletag.cmd || [],
    ...
    function(e, t) {
        ...
        n.fetchAds = function(n) {
            ...
            googletag.cmd.push(function() {
                googletag.pubads().clearTargeting(), googletag.pubads().setTargeting("game", e.asyncAds.metadata.game), googletag.pubads().setTargeting("chan", e.asyncAds.metadata.chan), googletag.pubads().setTargeting("pagetype", e.asyncAds.metadata.pagetype), googletag.pubads().setTargeting("campaign", e.asyncAds.metadata.campaign), googletag.pubads().setTargeting("kuid", e.asyncAds.metadata.kuid), googletag.pubads().setTargeting("server", e.deployFlavor), googletag.pubads().setTargeting("salt", "https:" === window.location.protocol ? "true" : "false"), googletag.display("dfp-channel-adlight")
            })
                    ...
                    return new RSVP.Promise(function(r, u) {
                        n.resetGoogletag().then(l(function() {
                            ...
                            googletag.cmd.push(function() {
                                ...
                                })), googletag.pubads().clearTargeting(), googletag.pubads().setTargeting("game", e.asyncAds.metadata.game), googletag.pubads().setTargeting("pagetype", e.asyncAds.metadata.pagetype), googletag.pubads().setTargeting("campaign", e.asyncAds.metadata.campaign), googletag.pubads().setTargeting("kuid", e.asyncAds.metadata.kuid), googletag.pubads().setTargeting("server", e.deployFlavor), googletag.pubads().setTargeting("salt", "https:" === window.location.protocol ? "true" : "false"), googletag.pubads().enableSingleRequest(), googletag.pubads().collapseEmptyDivs(), googletag.enableServices(), _.each(o.slots, function(e) {
                                    googletag.display(e)
                                })
                            })
                        }), u)
